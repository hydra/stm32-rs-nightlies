...
pub type ATTSETX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PATT3_SPEC, u8, u8, 8, O>;
///Field `ATTWAITx` reader - ATTWAITx
pub type ATTWAITX_R = crate::FieldReader<u8, u8>;
///Field `ATTWAITx` writer - ATTWAITx
pub type ATTWAITX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PATT3_SPEC, u8, u8, 8, O>;
///Field `ATTHOLDx` reader - ATTHOLDx
pub type ATTHOLDX_R = crate::FieldReader<u8, u8>;
///Field `ATTHOLDx` writer - ATTHOLDx
pub type ATTHOLDX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PATT3_SPEC, u8, u8, 8, O>;
///Field `ATTHIZx` reader - ATTHIZx
pub type ATTHIZX_R = crate::FieldReader<u8, u8>;
///Field `ATTHIZx` writer - ATTHIZx
pub type ATTHIZX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PATT3_SPEC, u8, u8, 8, O>;
impl R {
    ///Bits 0:7 - ATTSETx
    #[inline(always)]
