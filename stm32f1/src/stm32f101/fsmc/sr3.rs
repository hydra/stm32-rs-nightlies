...
pub type IRS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR3_SPEC, bool, O>;
///Field `ILS` reader - ILS
pub type ILS_R = crate::BitReader<bool>;
///Field `ILS` writer - ILS
pub type ILS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR3_SPEC, bool, O>;
///Field `IFS` reader - IFS
pub type IFS_R = crate::BitReader<bool>;
///Field `IFS` writer - IFS
pub type IFS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR3_SPEC, bool, O>;
///Field `IREN` reader - IREN
pub type IREN_R = crate::BitReader<bool>;
///Field `IREN` writer - IREN
pub type IREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR3_SPEC, bool, O>;
///Field `ILEN` reader - ILEN
pub type ILEN_R = crate::BitReader<bool>;
///Field `ILEN` writer - ILEN
pub type ILEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR3_SPEC, bool, O>;
///Field `IFEN` reader - IFEN
pub type IFEN_R = crate::BitReader<bool>;
///Field `IFEN` writer - IFEN
pub type IFEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR3_SPEC, bool, O>;
