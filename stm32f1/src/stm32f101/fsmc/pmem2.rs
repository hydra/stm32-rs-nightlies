...
pub type MEMSETX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMEM2_SPEC, u8, u8, 8, O>;
///Field `MEMWAITx` reader - MEMWAITx
pub type MEMWAITX_R = crate::FieldReader<u8, u8>;
///Field `MEMWAITx` writer - MEMWAITx
pub type MEMWAITX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMEM2_SPEC, u8, u8, 8, O>;
///Field `MEMHOLDx` reader - MEMHOLDx
pub type MEMHOLDX_R = crate::FieldReader<u8, u8>;
///Field `MEMHOLDx` writer - MEMHOLDx
pub type MEMHOLDX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMEM2_SPEC, u8, u8, 8, O>;
///Field `MEMHIZx` reader - MEMHIZx
pub type MEMHIZX_R = crate::FieldReader<u8, u8>;
///Field `MEMHIZx` writer - MEMHIZx
pub type MEMHIZX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMEM2_SPEC, u8, u8, 8, O>;
impl R {
    ///Bits 0:7 - MEMSETx
    #[inline(always)]
