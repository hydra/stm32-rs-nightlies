...
pub struct RegisterBlock {
    ...
    pub c6cr: C6CR,
    ///0x1c - DMAMUX request line multiplexer channel x configuration register
    pub c7cr: C7CR,
    ///0x20 - DMAMUX request line multiplexer channel x configuration register
    pub c8cr: C8CR,
    ///0x24 - DMAMUX request line multiplexer channel x configuration register
    pub c9cr: C9CR,
    ///0x28 - DMAMUX request line multiplexer channel x configuration register
    pub c10cr: C10CR,
    ///0x2c - DMAMUX request line multiplexer channel x configuration register
    pub c11cr: C11CR,
    _reserved12: [u8; 0x50],
