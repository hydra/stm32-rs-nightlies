...
pub mod pcrop1ber;
///PCROP2ASR (rw) register accessor: an alias for `Reg<PCROP2ASR_SPEC>`
pub type PCROP2ASR = crate::Reg<pcrop2asr::PCROP2ASR_SPEC>;
///Flash PCROP2 area A start address register
pub mod pcrop2asr;
///PCROP2AER (rw) register accessor: an alias for `Reg<PCROP2AER_SPEC>`
