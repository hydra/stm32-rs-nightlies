...
///CR1_FIFO_ENABLED (rw) register accessor: an alias for `Reg<CR1_FIFO_ENABLED_SPEC>`
pub type CR1_FIFO_ENABLED = crate::Reg<cr1_fifo_enabled::CR1_FIFO_ENABLED_SPEC>;
///Control register 1
pub mod cr1_fifo_enabled;
///CR1_FIFO_DISABLED (rw) register accessor: an alias for `Reg<CR1_FIFO_DISABLED_SPEC>`
...
///Request register
pub mod rqr;
///ISR_FIFO_ENABLED (r) register accessor: an alias for `Reg<ISR_FIFO_ENABLED_SPEC>`
pub type ISR_FIFO_ENABLED = crate::Reg<isr_fifo_enabled::ISR_FIFO_ENABLED_SPEC>;
///Interrupt &amp; status register
pub mod isr_fifo_enabled;
///ISR_FIFO_DISABLED (r) register accessor: an alias for `Reg<ISR_FIFO_DISABLED_SPEC>`
