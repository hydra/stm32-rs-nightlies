...
pub enum EXTI9_A {
    ...
    Pf9 = 5,
    ///6: Select PG9 as the source input for the EXTI9 external interrupt
    Pg9 = 6,
}
...
pub enum EXTI10_A {
    ...
    Pf10 = 5,
    ///6: Select PG10 as the source input for the EXTI10 external interrupt
    Pg10 = 6,
}
...
pub enum EXTI11_A {
    ...
    Pf11 = 5,
    ///6: Select PG11 as the source input for the EXTI11 external interrupt
    Pg11 = 6,
}
