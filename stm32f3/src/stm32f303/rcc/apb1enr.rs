...
///Field `UART4EN` reader - USART 4 clock enable
pub use TIM2EN_R as UART4EN_R;
///Field `UART5EN` reader - USART 5 clock enable
...
///Field `UART4EN` writer - USART 4 clock enable
pub use TIM2EN_W as UART4EN_W;
///Field `UART5EN` writer - USART 5 clock enable
