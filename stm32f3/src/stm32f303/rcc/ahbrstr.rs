...
///Field `IOPGRST` reader - Touch sensing controller reset
...
///Field `ADC34RST` reader - ADC3 and ADC4 reset
...
///Field `IOPGRST` writer - Touch sensing controller reset
...
///Field `ADC34RST` writer - ADC3 and ADC4 reset
