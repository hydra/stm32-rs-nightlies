...
///Field `BR0` writer - Port x Reset bit y
...
///Field `BR1` writer - Port x Reset bit y
pub use BR0_W as BR1_W;
///Field `BR2` writer - Port x Reset bit y
pub use BR0_W as BR2_W;
///Field `BR3` writer - Port x Reset bit y
pub use BR0_W as BR3_W;
///Field `BR4` writer - Port x Reset bit y
pub use BR0_W as BR4_W;
///Field `BR5` writer - Port x Reset bit y
pub use BR0_W as BR5_W;
///Field `BR6` writer - Port x Reset bit y
pub use BR0_W as BR6_W;
///Field `BR7` writer - Port x Reset bit y
pub use BR0_W as BR7_W;
///Field `BR8` writer - Port x Reset bit y
pub use BR0_W as BR8_W;
///Field `BR9` writer - Port x Reset bit y
pub use BR0_W as BR9_W;
///Field `BR10` writer - Port x Reset bit y
pub use BR0_W as BR10_W;
///Field `BR11` writer - Port x Reset bit y
pub use BR0_W as BR11_W;
///Field `BR12` writer - Port x Reset bit y
pub use BR0_W as BR12_W;
///Field `BR13` writer - Port x Reset bit y
pub use BR0_W as BR13_W;
///Field `BR14` writer - Port x Reset bit y
pub use BR0_W as BR14_W;
///Field `BR15` writer - Port x Reset bit y
