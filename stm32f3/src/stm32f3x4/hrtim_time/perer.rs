...
///`read()` method returns [perer::R](R) reader structure
impl crate::Readable for PERER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [perer::W](W) writer structure
impl crate::Writable for PERER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets PERER to value 0xffff
