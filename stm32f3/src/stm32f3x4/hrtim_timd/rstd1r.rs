...
///`read()` method returns [rstd1r::R](R) reader structure
impl crate::Readable for RSTD1R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rstd1r::W](W) writer structure
impl crate::Writable for RSTD1R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RSTD1R to value 0
