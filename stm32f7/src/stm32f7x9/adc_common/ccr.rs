...
///Field `VBATE` reader - V_BAT enable
...
///Field `VBATE` writer - V_BAT enable
...
///Field `TSVREFE` reader - Temperature sensor and V_REFINT enable
...
///Field `TSVREFE` writer - Temperature sensor and V_REFINT enable
