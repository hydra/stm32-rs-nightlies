...
pub mod plli2scfgr;
///PLLSAICFGR (rw) register accessor: an alias for `Reg<PLLSAICFGR_SPEC>`
pub type PLLSAICFGR = crate::Reg<pllsaicfgr::PLLSAICFGR_SPEC>;
///PLL configuration register
pub mod pllsaicfgr;
///DCKCFGR1 (rw) register accessor: an alias for `Reg<DCKCFGR1_SPEC>`
pub type DCKCFGR1 = crate::Reg<dckcfgr1::DCKCFGR1_SPEC>;
