///Register `DFSDM_CHCFG0R1` reader
...
///Register `DFSDM_CHCFG0R1` writer
...
///`read()` method returns [dfsdm_chcfg0r1::R](R) reader structure
impl crate::Readable for DFSDM_CHCFG0R1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_chcfg0r1::W](W) writer structure
impl crate::Writable for DFSDM_CHCFG0R1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_CHCFG0R1 to value 0
