...
///`read()` method returns [dfsdm0_jchgr::R](R) reader structure
impl crate::Readable for DFSDM0_JCHGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm0_jchgr::W](W) writer structure
impl crate::Writable for DFSDM0_JCHGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM0_JCHGR to value 0x01
