///Register `DFSDM_CHCFG7R1` reader
...
///Register `DFSDM_CHCFG7R1` writer
...
///Field `SITP` reader - Serial interface type for channel 7
pub type SITP_R = crate::FieldReader<u8, u8>;
///Field `SITP` writer - Serial interface type for channel 7
pub type SITP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_CHCFG7R1_SPEC, u8, u8, 2, O>;
///Field `SPICKSEL` reader - SPI clock select for channel 7
pub type SPICKSEL_R = crate::FieldReader<u8, u8>;
///Field `SPICKSEL` writer - SPI clock select for channel 7
pub type SPICKSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_CHCFG7R1_SPEC, u8, u8, 2, O>;
///Field `SCDEN` reader - Short-circuit detector enable on channel 7
pub type SCDEN_R = crate::BitReader<bool>;
///Field `SCDEN` writer - Short-circuit detector enable on channel 7
pub type SCDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG7R1_SPEC, bool, O>;
///Field `CKABEN` reader - Clock absence detector enable on channel 7
pub type CKABEN_R = crate::BitReader<bool>;
///Field `CKABEN` writer - Clock absence detector enable on channel 7
pub type CKABEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG7R1_SPEC, bool, O>;
///Field `CHEN` reader - Channel 7 enable
pub type CHEN_R = crate::BitReader<bool>;
///Field `CHEN` writer - Channel 7 enable
...
///Field `DATMPX` reader - Input data multiplexer for channel 7
pub type DATMPX_R = crate::FieldReader<u8, u8>;
///Field `DATMPX` writer - Input data multiplexer for channel 7
...
///`read()` method returns [dfsdm_chcfg7r1::R](R) reader structure
impl crate::Readable for DFSDM_CHCFG7R1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_chcfg7r1::W](W) writer structure
impl crate::Writable for DFSDM_CHCFG7R1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_CHCFG7R1 to value 0
