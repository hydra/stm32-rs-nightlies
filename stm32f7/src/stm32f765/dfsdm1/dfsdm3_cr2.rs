...
///`read()` method returns [dfsdm3_cr2::R](R) reader structure
impl crate::Readable for DFSDM3_CR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm3_cr2::W](W) writer structure
impl crate::Writable for DFSDM3_CR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM3_CR2 to value 0
