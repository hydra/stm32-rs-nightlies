///Register `DFSDM_CHDATIN2R` reader
...
///Register `DFSDM_CHDATIN2R` writer
...
///Field `INDAT0` reader - Input data for channel 2
pub type INDAT0_R = crate::FieldReader<u16, u16>;
///Field `INDAT0` writer - Input data for channel 2
pub type INDAT0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_CHDATIN2R_SPEC, u16, u16, 16, O>;
///Field `INDAT1` reader - Input data for channel 3
pub type INDAT1_R = crate::FieldReader<u16, u16>;
///Field `INDAT1` writer - Input data for channel 3
...
///`read()` method returns [dfsdm_chdatin2r::R](R) reader structure
impl crate::Readable for DFSDM_CHDATIN2R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_chdatin2r::W](W) writer structure
impl crate::Writable for DFSDM_CHDATIN2R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_CHDATIN2R to value 0
