///Register `PWR_MPUWKUPENR` reader
...
///Register `PWR_MPUWKUPENR` writer
...
///`read()` method returns [pwr_mpuwkupenr::R](R) reader structure
impl crate::Readable for PWR_MPUWKUPENR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pwr_mpuwkupenr::W](W) writer structure
impl crate::Writable for PWR_MPUWKUPENR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets PWR_MPUWKUPENR to value 0
