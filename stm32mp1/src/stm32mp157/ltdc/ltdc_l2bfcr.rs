...
///`read()` method returns [ltdc_l2bfcr::R](R) reader structure
impl crate::Readable for LTDC_L2BFCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ltdc_l2bfcr::W](W) writer structure
impl crate::Writable for LTDC_L2BFCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LTDC_L2BFCR to value 0x0607
