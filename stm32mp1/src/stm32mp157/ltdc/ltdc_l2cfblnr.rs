...
///`read()` method returns [ltdc_l2cfblnr::R](R) reader structure
impl crate::Readable for LTDC_L2CFBLNR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ltdc_l2cfblnr::W](W) writer structure
impl crate::Writable for LTDC_L2CFBLNR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LTDC_L2CFBLNR to value 0
