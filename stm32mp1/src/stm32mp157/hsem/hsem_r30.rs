...
///`read()` method returns [hsem_r30::R](R) reader structure
impl crate::Readable for HSEM_R30_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hsem_r30::W](W) writer structure
impl crate::Writable for HSEM_R30_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets HSEM_R30 to value 0
