...
///`read()` method returns [exti_ftsr3::R](R) reader structure
impl crate::Readable for EXTI_FTSR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [exti_ftsr3::W](W) writer structure
impl crate::Writable for EXTI_FTSR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets EXTI_FTSR3 to value 0
