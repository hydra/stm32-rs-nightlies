...
///`read()` method returns [exti_c2imr1::R](R) reader structure
impl crate::Readable for EXTI_C2IMR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [exti_c2imr1::W](W) writer structure
impl crate::Writable for EXTI_C2IMR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets EXTI_C2IMR1 to value 0xfffe_0000
