...
pub mod fdcan_hpms;
///FDCAN_NDAT1 (rw) register accessor: an alias for `Reg<FDCAN_NDAT1_SPEC>`
pub type FDCAN_NDAT1 = crate::Reg<fdcan_ndat1::FDCAN_NDAT1_SPEC>;
///FDCAN new data 1 register
pub mod fdcan_ndat1;
///FDCAN_NDAT2 (rw) register accessor: an alias for `Reg<FDCAN_NDAT2_SPEC>`
...
pub mod fdcan_rxf1a;
///FDCAN_RXESC (r) register accessor: an alias for `Reg<FDCAN_RXESC_SPEC>`
...
pub mod fdcan_txfqs;
///FDCAN_TXESC (r) register accessor: an alias for `Reg<FDCAN_TXESC_SPEC>`
...
pub mod fdcan_ttocn;
///FDCAN_TTGTP (rw) register accessor: an alias for `Reg<FDCAN_TTGTP_SPEC>`
