...
pub mod dac_shrr;
///DAC_HWCFGR0 (r) register accessor: an alias for `Reg<DAC_HWCFGR0_SPEC>`
pub type DAC_HWCFGR0 = crate::Reg<dac_hwcfgr0::DAC_HWCFGR0_SPEC>;
///DAC IP hardware configuration register
pub mod dac_hwcfgr0;
///DAC_VERR (r) register accessor: an alias for `Reg<DAC_VERR_SPEC>`
pub type DAC_VERR = crate::Reg<dac_verr::DAC_VERR_SPEC>;
///No
pub mod dac_verr;
///DAC_IPIDR (r) register accessor: an alias for `Reg<DAC_IPIDR_SPEC>`
pub type DAC_IPIDR = crate::Reg<dac_ipidr::DAC_IPIDR_SPEC>;
///No
pub mod dac_ipidr;
///DAC_SIDR (r) register accessor: an alias for `Reg<DAC_SIDR_SPEC>`
pub type DAC_SIDR = crate::Reg<dac_sidr::DAC_SIDR_SPEC>;
///No
pub mod dac_sidr;
