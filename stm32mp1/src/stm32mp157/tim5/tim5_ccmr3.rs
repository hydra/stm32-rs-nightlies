...
///`read()` method returns [tim5_ccmr3::R](R) reader structure
impl crate::Readable for TIM5_CCMR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim5_ccmr3::W](W) writer structure
impl crate::Writable for TIM5_CCMR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM5_CCMR3 to value 0
