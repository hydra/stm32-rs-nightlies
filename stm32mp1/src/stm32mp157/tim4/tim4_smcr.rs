...
///`read()` method returns [tim4_smcr::R](R) reader structure
impl crate::Readable for TIM4_SMCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim4_smcr::W](W) writer structure
impl crate::Writable for TIM4_SMCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM4_SMCR to value 0
