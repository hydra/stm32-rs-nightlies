...
///`read()` method returns [ddrphyc_dtdr0::R](R) reader structure
impl crate::Readable for DDRPHYC_DTDR0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrphyc_dtdr0::W](W) writer structure
impl crate::Writable for DDRPHYC_DTDR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRPHYC_DTDR0 to value 0xdd22_ee11
