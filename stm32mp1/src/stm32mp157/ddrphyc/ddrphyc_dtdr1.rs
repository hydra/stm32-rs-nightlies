...
///`read()` method returns [ddrphyc_dtdr1::R](R) reader structure
impl crate::Readable for DDRPHYC_DTDR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrphyc_dtdr1::W](W) writer structure
impl crate::Writable for DDRPHYC_DTDR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRPHYC_DTDR1 to value 0x7788_bb44
