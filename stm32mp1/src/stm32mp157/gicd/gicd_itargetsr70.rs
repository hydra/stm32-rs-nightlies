///Register `GICD_ITARGETSR70` reader
...
///Register `GICD_ITARGETSR70` writer
...
///`read()` method returns [gicd_itargetsr70::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR70_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr70::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR70_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR70 to value 0
