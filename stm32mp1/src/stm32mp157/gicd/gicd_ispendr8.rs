...
///`read()` method returns [gicd_ispendr8::R](R) reader structure
impl crate::Readable for GICD_ISPENDR8_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ispendr8::W](W) writer structure
impl crate::Writable for GICD_ISPENDR8_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ISPENDR8 to value 0
