///Register `GICD_IPRIORITYR28` reader
...
///Register `GICD_IPRIORITYR28` writer
...
///`read()` method returns [gicd_ipriorityr28::R](R) reader structure
impl crate::Readable for GICD_IPRIORITYR28_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ipriorityr28::W](W) writer structure
impl crate::Writable for GICD_IPRIORITYR28_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_IPRIORITYR28 to value 0
