///Register `GICD_ITARGETSR55` reader
...
///Register `GICD_ITARGETSR55` writer
...
///`read()` method returns [gicd_itargetsr55::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR55_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr55::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR55_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR55 to value 0
