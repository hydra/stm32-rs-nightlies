///Register `GICD_ITARGETSR53` reader
...
///Register `GICD_ITARGETSR53` writer
...
///`read()` method returns [gicd_itargetsr53::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR53_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr53::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR53_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR53 to value 0
