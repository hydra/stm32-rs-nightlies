...
///`read()` method returns [gicd_icfgr11::R](R) reader structure
impl crate::Readable for GICD_ICFGR11_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_icfgr11::W](W) writer structure
impl crate::Writable for GICD_ICFGR11_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ICFGR11 to value 0x5555_5555
