///Register `GICD_ITARGETSR44` reader
...
///Register `GICD_ITARGETSR44` writer
...
///`read()` method returns [gicd_itargetsr44::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR44_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr44::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR44_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR44 to value 0
