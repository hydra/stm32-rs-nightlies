///Register `GICD_IPRIORITYR56` reader
...
///Register `GICD_IPRIORITYR56` writer
...
///`read()` method returns [gicd_ipriorityr56::R](R) reader structure
impl crate::Readable for GICD_IPRIORITYR56_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ipriorityr56::W](W) writer structure
impl crate::Writable for GICD_IPRIORITYR56_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_IPRIORITYR56 to value 0
