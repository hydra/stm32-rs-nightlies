...
///`read()` method returns [gicd_icpendr1::R](R) reader structure
impl crate::Readable for GICD_ICPENDR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_icpendr1::W](W) writer structure
impl crate::Writable for GICD_ICPENDR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ICPENDR1 to value 0
