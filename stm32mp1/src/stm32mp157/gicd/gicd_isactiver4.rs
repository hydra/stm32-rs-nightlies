///Register `GICD_ISACTIVER4` reader
...
///Register `GICD_ISACTIVER4` writer
...
///`read()` method returns [gicd_isactiver4::R](R) reader structure
impl crate::Readable for GICD_ISACTIVER4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_isactiver4::W](W) writer structure
impl crate::Writable for GICD_ISACTIVER4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ISACTIVER4 to value 0
