...
///`read()` method returns [tim2_bdtr::R](R) reader structure
impl crate::Readable for TIM2_BDTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim2_bdtr::W](W) writer structure
impl crate::Writable for TIM2_BDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM2_BDTR to value 0
