...
///`read()` method returns [gpiog_lckr::R](R) reader structure
impl crate::Readable for GPIOG_LCKR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpiog_lckr::W](W) writer structure
impl crate::Writable for GPIOG_LCKR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOG_LCKR to value 0
