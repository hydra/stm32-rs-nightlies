...
///`read()` method returns [dts_icifr::R](R) reader structure
impl crate::Readable for DTS_ICIFR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dts_icifr::W](W) writer structure
impl crate::Writable for DTS_ICIFR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DTS_ICIFR to value 0
