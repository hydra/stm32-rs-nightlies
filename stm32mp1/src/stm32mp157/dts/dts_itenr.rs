...
///`read()` method returns [dts_itenr::R](R) reader structure
impl crate::Readable for DTS_ITENR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dts_itenr::W](W) writer structure
impl crate::Writable for DTS_ITENR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DTS_ITENR to value 0
