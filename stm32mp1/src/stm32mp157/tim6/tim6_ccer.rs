...
///`read()` method returns [tim6_ccer::R](R) reader structure
impl crate::Readable for TIM6_CCER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim6_ccer::W](W) writer structure
impl crate::Writable for TIM6_CCER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM6_CCER to value 0
