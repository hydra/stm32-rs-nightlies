...
///`read()` method returns [gpiok_odr::R](R) reader structure
impl crate::Readable for GPIOK_ODR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpiok_odr::W](W) writer structure
impl crate::Writable for GPIOK_ODR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOK_ODR to value 0
