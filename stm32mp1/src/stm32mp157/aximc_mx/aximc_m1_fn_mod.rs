///Register `AXIMC_M1_FN_MOD` reader
...
///Register `AXIMC_M1_FN_MOD` writer
...
///`read()` method returns [aximc_m1_fn_mod::R](R) reader structure
impl crate::Readable for AXIMC_M1_FN_MOD_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [aximc_m1_fn_mod::W](W) writer structure
impl crate::Writable for AXIMC_M1_FN_MOD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets AXIMC_M1_FN_MOD to value 0
