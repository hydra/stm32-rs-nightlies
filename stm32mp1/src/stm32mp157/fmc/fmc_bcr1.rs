...
///`read()` method returns [fmc_bcr1::R](R) reader structure
impl crate::Readable for FMC_BCR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [fmc_bcr1::W](W) writer structure
impl crate::Writable for FMC_BCR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets FMC_BCR1 to value 0x30db
