...
///`read()` method returns [gich_lr3::R](R) reader structure
impl crate::Readable for GICH_LR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gich_lr3::W](W) writer structure
impl crate::Writable for GICH_LR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICH_LR3 to value 0
