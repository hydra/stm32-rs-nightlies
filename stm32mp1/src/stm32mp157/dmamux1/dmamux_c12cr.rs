...
///`read()` method returns [dmamux_c12cr::R](R) reader structure
impl crate::Readable for DMAMUX_C12CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dmamux_c12cr::W](W) writer structure
impl crate::Writable for DMAMUX_C12CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DMAMUX_C12CR to value 0
