...
///`read()` method returns [mdma_c4cr::R](R) reader structure
impl crate::Readable for MDMA_C4CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdma_c4cr::W](W) writer structure
impl crate::Writable for MDMA_C4CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDMA_C4CR to value 0
