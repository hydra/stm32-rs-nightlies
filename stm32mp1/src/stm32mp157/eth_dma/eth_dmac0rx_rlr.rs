///Register `ETH_DMAC0RxRLR` reader
...
///Register `ETH_DMAC0RxRLR` writer
...
///`read()` method returns [eth_dmac0rx_rlr::R](R) reader structure
impl crate::Readable for ETH_DMAC0RX_RLR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_dmac0rx_rlr::W](W) writer structure
impl crate::Writable for ETH_DMAC0RX_RLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_DMAC0RxRLR to value 0x8000
