///Register `ETH_DMAC1TxRLR` reader
...
///Register `ETH_DMAC1TxRLR` writer
...
///`read()` method returns [eth_dmac1tx_rlr::R](R) reader structure
impl crate::Readable for ETH_DMAC1TX_RLR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_dmac1tx_rlr::W](W) writer structure
impl crate::Writable for ETH_DMAC1TX_RLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_DMAC1TxRLR to value 0
