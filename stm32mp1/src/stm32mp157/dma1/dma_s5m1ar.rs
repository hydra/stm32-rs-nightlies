...
///`read()` method returns [dma_s5m1ar::R](R) reader structure
impl crate::Readable for DMA_S5M1AR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_s5m1ar::W](W) writer structure
impl crate::Writable for DMA_S5M1AR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DMA_S5M1AR to value 0
