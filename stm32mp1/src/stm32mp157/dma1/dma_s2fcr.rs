...
///`read()` method returns [dma_s2fcr::R](R) reader structure
impl crate::Readable for DMA_S2FCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_s2fcr::W](W) writer structure
impl crate::Writable for DMA_S2FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DMA_S2FCR to value 0x21
