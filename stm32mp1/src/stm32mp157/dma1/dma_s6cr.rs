...
///`read()` method returns [dma_s6cr::R](R) reader structure
impl crate::Readable for DMA_S6CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_s6cr::W](W) writer structure
impl crate::Writable for DMA_S6CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DMA_S6CR to value 0
