///Register `ETZPC_DECPROT5` reader
...
///Register `ETZPC_DECPROT5` writer
...
///`read()` method returns [etzpc_decprot5::R](R) reader structure
impl crate::Readable for ETZPC_DECPROT5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [etzpc_decprot5::W](W) writer structure
impl crate::Writable for ETZPC_DECPROT5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETZPC_DECPROT5 to value 0
