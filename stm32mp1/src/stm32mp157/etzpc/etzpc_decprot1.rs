///Register `ETZPC_DECPROT1` reader
...
///Register `ETZPC_DECPROT1` writer
...
///`read()` method returns [etzpc_decprot1::R](R) reader structure
impl crate::Readable for ETZPC_DECPROT1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [etzpc_decprot1::W](W) writer structure
impl crate::Writable for ETZPC_DECPROT1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETZPC_DECPROT1 to value 0
