...
///`read()` method returns [otg_hcdma5::R](R) reader structure
impl crate::Readable for OTG_HCDMA5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcdma5::W](W) writer structure
impl crate::Writable for OTG_HCDMA5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCDMA5 to value 0
