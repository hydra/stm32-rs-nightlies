...
///`read()` method returns [otg_diepctl4::R](R) reader structure
impl crate::Readable for OTG_DIEPCTL4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_diepctl4::W](W) writer structure
impl crate::Writable for OTG_DIEPCTL4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_DIEPCTL4 to value 0
