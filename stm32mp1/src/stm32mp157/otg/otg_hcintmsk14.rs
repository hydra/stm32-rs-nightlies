///Register `OTG_HCINTMSK14` reader
...
///Register `OTG_HCINTMSK14` writer
...
///`read()` method returns [otg_hcintmsk14::R](R) reader structure
impl crate::Readable for OTG_HCINTMSK14_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcintmsk14::W](W) writer structure
impl crate::Writable for OTG_HCINTMSK14_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCINTMSK14 to value 0
