...
///`read()` method returns [otg_dieptxf6::R](R) reader structure
impl crate::Readable for OTG_DIEPTXF6_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_dieptxf6::W](W) writer structure
impl crate::Writable for OTG_DIEPTXF6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_DIEPTXF6 to value 0x0200_0400
