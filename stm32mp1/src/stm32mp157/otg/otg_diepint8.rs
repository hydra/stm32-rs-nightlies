...
///`read()` method returns [otg_diepint8::R](R) reader structure
impl crate::Readable for OTG_DIEPINT8_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_diepint8::W](W) writer structure
impl crate::Writable for OTG_DIEPINT8_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_DIEPINT8 to value 0x80
