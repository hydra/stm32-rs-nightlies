///Register `OTG_HCINTMSK10` reader
...
///Register `OTG_HCINTMSK10` writer
...
///`read()` method returns [otg_hcintmsk10::R](R) reader structure
impl crate::Readable for OTG_HCINTMSK10_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcintmsk10::W](W) writer structure
impl crate::Writable for OTG_HCINTMSK10_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCINTMSK10 to value 0
