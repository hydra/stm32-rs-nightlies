...
///`read()` method returns [rcc_mc_cier::R](R) reader structure
impl crate::Readable for RCC_MC_CIER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_cier::W](W) writer structure
impl crate::Writable for RCC_MC_CIER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_CIER to value 0
