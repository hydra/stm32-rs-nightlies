...
///`read()` method returns [rcc_pll3cfgr1::R](R) reader structure
impl crate::Readable for RCC_PLL3CFGR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_pll3cfgr1::W](W) writer structure
impl crate::Writable for RCC_PLL3CFGR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_PLL3CFGR1 to value 0x0001_0031
