///Register `RCC_I2C12CKSELR` reader
...
///Register `RCC_I2C12CKSELR` writer
...
///`read()` method returns [rcc_i2c12ckselr::R](R) reader structure
impl crate::Readable for RCC_I2C12CKSELR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_i2c12ckselr::W](W) writer structure
impl crate::Writable for RCC_I2C12CKSELR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_I2C12CKSELR to value 0
