///Register `RCC_TZAHB6RSTSETR` reader
...
///Register `RCC_TZAHB6RSTSETR` writer
...
///`read()` method returns [rcc_tzahb6rstsetr::R](R) reader structure
impl crate::Readable for RCC_TZAHB6RSTSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_tzahb6rstsetr::W](W) writer structure
impl crate::Writable for RCC_TZAHB6RSTSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_TZAHB6RSTSETR to value 0
