///Register `RCC_MC_AHB6ENCLRR` reader
...
///Register `RCC_MC_AHB6ENCLRR` writer
...
///`read()` method returns [rcc_mc_ahb6enclrr::R](R) reader structure
impl crate::Readable for RCC_MC_AHB6ENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_ahb6enclrr::W](W) writer structure
impl crate::Writable for RCC_MC_AHB6ENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_AHB6ENCLRR to value 0
