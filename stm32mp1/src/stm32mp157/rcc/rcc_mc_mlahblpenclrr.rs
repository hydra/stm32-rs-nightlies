///Register `RCC_MC_MLAHBLPENCLRR` reader
...
///Register `RCC_MC_MLAHBLPENCLRR` writer
...
///`read()` method returns [rcc_mc_mlahblpenclrr::R](R) reader structure
impl crate::Readable for RCC_MC_MLAHBLPENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_mlahblpenclrr::W](W) writer structure
impl crate::Writable for RCC_MC_MLAHBLPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_MLAHBLPENCLRR to value 0x17
