///Register `RCC_APB1RSTCLRR` reader
...
///Register `RCC_APB1RSTCLRR` writer
...
///`read()` method returns [rcc_apb1rstclrr::R](R) reader structure
impl crate::Readable for RCC_APB1RSTCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_apb1rstclrr::W](W) writer structure
impl crate::Writable for RCC_APB1RSTCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_APB1RSTCLRR to value 0
