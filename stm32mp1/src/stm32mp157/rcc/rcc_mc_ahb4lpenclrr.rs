///Register `RCC_MC_AHB4LPENCLRR` reader
...
///Register `RCC_MC_AHB4LPENCLRR` writer
...
///`read()` method returns [rcc_mc_ahb4lpenclrr::R](R) reader structure
impl crate::Readable for RCC_MC_AHB4LPENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_ahb4lpenclrr::W](W) writer structure
impl crate::Writable for RCC_MC_AHB4LPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_AHB4LPENCLRR to value 0x07ff
