///Register `RCC_MP_RSTSCLRR` reader
...
///Register `RCC_MP_RSTSCLRR` writer
...
///`read()` method returns [rcc_mp_rstsclrr::R](R) reader structure
impl crate::Readable for RCC_MP_RSTSCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mp_rstsclrr::W](W) writer structure
impl crate::Writable for RCC_MP_RSTSCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MP_RSTSCLRR to value 0
