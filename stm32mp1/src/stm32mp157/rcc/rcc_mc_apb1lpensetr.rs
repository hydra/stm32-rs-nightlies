///Register `RCC_MC_APB1LPENSETR` reader
...
///Register `RCC_MC_APB1LPENSETR` writer
...
///Field `WWDG1LPEN` reader - WWDG1LPEN
pub type WWDG1LPEN_R = crate::BitReader<bool>;
///Field `WWDG1LPEN` writer - WWDG1LPEN
...
///`read()` method returns [rcc_mc_apb1lpensetr::R](R) reader structure
impl crate::Readable for RCC_MC_APB1LPENSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_apb1lpensetr::W](W) writer structure
impl crate::Writable for RCC_MC_APB1LPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_APB1LPENSETR to value 0xbdef_dbff
