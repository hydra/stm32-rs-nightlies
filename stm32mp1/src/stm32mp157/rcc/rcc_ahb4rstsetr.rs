///Register `RCC_AHB4RSTSETR` reader
...
///Register `RCC_AHB4RSTSETR` writer
...
///`read()` method returns [rcc_ahb4rstsetr::R](R) reader structure
impl crate::Readable for RCC_AHB4RSTSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_ahb4rstsetr::W](W) writer structure
impl crate::Writable for RCC_AHB4RSTSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_AHB4RSTSETR to value 0
