///Register `RCC_MP_AHB5ENSETR` reader
...
///Register `RCC_MP_AHB5ENSETR` writer
...
///`read()` method returns [rcc_mp_ahb5ensetr::R](R) reader structure
impl crate::Readable for RCC_MP_AHB5ENSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mp_ahb5ensetr::W](W) writer structure
impl crate::Writable for RCC_MP_AHB5ENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MP_AHB5ENSETR to value 0x0001_0000
