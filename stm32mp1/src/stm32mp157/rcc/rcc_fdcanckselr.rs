///Register `RCC_FDCANCKSELR` reader
...
///Register `RCC_FDCANCKSELR` writer
...
///`read()` method returns [rcc_fdcanckselr::R](R) reader structure
impl crate::Readable for RCC_FDCANCKSELR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_fdcanckselr::W](W) writer structure
impl crate::Writable for RCC_FDCANCKSELR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_FDCANCKSELR to value 0
