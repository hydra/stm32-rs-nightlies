...
///`read()` method returns [gpioj_ospeedr::R](R) reader structure
impl crate::Readable for GPIOJ_OSPEEDR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpioj_ospeedr::W](W) writer structure
impl crate::Writable for GPIOJ_OSPEEDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOJ_OSPEEDR to value 0
