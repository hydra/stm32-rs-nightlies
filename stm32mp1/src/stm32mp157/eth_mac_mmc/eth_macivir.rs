...
///`read()` method returns [eth_macivir::R](R) reader structure
impl crate::Readable for ETH_MACIVIR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_macivir::W](W) writer structure
impl crate::Writable for ETH_MACIVIR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_MACIVIR to value 0
