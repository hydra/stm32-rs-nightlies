...
///`read()` method returns [eth_maca1lr::R](R) reader structure
impl crate::Readable for ETH_MACA1LR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_maca1lr::W](W) writer structure
impl crate::Writable for ETH_MACA1LR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_MACA1LR to value 0xffff_ffff
