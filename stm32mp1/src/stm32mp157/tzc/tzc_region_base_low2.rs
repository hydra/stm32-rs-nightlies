///Register `TZC_REGION_BASE_LOW2` reader
...
///Register `TZC_REGION_BASE_LOW2` writer
...
///`read()` method returns [tzc_region_base_low2::R](R) reader structure
impl crate::Readable for TZC_REGION_BASE_LOW2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tzc_region_base_low2::W](W) writer structure
impl crate::Writable for TZC_REGION_BASE_LOW2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TZC_REGION_BASE_LOW2 to value 0
