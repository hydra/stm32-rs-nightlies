///Register `TZC_REGION_TOP_LOW1` reader
...
///Register `TZC_REGION_TOP_LOW1` writer
...
///`read()` method returns [tzc_region_top_low1::R](R) reader structure
impl crate::Readable for TZC_REGION_TOP_LOW1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tzc_region_top_low1::W](W) writer structure
impl crate::Writable for TZC_REGION_TOP_LOW1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TZC_REGION_TOP_LOW1 to value 0x0fff
