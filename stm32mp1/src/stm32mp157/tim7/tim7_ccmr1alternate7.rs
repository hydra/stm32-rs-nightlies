///Register `TIM7_CCMR1ALTERNATE7` reader
...
///Register `TIM7_CCMR1ALTERNATE7` writer
...
///`read()` method returns [tim7_ccmr1alternate7::R](R) reader structure
impl crate::Readable for TIM7_CCMR1ALTERNATE7_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim7_ccmr1alternate7::W](W) writer structure
impl crate::Writable for TIM7_CCMR1ALTERNATE7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM7_CCMR1ALTERNATE7 to value 0
