...
///`read()` method returns [tim7_bdtr::R](R) reader structure
impl crate::Readable for TIM7_BDTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim7_bdtr::W](W) writer structure
impl crate::Writable for TIM7_BDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM7_BDTR to value 0
