///Register `DDRCTRL_ADDRMAP5` reader
...
///Register `DDRCTRL_ADDRMAP5` writer
...
///`read()` method returns [ddrctrl_addrmap5::R](R) reader structure
impl crate::Readable for DDRCTRL_ADDRMAP5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_addrmap5::W](W) writer structure
impl crate::Writable for DDRCTRL_ADDRMAP5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_ADDRMAP5 to value 0
