...
///`read()` method returns [sdmmc_fifor14::R](R) reader structure
impl crate::Readable for SDMMC_FIFOR14_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sdmmc_fifor14::W](W) writer structure
impl crate::Writable for SDMMC_FIFOR14_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets SDMMC_FIFOR14 to value 0
