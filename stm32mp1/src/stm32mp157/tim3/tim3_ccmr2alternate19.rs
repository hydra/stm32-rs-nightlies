///Register `TIM3_CCMR2ALTERNATE19` reader
...
///Register `TIM3_CCMR2ALTERNATE19` writer
...
///`read()` method returns [tim3_ccmr2alternate19::R](R) reader structure
impl crate::Readable for TIM3_CCMR2ALTERNATE19_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim3_ccmr2alternate19::W](W) writer structure
impl crate::Writable for TIM3_CCMR2ALTERNATE19_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM3_CCMR2ALTERNATE19 to value 0
