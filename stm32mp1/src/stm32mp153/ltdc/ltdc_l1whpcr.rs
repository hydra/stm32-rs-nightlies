...
///`read()` method returns [ltdc_l1whpcr::R](R) reader structure
impl crate::Readable for LTDC_L1WHPCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ltdc_l1whpcr::W](W) writer structure
impl crate::Writable for LTDC_L1WHPCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LTDC_L1WHPCR to value 0
