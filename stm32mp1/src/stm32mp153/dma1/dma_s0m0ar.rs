...
///`read()` method returns [dma_s0m0ar::R](R) reader structure
impl crate::Readable for DMA_S0M0AR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_s0m0ar::W](W) writer structure
impl crate::Writable for DMA_S0M0AR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DMA_S0M0AR to value 0
