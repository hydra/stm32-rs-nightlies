...
///`read()` method returns [dma_s1ndtr::R](R) reader structure
impl crate::Readable for DMA_S1NDTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_s1ndtr::W](W) writer structure
impl crate::Writable for DMA_S1NDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DMA_S1NDTR to value 0
