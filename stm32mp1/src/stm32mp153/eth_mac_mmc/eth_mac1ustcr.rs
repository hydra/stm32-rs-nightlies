...
///`read()` method returns [eth_mac1ustcr::R](R) reader structure
impl crate::Readable for ETH_MAC1USTCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_mac1ustcr::W](W) writer structure
impl crate::Writable for ETH_MAC1USTCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_MAC1USTCR to value 0
