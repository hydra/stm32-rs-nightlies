...
///`read()` method returns [eth_macl3a00r::R](R) reader structure
impl crate::Readable for ETH_MACL3A00R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_macl3a00r::W](W) writer structure
impl crate::Writable for ETH_MACL3A00R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_MACL3A00R to value 0
