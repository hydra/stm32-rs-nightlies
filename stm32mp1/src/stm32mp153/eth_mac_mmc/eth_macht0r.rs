...
///`read()` method returns [eth_macht0r::R](R) reader structure
impl crate::Readable for ETH_MACHT0R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_macht0r::W](W) writer structure
impl crate::Writable for ETH_MACHT0R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_MACHT0R to value 0
