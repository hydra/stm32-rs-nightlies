...
///`read()` method returns [dcmi_ris::R](R) reader structure
impl crate::Readable for DCMI_RIS_SPEC {
    type Reader = R;
}
///`reset()` method sets DCMI_RIS to value 0
