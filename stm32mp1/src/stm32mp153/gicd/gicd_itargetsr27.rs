///Register `GICD_ITARGETSR27` reader
...
///Register `GICD_ITARGETSR27` writer
...
///`read()` method returns [gicd_itargetsr27::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR27_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr27::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR27_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR27 to value 0
