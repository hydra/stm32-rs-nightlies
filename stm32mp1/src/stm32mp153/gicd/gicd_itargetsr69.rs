///Register `GICD_ITARGETSR69` reader
...
///Register `GICD_ITARGETSR69` writer
...
///`read()` method returns [gicd_itargetsr69::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR69_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr69::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR69_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR69 to value 0
