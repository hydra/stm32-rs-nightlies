///Register `GICD_SPENDSGIR2` reader
...
///Register `GICD_SPENDSGIR2` writer
...
///`read()` method returns [gicd_spendsgir2::R](R) reader structure
impl crate::Readable for GICD_SPENDSGIR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_spendsgir2::W](W) writer structure
impl crate::Writable for GICD_SPENDSGIR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_SPENDSGIR2 to value 0
