///Register `GICD_ITARGETSR12` reader
...
///Register `GICD_ITARGETSR12` writer
...
///`read()` method returns [gicd_itargetsr12::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR12_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr12::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR12_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR12 to value 0
