///Register `GICD_ITARGETSR25` reader
...
///Register `GICD_ITARGETSR25` writer
...
///`read()` method returns [gicd_itargetsr25::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR25_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr25::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR25_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR25 to value 0
