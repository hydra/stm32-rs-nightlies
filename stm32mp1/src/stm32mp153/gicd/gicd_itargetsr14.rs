///Register `GICD_ITARGETSR14` reader
...
///Register `GICD_ITARGETSR14` writer
...
///`read()` method returns [gicd_itargetsr14::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR14_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr14::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR14_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR14 to value 0
