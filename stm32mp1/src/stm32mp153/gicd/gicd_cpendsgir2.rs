///Register `GICD_CPENDSGIR2` reader
...
///Register `GICD_CPENDSGIR2` writer
...
///`read()` method returns [gicd_cpendsgir2::R](R) reader structure
impl crate::Readable for GICD_CPENDSGIR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_cpendsgir2::W](W) writer structure
impl crate::Writable for GICD_CPENDSGIR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_CPENDSGIR2 to value 0
