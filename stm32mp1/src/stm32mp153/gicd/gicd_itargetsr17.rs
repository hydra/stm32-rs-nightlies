///Register `GICD_ITARGETSR17` reader
...
///Register `GICD_ITARGETSR17` writer
...
///`read()` method returns [gicd_itargetsr17::R](R) reader structure
impl crate::Readable for GICD_ITARGETSR17_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_itargetsr17::W](W) writer structure
impl crate::Writable for GICD_ITARGETSR17_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_ITARGETSR17 to value 0
