///Register `GICD_IPRIORITYR33` reader
...
///Register `GICD_IPRIORITYR33` writer
...
///`read()` method returns [gicd_ipriorityr33::R](R) reader structure
impl crate::Readable for GICD_IPRIORITYR33_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ipriorityr33::W](W) writer structure
impl crate::Writable for GICD_IPRIORITYR33_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_IPRIORITYR33 to value 0
