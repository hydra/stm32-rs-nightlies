///Register `GICD_IPRIORITYR11` reader
...
///Register `GICD_IPRIORITYR11` writer
...
///`read()` method returns [gicd_ipriorityr11::R](R) reader structure
impl crate::Readable for GICD_IPRIORITYR11_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ipriorityr11::W](W) writer structure
impl crate::Writable for GICD_IPRIORITYR11_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_IPRIORITYR11 to value 0
