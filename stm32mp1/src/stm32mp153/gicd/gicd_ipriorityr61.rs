///Register `GICD_IPRIORITYR61` reader
...
///Register `GICD_IPRIORITYR61` writer
...
///`read()` method returns [gicd_ipriorityr61::R](R) reader structure
impl crate::Readable for GICD_IPRIORITYR61_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ipriorityr61::W](W) writer structure
impl crate::Writable for GICD_IPRIORITYR61_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_IPRIORITYR61 to value 0
