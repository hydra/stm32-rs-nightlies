///Register `GICD_IPRIORITYR55` reader
...
///Register `GICD_IPRIORITYR55` writer
...
///`read()` method returns [gicd_ipriorityr55::R](R) reader structure
impl crate::Readable for GICD_IPRIORITYR55_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gicd_ipriorityr55::W](W) writer structure
impl crate::Writable for GICD_IPRIORITYR55_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GICD_IPRIORITYR55 to value 0
