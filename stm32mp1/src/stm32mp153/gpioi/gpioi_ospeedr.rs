...
///`read()` method returns [gpioi_ospeedr::R](R) reader structure
impl crate::Readable for GPIOI_OSPEEDR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpioi_ospeedr::W](W) writer structure
impl crate::Writable for GPIOI_OSPEEDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOI_OSPEEDR to value 0
