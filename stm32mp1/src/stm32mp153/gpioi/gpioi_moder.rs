...
///`read()` method returns [gpioi_moder::R](R) reader structure
impl crate::Readable for GPIOI_MODER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpioi_moder::W](W) writer structure
impl crate::Writable for GPIOI_MODER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOI_MODER to value 0xffff_ffff
