...
///`read()` method returns [gpioi_lckr::R](R) reader structure
impl crate::Readable for GPIOI_LCKR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpioi_lckr::W](W) writer structure
impl crate::Writable for GPIOI_LCKR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOI_LCKR to value 0
