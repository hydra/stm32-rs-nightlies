...
///`read()` method returns [usbphyc_tune2::R](R) reader structure
impl crate::Readable for USBPHYC_TUNE2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [usbphyc_tune2::W](W) writer structure
impl crate::Writable for USBPHYC_TUNE2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets USBPHYC_TUNE2 to value 0x0407_0004
