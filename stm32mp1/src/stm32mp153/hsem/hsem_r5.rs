...
///`read()` method returns [hsem_r5::R](R) reader structure
impl crate::Readable for HSEM_R5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hsem_r5::W](W) writer structure
impl crate::Writable for HSEM_R5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets HSEM_R5 to value 0
