///Register `AXIMC_M2_FN_MOD_AHB` reader
...
///Register `AXIMC_M2_FN_MOD_AHB` writer
...
///`read()` method returns [aximc_m2_fn_mod_ahb::R](R) reader structure
impl crate::Readable for AXIMC_M2_FN_MOD_AHB_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [aximc_m2_fn_mod_ahb::W](W) writer structure
impl crate::Writable for AXIMC_M2_FN_MOD_AHB_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets AXIMC_M2_FN_MOD_AHB to value 0
