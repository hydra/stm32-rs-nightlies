///Register `CRYP_CSGCMCCM0R` reader
...
///Register `CRYP_CSGCMCCM0R` writer
...
///`read()` method returns [cryp_csgcmccm0r::R](R) reader structure
impl crate::Readable for CRYP_CSGCMCCM0R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cryp_csgcmccm0r::W](W) writer structure
impl crate::Writable for CRYP_CSGCMCCM0R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CRYP_CSGCMCCM0R to value 0
