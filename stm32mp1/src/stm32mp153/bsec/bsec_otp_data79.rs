///Register `BSEC_OTP_DATA79` reader
...
///Register `BSEC_OTP_DATA79` writer
...
///`read()` method returns [bsec_otp_data79::R](R) reader structure
impl crate::Readable for BSEC_OTP_DATA79_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [bsec_otp_data79::W](W) writer structure
impl crate::Writable for BSEC_OTP_DATA79_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets BSEC_OTP_DATA79 to value 0
