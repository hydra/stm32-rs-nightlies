///Register `TIMx_CCMR1_Output` reader
...
///Register `TIMx_CCMR1_Output` writer
...
///`read()` method returns [timx_ccmr1_output::R](R) reader structure
impl crate::Readable for TIMX_CCMR1_OUTPUT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timx_ccmr1_output::W](W) writer structure
impl crate::Writable for TIMX_CCMR1_OUTPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMx_CCMR1_Output to value 0
