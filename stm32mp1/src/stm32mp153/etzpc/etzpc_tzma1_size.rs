///Register `ETZPC_TZMA1_SIZE` reader
...
///Register `ETZPC_TZMA1_SIZE` writer
...
///`read()` method returns [etzpc_tzma1_size::R](R) reader structure
impl crate::Readable for ETZPC_TZMA1_SIZE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [etzpc_tzma1_size::W](W) writer structure
impl crate::Writable for ETZPC_TZMA1_SIZE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETZPC_TZMA1_SIZE to value 0x03ff
