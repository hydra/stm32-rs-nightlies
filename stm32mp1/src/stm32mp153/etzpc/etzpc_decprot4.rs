///Register `ETZPC_DECPROT4` reader
...
///Register `ETZPC_DECPROT4` writer
...
///`read()` method returns [etzpc_decprot4::R](R) reader structure
impl crate::Readable for ETZPC_DECPROT4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [etzpc_decprot4::W](W) writer structure
impl crate::Writable for ETZPC_DECPROT4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETZPC_DECPROT4 to value 0
