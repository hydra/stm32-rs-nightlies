...
///`read()` method returns [mdma_c1tcr::R](R) reader structure
impl crate::Readable for MDMA_C1TCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdma_c1tcr::W](W) writer structure
impl crate::Writable for MDMA_C1TCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDMA_C1TCR to value 0
