...
///`read()` method returns [mdma_c26bndtr::R](R) reader structure
impl crate::Readable for MDMA_C26BNDTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdma_c26bndtr::W](W) writer structure
impl crate::Writable for MDMA_C26BNDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDMA_C26BNDTR to value 0
