...
///`read()` method returns [otg_hcintmsk6::R](R) reader structure
impl crate::Readable for OTG_HCINTMSK6_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcintmsk6::W](W) writer structure
impl crate::Writable for OTG_HCINTMSK6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCINTMSK6 to value 0
