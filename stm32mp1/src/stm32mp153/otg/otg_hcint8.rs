...
///`read()` method returns [otg_hcint8::R](R) reader structure
impl crate::Readable for OTG_HCINT8_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcint8::W](W) writer structure
impl crate::Writable for OTG_HCINT8_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCINT8 to value 0
