...
///`read()` method returns [otg_hcint0::R](R) reader structure
impl crate::Readable for OTG_HCINT0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcint0::W](W) writer structure
impl crate::Writable for OTG_HCINT0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCINT0 to value 0
