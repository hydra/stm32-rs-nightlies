...
///`read()` method returns [otg_diepdma5::R](R) reader structure
impl crate::Readable for OTG_DIEPDMA5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_diepdma5::W](W) writer structure
impl crate::Writable for OTG_DIEPDMA5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_DIEPDMA5 to value 0
