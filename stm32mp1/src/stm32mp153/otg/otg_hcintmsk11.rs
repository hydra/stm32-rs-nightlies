///Register `OTG_HCINTMSK11` reader
...
///Register `OTG_HCINTMSK11` writer
...
///`read()` method returns [otg_hcintmsk11::R](R) reader structure
impl crate::Readable for OTG_HCINTMSK11_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_hcintmsk11::W](W) writer structure
impl crate::Writable for OTG_HCINTMSK11_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_HCINTMSK11 to value 0
