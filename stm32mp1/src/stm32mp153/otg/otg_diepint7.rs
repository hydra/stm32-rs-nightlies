...
///`read()` method returns [otg_diepint7::R](R) reader structure
impl crate::Readable for OTG_DIEPINT7_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_diepint7::W](W) writer structure
impl crate::Writable for OTG_DIEPINT7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_DIEPINT7 to value 0x80
