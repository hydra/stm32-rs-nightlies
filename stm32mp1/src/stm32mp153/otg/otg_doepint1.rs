...
///`read()` method returns [otg_doepint1::R](R) reader structure
impl crate::Readable for OTG_DOEPINT1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_doepint1::W](W) writer structure
impl crate::Writable for OTG_DOEPINT1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_DOEPINT1 to value 0x80
