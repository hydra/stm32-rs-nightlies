...
///`read()` method returns [otg_gahbcfg::R](R) reader structure
impl crate::Readable for OTG_GAHBCFG_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [otg_gahbcfg::W](W) writer structure
impl crate::Writable for OTG_GAHBCFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets OTG_GAHBCFG to value 0
