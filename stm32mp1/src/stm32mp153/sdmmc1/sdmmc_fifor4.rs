...
///`read()` method returns [sdmmc_fifor4::R](R) reader structure
impl crate::Readable for SDMMC_FIFOR4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sdmmc_fifor4::W](W) writer structure
impl crate::Writable for SDMMC_FIFOR4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets SDMMC_FIFOR4 to value 0
