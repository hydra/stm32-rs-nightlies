...
///`read()` method returns [tim12_ccr2::R](R) reader structure
impl crate::Readable for TIM12_CCR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim12_ccr2::W](W) writer structure
impl crate::Writable for TIM12_CCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM12_CCR2 to value 0
