...
///`read()` method returns [tim12_tisel::R](R) reader structure
impl crate::Readable for TIM12_TISEL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim12_tisel::W](W) writer structure
impl crate::Writable for TIM12_TISEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM12_TISEL to value 0
