...
///`read()` method returns [gpiog_pupdr::R](R) reader structure
impl crate::Readable for GPIOG_PUPDR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpiog_pupdr::W](W) writer structure
impl crate::Writable for GPIOG_PUPDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOG_PUPDR to value 0
