...
///`read()` method returns [sai_pdmdly::R](R) reader structure
impl crate::Readable for SAI_PDMDLY_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sai_pdmdly::W](W) writer structure
impl crate::Writable for SAI_PDMDLY_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets SAI_PDMDLY to value 0
