...
///`read()` method returns [eth_dmac0ier::R](R) reader structure
impl crate::Readable for ETH_DMAC0IER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_dmac0ier::W](W) writer structure
impl crate::Writable for ETH_DMAC0IER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_DMAC0IER to value 0x8000
