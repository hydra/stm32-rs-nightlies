///Register `ETH_DMAC1SFCSR` reader
...
///Register `ETH_DMAC1SFCSR` writer
...
///`read()` method returns [eth_dmac1sfcsr::R](R) reader structure
impl crate::Readable for ETH_DMAC1SFCSR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eth_dmac1sfcsr::W](W) writer structure
impl crate::Writable for ETH_DMAC1SFCSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ETH_DMAC1SFCSR to value 0
