///Register `DDRPHYC_DX1DQTR` reader
...
///Register `DDRPHYC_DX1DQTR` writer
...
///`read()` method returns [ddrphyc_dx1dqtr::R](R) reader structure
impl crate::Readable for DDRPHYC_DX1DQTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrphyc_dx1dqtr::W](W) writer structure
impl crate::Writable for DDRPHYC_DX1DQTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRPHYC_DX1DQTR to value 0xffff_ffff
