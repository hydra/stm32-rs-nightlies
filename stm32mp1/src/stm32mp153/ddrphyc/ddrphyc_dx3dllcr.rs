///Register `DDRPHYC_DX3DLLCR` reader
...
///Register `DDRPHYC_DX3DLLCR` writer
...
///`read()` method returns [ddrphyc_dx3dllcr::R](R) reader structure
impl crate::Readable for DDRPHYC_DX3DLLCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrphyc_dx3dllcr::W](W) writer structure
impl crate::Writable for DDRPHYC_DX3DLLCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRPHYC_DX3DLLCR to value 0x4000_0000
