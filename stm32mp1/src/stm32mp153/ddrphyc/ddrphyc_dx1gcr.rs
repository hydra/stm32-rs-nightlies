///Register `DDRPHYC_DX1GCR` reader
...
///Register `DDRPHYC_DX1GCR` writer
...
///`read()` method returns [ddrphyc_dx1gcr::R](R) reader structure
impl crate::Readable for DDRPHYC_DX1GCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrphyc_dx1gcr::W](W) writer structure
impl crate::Writable for DDRPHYC_DX1GCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRPHYC_DX1GCR to value 0xee81
