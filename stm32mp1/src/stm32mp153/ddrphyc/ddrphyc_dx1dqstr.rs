///Register `DDRPHYC_DX1DQSTR` reader
...
///Register `DDRPHYC_DX1DQSTR` writer
...
///`read()` method returns [ddrphyc_dx1dqstr::R](R) reader structure
impl crate::Readable for DDRPHYC_DX1DQSTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrphyc_dx1dqstr::W](W) writer structure
impl crate::Writable for DDRPHYC_DX1DQSTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRPHYC_DX1DQSTR to value 0x3db0_2000
