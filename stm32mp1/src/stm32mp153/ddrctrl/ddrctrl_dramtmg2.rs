///Register `DDRCTRL_DRAMTMG2` reader
...
///Register `DDRCTRL_DRAMTMG2` writer
...
///`read()` method returns [ddrctrl_dramtmg2::R](R) reader structure
impl crate::Readable for DDRCTRL_DRAMTMG2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_dramtmg2::W](W) writer structure
impl crate::Writable for DDRCTRL_DRAMTMG2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_DRAMTMG2 to value 0x0305_060d
