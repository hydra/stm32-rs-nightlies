///Register `DDRCTRL_PERFHPR1` reader
...
///Register `DDRCTRL_PERFHPR1` writer
...
///`read()` method returns [ddrctrl_perfhpr1::R](R) reader structure
impl crate::Readable for DDRCTRL_PERFHPR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_perfhpr1::W](W) writer structure
impl crate::Writable for DDRCTRL_PERFHPR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_PERFHPR1 to value 0x0f00_0001
