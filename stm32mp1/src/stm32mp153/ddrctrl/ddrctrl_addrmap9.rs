///Register `DDRCTRL_ADDRMAP9` reader
...
///Register `DDRCTRL_ADDRMAP9` writer
...
///`read()` method returns [ddrctrl_addrmap9::R](R) reader structure
impl crate::Readable for DDRCTRL_ADDRMAP9_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_addrmap9::W](W) writer structure
impl crate::Writable for DDRCTRL_ADDRMAP9_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_ADDRMAP9 to value 0
