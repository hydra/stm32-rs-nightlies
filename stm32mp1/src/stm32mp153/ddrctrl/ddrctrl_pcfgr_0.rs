///Register `DDRCTRL_PCFGR_0` reader
...
///Register `DDRCTRL_PCFGR_0` writer
...
///`read()` method returns [ddrctrl_pcfgr_0::R](R) reader structure
impl crate::Readable for DDRCTRL_PCFGR_0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_pcfgr_0::W](W) writer structure
impl crate::Writable for DDRCTRL_PCFGR_0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_PCFGR_0 to value 0x4000
