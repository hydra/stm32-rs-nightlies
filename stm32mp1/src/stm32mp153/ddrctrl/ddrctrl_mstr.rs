...
///`read()` method returns [ddrctrl_mstr::R](R) reader structure
impl crate::Readable for DDRCTRL_MSTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_mstr::W](W) writer structure
impl crate::Writable for DDRCTRL_MSTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_MSTR to value 0x0004_0001
