///Register `DDRCTRL_RFSHCTL0` reader
...
///Register `DDRCTRL_RFSHCTL0` writer
...
///`read()` method returns [ddrctrl_rfshctl0::R](R) reader structure
impl crate::Readable for DDRCTRL_RFSHCTL0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ddrctrl_rfshctl0::W](W) writer structure
impl crate::Writable for DDRCTRL_RFSHCTL0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DDRCTRL_RFSHCTL0 to value 0x0021_0000
