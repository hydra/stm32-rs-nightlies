...
///`read()` method returns [fmc_bcr4::R](R) reader structure
impl crate::Readable for FMC_BCR4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [fmc_bcr4::W](W) writer structure
impl crate::Writable for FMC_BCR4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets FMC_BCR4 to value 0x30db
