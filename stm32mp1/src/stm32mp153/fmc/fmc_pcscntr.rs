...
///`read()` method returns [fmc_pcscntr::R](R) reader structure
impl crate::Readable for FMC_PCSCNTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [fmc_pcscntr::W](W) writer structure
