...
///`read()` method returns [gpioh_odr::R](R) reader structure
impl crate::Readable for GPIOH_ODR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpioh_odr::W](W) writer structure
impl crate::Writable for GPIOH_ODR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPIOH_ODR to value 0
