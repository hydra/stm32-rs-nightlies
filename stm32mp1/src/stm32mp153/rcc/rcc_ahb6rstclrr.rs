///Register `RCC_AHB6RSTCLRR` reader
...
///Register `RCC_AHB6RSTCLRR` writer
...
///`read()` method returns [rcc_ahb6rstclrr::R](R) reader structure
impl crate::Readable for RCC_AHB6RSTCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_ahb6rstclrr::W](W) writer structure
impl crate::Writable for RCC_AHB6RSTCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_AHB6RSTCLRR to value 0
