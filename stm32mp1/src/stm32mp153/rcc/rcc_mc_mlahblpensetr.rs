///Register `RCC_MC_MLAHBLPENSETR` reader
...
///Register `RCC_MC_MLAHBLPENSETR` writer
...
///`read()` method returns [rcc_mc_mlahblpensetr::R](R) reader structure
impl crate::Readable for RCC_MC_MLAHBLPENSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_mlahblpensetr::W](W) writer structure
impl crate::Writable for RCC_MC_MLAHBLPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_MLAHBLPENSETR to value 0x17
