///Register `RCC_UART24CKSELR` reader
...
///Register `RCC_UART24CKSELR` writer
...
///`read()` method returns [rcc_uart24ckselr::R](R) reader structure
impl crate::Readable for RCC_UART24CKSELR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_uart24ckselr::W](W) writer structure
impl crate::Writable for RCC_UART24CKSELR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_UART24CKSELR to value 0
