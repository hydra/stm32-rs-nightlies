...
///`read()` method returns [rcc_pll2cfgr2::R](R) reader structure
impl crate::Readable for RCC_PLL2CFGR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_pll2cfgr2::W](W) writer structure
impl crate::Writable for RCC_PLL2CFGR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_PLL2CFGR2 to value 0x0001_0101
