///Register `RCC_UART1CKSELR` reader
...
///Register `RCC_UART1CKSELR` writer
...
///`read()` method returns [rcc_uart1ckselr::R](R) reader structure
impl crate::Readable for RCC_UART1CKSELR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_uart1ckselr::W](W) writer structure
impl crate::Writable for RCC_UART1CKSELR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_UART1CKSELR to value 0
