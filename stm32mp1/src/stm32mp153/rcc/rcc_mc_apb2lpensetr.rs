...
///Register `RCC_MC_APB2LPENSETR` writer
...
///`read()` method returns [rcc_mc_apb2lpensetr::R](R) reader structure
impl crate::Readable for RCC_MC_APB2LPENSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_apb2lpensetr::W](W) writer structure
impl crate::Writable for RCC_MC_APB2LPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_APB2LPENSETR to value 0x0137_271f
