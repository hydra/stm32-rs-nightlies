///Register `RCC_MP_APB4LPENSETR` reader
...
///Register `RCC_MP_APB4LPENSETR` writer
...
///`read()` method returns [rcc_mp_apb4lpensetr::R](R) reader structure
impl crate::Readable for RCC_MP_APB4LPENSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mp_apb4lpensetr::W](W) writer structure
impl crate::Writable for RCC_MP_APB4LPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MP_APB4LPENSETR to value 0x0011_8111
