///Register `RCC_MC_APB1ENCLRR` reader
...
///Register `RCC_MC_APB1ENCLRR` writer
...
///`read()` method returns [rcc_mc_apb1enclrr::R](R) reader structure
impl crate::Readable for RCC_MC_APB1ENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_apb1enclrr::W](W) writer structure
impl crate::Writable for RCC_MC_APB1ENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_APB1ENCLRR to value 0
