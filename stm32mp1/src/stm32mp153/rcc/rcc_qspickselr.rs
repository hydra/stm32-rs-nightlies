///Register `RCC_QSPICKSELR` reader
...
///Register `RCC_QSPICKSELR` writer
...
///`read()` method returns [rcc_qspickselr::R](R) reader structure
impl crate::Readable for RCC_QSPICKSELR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_qspickselr::W](W) writer structure
impl crate::Writable for RCC_QSPICKSELR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_QSPICKSELR to value 0
