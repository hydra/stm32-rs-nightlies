...
///`read()` method returns [rcc_pll4cr::R](R) reader structure
impl crate::Readable for RCC_PLL4CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_pll4cr::W](W) writer structure
impl crate::Writable for RCC_PLL4CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_PLL4CR to value 0
