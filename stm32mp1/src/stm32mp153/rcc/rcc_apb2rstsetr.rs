///Register `RCC_APB2RSTSETR` reader
...
///Register `RCC_APB2RSTSETR` writer
...
///`read()` method returns [rcc_apb2rstsetr::R](R) reader structure
impl crate::Readable for RCC_APB2RSTSETR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_apb2rstsetr::W](W) writer structure
impl crate::Writable for RCC_APB2RSTSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_APB2RSTSETR to value 0
