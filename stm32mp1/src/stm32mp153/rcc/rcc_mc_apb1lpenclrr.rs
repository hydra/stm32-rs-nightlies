///Register `RCC_MC_APB1LPENCLRR` reader
...
///Register `RCC_MC_APB1LPENCLRR` writer
...
///`read()` method returns [rcc_mc_apb1lpenclrr::R](R) reader structure
impl crate::Readable for RCC_MC_APB1LPENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mc_apb1lpenclrr::W](W) writer structure
impl crate::Writable for RCC_MC_APB1LPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MC_APB1LPENCLRR to value 0xbdef_dbff
