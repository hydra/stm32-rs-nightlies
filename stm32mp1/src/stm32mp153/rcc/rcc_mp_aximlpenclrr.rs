///Register `RCC_MP_AXIMLPENCLRR` reader
...
///Register `RCC_MP_AXIMLPENCLRR` writer
...
///`read()` method returns [rcc_mp_aximlpenclrr::R](R) reader structure
impl crate::Readable for RCC_MP_AXIMLPENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mp_aximlpenclrr::W](W) writer structure
impl crate::Writable for RCC_MP_AXIMLPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MP_AXIMLPENCLRR to value 0x01
