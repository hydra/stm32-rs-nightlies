///Register `RCC_MP_APB3LPENCLRR` reader
...
///Register `RCC_MP_APB3LPENCLRR` writer
...
///`read()` method returns [rcc_mp_apb3lpenclrr::R](R) reader structure
impl crate::Readable for RCC_MP_APB3LPENCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_mp_apb3lpenclrr::W](W) writer structure
impl crate::Writable for RCC_MP_APB3LPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_MP_APB3LPENCLRR to value 0x0003_290f
