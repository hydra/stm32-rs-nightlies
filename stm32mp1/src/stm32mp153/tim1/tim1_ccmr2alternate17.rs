///Register `TIM1_CCMR2ALTERNATE17` reader
...
///Register `TIM1_CCMR2ALTERNATE17` writer
...
///`read()` method returns [tim1_ccmr2alternate17::R](R) reader structure
impl crate::Readable for TIM1_CCMR2ALTERNATE17_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim1_ccmr2alternate17::W](W) writer structure
impl crate::Writable for TIM1_CCMR2ALTERNATE17_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM1_CCMR2ALTERNATE17 to value 0
