...
///`read()` method returns [timx_cr1::R](R) reader structure
impl crate::Readable for TIMX_CR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timx_cr1::W](W) writer structure
impl crate::Writable for TIMX_CR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMx_CR1 to value 0
