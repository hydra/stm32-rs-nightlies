...
///`read()` method returns [timx_tisel::R](R) reader structure
impl crate::Readable for TIMX_TISEL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timx_tisel::W](W) writer structure
impl crate::Writable for TIMX_TISEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMx_TISEL to value 0
