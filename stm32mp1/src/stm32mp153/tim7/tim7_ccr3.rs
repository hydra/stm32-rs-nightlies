...
///`read()` method returns [tim7_ccr3::R](R) reader structure
impl crate::Readable for TIM7_CCR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim7_ccr3::W](W) writer structure
impl crate::Writable for TIM7_CCR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM7_CCR3 to value 0
