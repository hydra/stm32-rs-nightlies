...
///`read()` method returns [exti_fpr3::R](R) reader structure
impl crate::Readable for EXTI_FPR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [exti_fpr3::W](W) writer structure
impl crate::Writable for EXTI_FPR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets EXTI_FPR3 to value 0
