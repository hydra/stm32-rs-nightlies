...
///`read()` method returns [dfsdm_flt4cr2::R](R) reader structure
impl crate::Readable for DFSDM_FLT4CR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_flt4cr2::W](W) writer structure
impl crate::Writable for DFSDM_FLT4CR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_FLT4CR2 to value 0
