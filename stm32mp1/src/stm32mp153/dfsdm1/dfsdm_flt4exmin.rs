///Register `DFSDM_FLT4EXMIN` reader
...
///Register `DFSDM_FLT4EXMIN` writer
...
///`read()` method returns [dfsdm_flt4exmin::R](R) reader structure
impl crate::Readable for DFSDM_FLT4EXMIN_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_flt4exmin::W](W) writer structure
impl crate::Writable for DFSDM_FLT4EXMIN_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_FLT4EXMIN to value 0x7fff_ff00
