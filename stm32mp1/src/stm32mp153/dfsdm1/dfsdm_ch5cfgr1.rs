///Register `DFSDM_CH5CFGR1` reader
...
///Register `DFSDM_CH5CFGR1` writer
...
///`read()` method returns [dfsdm_ch5cfgr1::R](R) reader structure
impl crate::Readable for DFSDM_CH5CFGR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_ch5cfgr1::W](W) writer structure
impl crate::Writable for DFSDM_CH5CFGR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_CH5CFGR1 to value 0
