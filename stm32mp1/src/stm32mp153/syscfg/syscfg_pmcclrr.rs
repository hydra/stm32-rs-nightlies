///Register `SYSCFG_PMCCLRR` reader
...
///Register `SYSCFG_PMCCLRR` writer
...
///`read()` method returns [syscfg_pmcclrr::R](R) reader structure
impl crate::Readable for SYSCFG_PMCCLRR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [syscfg_pmcclrr::W](W) writer structure
impl crate::Writable for SYSCFG_PMCCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets SYSCFG_PMCCLRR to value 0
