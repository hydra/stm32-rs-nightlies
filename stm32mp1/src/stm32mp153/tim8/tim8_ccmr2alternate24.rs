///Register `TIM8_CCMR2ALTERNATE24` reader
...
///Register `TIM8_CCMR2ALTERNATE24` writer
...
///`read()` method returns [tim8_ccmr2alternate24::R](R) reader structure
impl crate::Readable for TIM8_CCMR2ALTERNATE24_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim8_ccmr2alternate24::W](W) writer structure
impl crate::Writable for TIM8_CCMR2ALTERNATE24_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM8_CCMR2ALTERNATE24 to value 0
