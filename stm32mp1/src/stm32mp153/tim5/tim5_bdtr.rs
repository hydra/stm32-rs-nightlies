...
///`read()` method returns [tim5_bdtr::R](R) reader structure
impl crate::Readable for TIM5_BDTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim5_bdtr::W](W) writer structure
impl crate::Writable for TIM5_BDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM5_BDTR to value 0
