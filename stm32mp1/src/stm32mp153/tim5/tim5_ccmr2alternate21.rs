///Register `TIM5_CCMR2ALTERNATE21` reader
...
///Register `TIM5_CCMR2ALTERNATE21` writer
...
///`read()` method returns [tim5_ccmr2alternate21::R](R) reader structure
impl crate::Readable for TIM5_CCMR2ALTERNATE21_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim5_ccmr2alternate21::W](W) writer structure
impl crate::Writable for TIM5_CCMR2ALTERNATE21_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM5_CCMR2ALTERNATE21 to value 0
