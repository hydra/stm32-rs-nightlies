...
///`read()` method returns [mpcwm1_upwmr::R](R) reader structure
impl crate::Readable for MPCWM1_UPWMR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcwm1_upwmr::W](W) writer structure
impl crate::Writable for MPCWM1_UPWMR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCWM1_UPWMR to value 0x0fff_0000
