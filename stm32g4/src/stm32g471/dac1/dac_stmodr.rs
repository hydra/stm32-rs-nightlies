...
///`read()` method returns [dac_stmodr::R](R) reader structure
impl crate::Readable for DAC_STMODR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dac_stmodr::W](W) writer structure
impl crate::Writable for DAC_STMODR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DAC_STMODR to value 0
