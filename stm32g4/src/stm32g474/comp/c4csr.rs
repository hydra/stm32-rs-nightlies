...
///`read()` method returns [c4csr::R](R) reader structure
impl crate::Readable for C4CSR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [c4csr::W](W) writer structure
impl crate::Writable for C4CSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets C4CSR to value 0
