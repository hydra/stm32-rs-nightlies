...
pub mod timbicr;
///TIMBDIER (rw) register accessor: an alias for `Reg<TIMBDIER_SPEC>`
...
pub mod fltbr;
///TIMBCR2 (rw) register accessor: an alias for `Reg<TIMBCR2_SPEC>`
pub type TIMBCR2 = crate::Reg<timbcr2::TIMBCR2_SPEC>;
///HRTIM Timerx Control Register 2
pub mod timbcr2;
///BEEFR3 (rw) register accessor: an alias for `Reg<BEEFR3_SPEC>`
pub type BEEFR3 = crate::Reg<beefr3::BEEFR3_SPEC>;
