...
///`read()` method returns [eeefr3::R](R) reader structure
impl crate::Readable for EEEFR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eeefr3::W](W) writer structure
impl crate::Writable for EEEFR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets EEEFR3 to value 0
