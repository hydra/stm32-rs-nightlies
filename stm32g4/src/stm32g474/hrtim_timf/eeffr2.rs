...
///`read()` method returns [eeffr2::R](R) reader structure
impl crate::Readable for EEFFR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [eeffr2::W](W) writer structure
impl crate::Writable for EEFFR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets EEFFR2 to value 0
