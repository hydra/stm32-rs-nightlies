...
///`read()` method returns [cpt2fcr::R](R) reader structure
impl crate::Readable for CPT2FCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cpt2fcr::W](W) writer structure
impl crate::Writable for CPT2FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CPT2FCR to value 0
