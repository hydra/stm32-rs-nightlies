...
///`read()` method returns [setf1r::R](R) reader structure
impl crate::Readable for SETF1R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [setf1r::W](W) writer structure
impl crate::Writable for SETF1R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets SETF1R to value 0
