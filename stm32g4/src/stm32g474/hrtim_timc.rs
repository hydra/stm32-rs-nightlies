...
pub mod timcicr;
///TIMCDIER (rw) register accessor: an alias for `Reg<TIMCDIER_SPEC>`
...
pub mod fltcr;
///TIMCCR2 (rw) register accessor: an alias for `Reg<TIMCCR2_SPEC>`
pub type TIMCCR2 = crate::Reg<timccr2::TIMCCR2_SPEC>;
///HRTIM Timerx Control Register 2
pub mod timccr2;
///CEEFR3 (rw) register accessor: an alias for `Reg<CEEFR3_SPEC>`
pub type CEEFR3 = crate::Reg<ceefr3::CEEFR3_SPEC>;
