...
///`read()` method returns [timbcr2::R](R) reader structure
impl crate::Readable for TIMBCR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timbcr2::W](W) writer structure
impl crate::Writable for TIMBCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMBCR2 to value 0
