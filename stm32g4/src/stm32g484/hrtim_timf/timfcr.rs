...
///`read()` method returns [timfcr::R](R) reader structure
impl crate::Readable for TIMFCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timfcr::W](W) writer structure
impl crate::Writable for TIMFCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMFCR to value 0
