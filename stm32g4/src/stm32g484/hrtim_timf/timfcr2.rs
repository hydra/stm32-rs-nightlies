...
///`read()` method returns [timfcr2::R](R) reader structure
impl crate::Readable for TIMFCR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timfcr2::W](W) writer structure
impl crate::Writable for TIMFCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMFCR2 to value 0
