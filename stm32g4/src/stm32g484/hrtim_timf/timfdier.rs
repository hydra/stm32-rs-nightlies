...
///`read()` method returns [timfdier::R](R) reader structure
impl crate::Readable for TIMFDIER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timfdier::W](W) writer structure
impl crate::Writable for TIMFDIER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMFDIER to value 0
