...
pub mod timdicr;
///TIMDDIER (rw) register accessor: an alias for `Reg<TIMDDIER_SPEC>`
...
pub mod fltdr;
///TIMDCR2 (rw) register accessor: an alias for `Reg<TIMDCR2_SPEC>`
pub type TIMDCR2 = crate::Reg<timdcr2::TIMDCR2_SPEC>;
///HRTIM Timerx Control Register 2
pub mod timdcr2;
///DEEFR3 (rw) register accessor: an alias for `Reg<DEEFR3_SPEC>`
