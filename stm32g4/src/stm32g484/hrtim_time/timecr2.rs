...
///`read()` method returns [timecr2::R](R) reader structure
impl crate::Readable for TIMECR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timecr2::W](W) writer structure
impl crate::Writable for TIMECR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMECR2 to value 0
