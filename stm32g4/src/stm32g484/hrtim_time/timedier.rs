...
///`read()` method returns [timedier::R](R) reader structure
impl crate::Readable for TIMEDIER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [timedier::W](W) writer structure
impl crate::Writable for TIMEDIER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIMEDIER to value 0
