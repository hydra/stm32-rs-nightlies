...
///`read()` method returns [deefr3::R](R) reader structure
impl crate::Readable for DEEFR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [deefr3::W](W) writer structure
impl crate::Writable for DEEFR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DEEFR3 to value 0
