...
///Field `TF1ODS` reader - Timer F Output 1 disable status
pub type TF1ODS_R = crate::BitReader<bool>;
///Field `TF1ODS` writer - Timer F Output 1 disable status
pub type TF1ODS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OENR_SPEC, bool, O>;
///Field `TF2ODS` reader - Timer F Output 2 disable status
pub type TF2ODS_R = crate::BitReader<bool>;
///Field `TF2ODS` writer - Timer F Output 2 disable status
