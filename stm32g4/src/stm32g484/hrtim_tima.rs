...
pub mod timaicr;
///TIMADIER (rw) register accessor: an alias for `Reg<TIMADIER_SPEC>`
pub type TIMADIER = crate::Reg<timadier::TIMADIER_SPEC>;
///TIMxDIER
pub mod timadier;
...
pub mod fltar;
///TIMACR2 (rw) register accessor: an alias for `Reg<TIMACR2_SPEC>`
pub type TIMACR2 = crate::Reg<timacr2::TIMACR2_SPEC>;
///HRTIM Timerx Control Register 2
pub mod timacr2;
///AEEFR3 (rw) register accessor: an alias for `Reg<AEEFR3_SPEC>`
pub type AEEFR3 = crate::Reg<aeefr3::AEEFR3_SPEC>;
