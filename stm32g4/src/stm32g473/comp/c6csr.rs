...
///`read()` method returns [c6csr::R](R) reader structure
impl crate::Readable for C6CSR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [c6csr::W](W) writer structure
impl crate::Writable for C6CSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets C6CSR to value 0
