...
///Field `PD0` reader - Port F pull-down bit i (i = 2 to 0) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PF\[i\]
///I/O. On STM32C011xx, only PD2 is available.
pub type PD0_R = crate::BitReader<bool>;
///Field `PD0` writer - Port F pull-down bit i (i = 2 to 0) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PF\[i\]
///I/O. On STM32C011xx, only PD2 is available.
pub type PD0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDCRF_SPEC, bool, O>;
///Field `PD1` reader - Port F pull-down bit i (i = 2 to 0) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PF\[i\]
///I/O. On STM32C011xx, only PD2 is available.
pub type PD1_R = crate::BitReader<bool>;
///Field `PD1` writer - Port F pull-down bit i (i = 2 to 0) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PF\[i\]
///I/O. On STM32C011xx, only PD2 is available.
...
impl R {
    ///Bit 0 - Port F pull-down bit i (i = 2 to 0) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PF\[i\]
    ///I/O. On STM32C011xx, only PD2 is available.
    #[inline(always)]
    pub fn pd0(&self) -> PD0_R {
        PD0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Port F pull-down bit i (i = 2 to 0) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PF\[i\]
    ///I/O. On STM32C011xx, only PD2 is available.
    #[inline(always)]
