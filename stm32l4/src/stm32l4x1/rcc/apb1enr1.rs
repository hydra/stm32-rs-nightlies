...
///Field `SPI2EN` reader - SPI peripheral 2 clock enable
pub type SPI2EN_R = crate::BitReader<bool>;
///Field `SPI2EN` writer - SPI peripheral 2 clock enable
...
///Field `USBF` reader - USB FS clock enable
pub type USBF_R = crate::BitReader<bool>;
///Field `USBF` writer - USB FS clock enable
