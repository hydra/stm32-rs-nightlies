...
pub type DATA0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDL0R_SPEC, u8, u8, 8, O>;
///Field `DATA1` reader - DATA1
pub type DATA1_R = crate::FieldReader<u8, u8>;
///Field `DATA1` writer - DATA1
pub type DATA1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDL0R_SPEC, u8, u8, 8, O>;
///Field `DATA2` reader - DATA2
pub type DATA2_R = crate::FieldReader<u8, u8>;
///Field `DATA2` writer - DATA2
pub type DATA2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDL0R_SPEC, u8, u8, 8, O>;
///Field `DATA3` reader - DATA3
pub type DATA3_R = crate::FieldReader<u8, u8>;
///Field `DATA3` writer - DATA3
pub type DATA3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDL0R_SPEC, u8, u8, 8, O>;
impl R {
    ///Bits 0:7 - DATA0
    #[inline(always)]
