...
pub enum CLK48SEL_A {
    ...
    Hsi48 = 0,
    ///1: PLL48M2CLK clock selected
    Pll48m2clk = 1,
    ///2: PLL48M1CLK clock selected
    Pll48m1clk = 2,
...
impl CLK48SEL_R {
    ...
    ///Checks if the value of the field is `Pll48m2clk`
    #[inline(always)]
...
impl ADCSEL_R {
    ...
    ///Checks if the value of the field is `Plladc1clk`
    #[inline(always)]
