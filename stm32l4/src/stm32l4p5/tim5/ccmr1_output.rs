...
///Field `OC1M_3` reader - Bit 3 of Output compare 1 mode
pub type OC1M_3_R = crate::BitReader<OC1M_3_A>;
///Bit 3 of Output compare 1 mode
///
///Value on reset: 0
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OC1M_3_A {
...
///Field `OC1M_3` writer - Bit 3 of Output compare 1 mode
...
///Field `OC2M_3` reader - Bit 3 of Output compare 2 mode
pub use OC1M_3_R as OC2M_3_R;
///Field `OC2M_3` writer - Bit 3 of Output compare 2 mode
...
impl R {
    ...
    ///Bit 16 - Bit 3 of Output compare 1 mode
    #[inline(always)]
    pub fn oc1m_3(&self) -> OC1M_3_R {
        OC1M_3_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 24 - Bit 3 of Output compare 2 mode
    #[inline(always)]
