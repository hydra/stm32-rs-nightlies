...
///Field `OC3M_3` reader - Bit 3 of Output compare 3 mode
pub type OC3M_3_R = crate::BitReader<OC3M_3_A>;
///Bit 3 of Output compare 3 mode
///
///Value on reset: 0
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OC3M_3_A {
...
///Field `OC3M_3` writer - Bit 3 of Output compare 3 mode
...
///Field `OC4M_3` reader - Bit 3 of Output compare 4 mode
pub use OC3M_3_R as OC4M_3_R;
///Field `OC4M_3` writer - Bit 3 of Output compare 4 mode
...
impl R {
    ...
    ///Bit 16 - Bit 3 of Output compare 3 mode
    #[inline(always)]
    pub fn oc3m_3(&self) -> OC3M_3_R {
        OC3M_3_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 24 - Bit 3 of Output compare 4 mode
    #[inline(always)]
