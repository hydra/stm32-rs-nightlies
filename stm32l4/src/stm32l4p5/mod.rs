//!Peripheral access API for STM32L4P5 microcontrollers (generated using svd2rust v0.28.0 (d1ddb1b 2023-03-19))
//!
...
///Secure digital input/output interface 1
pub mod sdmmc1;
///Secure digital input/output interface 2
pub struct SDMMC2 {
    _marker: PhantomData<*const ()>,
}
