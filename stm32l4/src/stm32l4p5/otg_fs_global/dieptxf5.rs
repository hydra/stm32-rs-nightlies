...
///Field `INEPTXSA` reader - IN endpoint FIFO6 transmit RAM start address
pub type INEPTXSA_R = crate::FieldReader<u16, u16>;
///Field `INEPTXSA` writer - IN endpoint FIFO6 transmit RAM start address
...
///`reset()` method sets DIEPTXF5 to value 0
