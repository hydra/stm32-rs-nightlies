...
impl<'a, const O: u8> NOMCK_W<'a, O> {
    ...
    ///Master clock generator is disabled. The clock divider controlled by MCKDIV can still be used to generate the bit clock
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
impl OSR_R {
    ...
    ///Checks if the value of the field is `Multiplier256`
    #[inline(always)]
    pub fn is_multiplier256(&self) -> bool {
        *self == OSR_A::Multiplier256
    }
    ///Checks if the value of the field is `Multiplier512`
    #[inline(always)]
