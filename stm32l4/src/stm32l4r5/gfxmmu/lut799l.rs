...
///`read()` method returns [lut799l::R](R) reader structure
impl crate::Readable for LUT799L_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut799l::W](W) writer structure
impl crate::Writable for LUT799L_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT799L to value 0
