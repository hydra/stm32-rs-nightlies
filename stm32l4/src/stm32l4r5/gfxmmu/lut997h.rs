...
///`read()` method returns [lut997h::R](R) reader structure
impl crate::Readable for LUT997H_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut997h::W](W) writer structure
impl crate::Writable for LUT997H_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT997H to value 0
