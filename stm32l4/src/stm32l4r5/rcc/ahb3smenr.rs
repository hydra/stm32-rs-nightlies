...
///Field `OSPI1SMEN` reader - OSPI1 memory interface clock enable during Sleep and Stop modes
pub type OSPI1SMEN_R = crate::BitReader<bool>;
///Field `OSPI1SMEN` writer - OSPI1 memory interface clock enable during Sleep and Stop modes
...
impl R {
    ...
    ///Bit 8 - OSPI1 memory interface clock enable during Sleep and Stop modes
    #[inline(always)]
