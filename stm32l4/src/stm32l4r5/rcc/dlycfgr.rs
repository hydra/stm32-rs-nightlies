...
///Field `OCTOSPI1_DLY` reader - Delay sampling configuration on OCTOSPI1
pub type OCTOSPI1_DLY_R = crate::FieldReader<u8, u8>;
///Field `OCTOSPI1_DLY` writer - Delay sampling configuration on OCTOSPI1
pub type OCTOSPI1_DLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DLYCFGR_SPEC, u8, u8, 4, O>;
///Field `OCTOSPI2_DLY` reader - Delay sampling configuration on OCTOSPI2
pub type OCTOSPI2_DLY_R = crate::FieldReader<u8, u8>;
///Field `OCTOSPI2_DLY` writer - Delay sampling configuration on OCTOSPI2
pub type OCTOSPI2_DLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DLYCFGR_SPEC, u8, u8, 4, O>;
impl R {
    ///Bits 0:3 - Delay sampling configuration on OCTOSPI1
    #[inline(always)]
    pub fn octospi1_dly(&self) -> OCTOSPI1_DLY_R {
        OCTOSPI1_DLY_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 4:7 - Delay sampling configuration on OCTOSPI2
    #[inline(always)]
