...
///`read()` method returns [awscd5r::R](R) reader structure
impl crate::Readable for AWSCD5R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [awscd5r::W](W) writer structure
impl crate::Writable for AWSCD5R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets AWSCD5R to value 0
