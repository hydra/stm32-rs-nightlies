...
///`read()` method returns [chdatin3r::R](R) reader structure
impl crate::Readable for CHDATIN3R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chdatin3r::W](W) writer structure
impl crate::Writable for CHDATIN3R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CHDATIN3R to value 0
