...
///`read()` method returns [chwdat0r::R](R) reader structure
impl crate::Readable for CHWDAT0R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chwdat0r::W](W) writer structure
impl crate::Writable for CHWDAT0R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CHWDAT0R to value 0
