...
///`read()` method returns [chwdat5r::R](R) reader structure
impl crate::Readable for CHWDAT5R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chwdat5r::W](W) writer structure
impl crate::Writable for CHWDAT5R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CHWDAT5R to value 0
