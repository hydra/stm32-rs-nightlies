...
///`read()` method returns [chcfg4r1::R](R) reader structure
impl crate::Readable for CHCFG4R1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chcfg4r1::W](W) writer structure
impl crate::Writable for CHCFG4R1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CHCFG4R1 to value 0
