...
///`read()` method returns [chcfg6r2::R](R) reader structure
impl crate::Readable for CHCFG6R2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chcfg6r2::W](W) writer structure
impl crate::Writable for CHCFG6R2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CHCFG6R2 to value 0
