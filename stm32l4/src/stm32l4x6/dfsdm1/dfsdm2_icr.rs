...
///`read()` method returns [dfsdm2_icr::R](R) reader structure
impl crate::Readable for DFSDM2_ICR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm2_icr::W](W) writer structure
impl crate::Writable for DFSDM2_ICR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM2_ICR to value 0
