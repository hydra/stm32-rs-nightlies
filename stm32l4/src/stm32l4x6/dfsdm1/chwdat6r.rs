...
///`read()` method returns [chwdat6r::R](R) reader structure
impl crate::Readable for CHWDAT6R_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chwdat6r::W](W) writer structure
impl crate::Writable for CHWDAT6R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CHWDAT6R to value 0
