...
///Field `CAN2SMEN` reader - CAN2 clocks enable during Sleep and Stop modes
pub type CAN2SMEN_R = crate::BitReader<bool>;
///Field `CAN2SMEN` writer - CAN2 clocks enable during Sleep and Stop modes
...
impl R {
    ...
    ///Bit 26 - CAN2 clocks enable during Sleep and Stop modes
    #[inline(always)]
