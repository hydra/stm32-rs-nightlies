///Register `DFSDM_FLT2AWHTR` reader
...
///Register `DFSDM_FLT2AWHTR` writer
...
///`read()` method returns [dfsdm_flt2awhtr::R](R) reader structure
impl crate::Readable for DFSDM_FLT2AWHTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dfsdm_flt2awhtr::W](W) writer structure
impl crate::Writable for DFSDM_FLT2AWHTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets DFSDM_FLT2AWHTR to value 0
