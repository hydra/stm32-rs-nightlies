...
///`read()` method returns [lut740h::R](R) reader structure
impl crate::Readable for LUT740H_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut740h::W](W) writer structure
impl crate::Writable for LUT740H_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT740H to value 0
