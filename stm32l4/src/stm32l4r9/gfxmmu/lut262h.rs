...
///`read()` method returns [lut262h::R](R) reader structure
impl crate::Readable for LUT262H_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut262h::W](W) writer structure
impl crate::Writable for LUT262H_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT262H to value 0
