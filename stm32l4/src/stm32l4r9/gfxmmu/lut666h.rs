...
///`read()` method returns [lut666h::R](R) reader structure
impl crate::Readable for LUT666H_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut666h::W](W) writer structure
impl crate::Writable for LUT666H_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT666H to value 0
