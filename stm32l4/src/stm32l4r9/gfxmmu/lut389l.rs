...
///`read()` method returns [lut389l::R](R) reader structure
impl crate::Readable for LUT389L_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut389l::W](W) writer structure
impl crate::Writable for LUT389L_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT389L to value 0
