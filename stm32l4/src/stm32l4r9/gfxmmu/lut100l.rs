...
///`read()` method returns [lut100l::R](R) reader structure
impl crate::Readable for LUT100L_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut100l::W](W) writer structure
impl crate::Writable for LUT100L_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT100L to value 0
