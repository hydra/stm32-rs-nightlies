...
///`read()` method returns [lut449l::R](R) reader structure
impl crate::Readable for LUT449L_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lut449l::W](W) writer structure
impl crate::Writable for LUT449L_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LUT449L to value 0
