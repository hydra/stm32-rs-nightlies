...
impl IR_MOD_R {
    ...
    ///Checks if the value of the field is `Tim16`
    #[inline(always)]
...
impl TIM16_DMA_RMP2_R {
    ...
    ///Checks if the value of the field is `NotAlternateRemapped`
    #[inline(always)]
    pub fn is_not_alternate_remapped(&self) -> bool {
        *self == TIM16_DMA_RMP2_A::NotAlternateRemapped
    }
    ///Checks if the value of the field is `AlternateRemapped`
    #[inline(always)]
