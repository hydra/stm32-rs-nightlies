...
///Field `PLLI2SDIVQ` reader - PLLI2S division factor for SAIs clock
...
///Field `PLLI2SDIVQ` writer - PLLI2S division factor for SAIs clock
...
///Field `PLLSAIDIVQ` reader - PLLSAI division factor for SAIs clock
...
///Field `PLLSAIDIVQ` writer - PLLSAI division factor for SAIs clock
...
///Field `SAI1SRC` reader - SAI1 clock source selection
...
///Field `SAI1SRC` writer - SAI1 clock source selection
...
///Field `SAI2SRC` reader - SAI2 clock source selection
...
pub enum SAI2SRC_A {
    ...
    Pllr = 2,
    ///3: SAI2 clock frequency = Alternate function input frequency
    HsiHse = 3,
}
...
///Field `SAI2SRC` writer - SAI2 clock source selection
...
///Field `I2S1SRC` reader - I2S APB1 clock source selection
...
///Field `I2S1SRC` writer - I2S APB1 clock source selection
...
///Field `I2S2SRC` reader - I2S APB2 clock source selection
pub use I2S1SRC_R as I2S2SRC_R;
///Field `I2S2SRC` writer - I2S APB2 clock source selection
