...
///Field `PLLI2SM` reader - Division factor for audio PLL (PLLI2S) input clock
pub type PLLI2SM_R = crate::FieldReader<u8, u8>;
///Field `PLLI2SM` writer - Division factor for audio PLL (PLLI2S) input clock
...
///Field `PLLI2SP` reader - PLLI2S division factor for SPDIF-IN clock
...
///Field `PLLI2SP` writer - PLLI2S division factor for SPDIF-IN clock
...
impl R {
    ...
    ///Bits 16:17 - PLLI2S division factor for SPDIF-IN clock
    #[inline(always)]
