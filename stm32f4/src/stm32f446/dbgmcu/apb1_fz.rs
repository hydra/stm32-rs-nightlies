...
pub type DBG_J2C3SMBUS_TIMEOUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB1_FZ_SPEC, bool, O>;
///Field `DBG_I2CFMP_SMBUS_TIMEOUT` reader - SMBUS timeout mode stopped when Core is halted
pub type DBG_I2CFMP_SMBUS_TIMEOUT_R = crate::BitReader<bool>;
///Field `DBG_I2CFMP_SMBUS_TIMEOUT` writer - SMBUS timeout mode stopped when Core is halted
...
impl R {
    ...
    ///Bit 24 - SMBUS timeout mode stopped when Core is halted
    #[inline(always)]
