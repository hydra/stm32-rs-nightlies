...
///Field `LPTIMER1RST` reader - LPTimer1 reset
...
///Field `CAN1RST` reader - CAN1RST
pub use TIM2RST_R as CAN1RST_R;
///Field `CAN2RST` reader - CAN2RST
...
///Field `UART7RST` reader - UART 7 reset
pub use TIM2RST_R as UART7RST_R;
///Field `UART8RST` reader - UART 8 reset
...
///Field `LPTIMER1RST` writer - LPTimer1 reset
...
///Field `CAN1RST` writer - CAN1RST
pub use TIM2RST_W as CAN1RST_W;
///Field `CAN2RST` writer - CAN2RST
...
///Field `UART7RST` writer - UART 7 reset
pub use TIM2RST_W as UART7RST_W;
///Field `UART8RST` writer - UART 8 reset
