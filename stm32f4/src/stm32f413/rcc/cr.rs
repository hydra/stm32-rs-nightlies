...
///Field `HSIRDY` writer - Internal high-speed clock ready flag
...
///Field `HSICAL` writer - Internal high-speed clock calibration
...
///Field `PLLRDY` writer - Main PLL (PLL) clock ready flag
pub use HSIRDY_W as PLLRDY_W;
///Field `PLLI2SRDY` writer - PLLI2S clock ready flag
