...
///Field `MUXEN` reader - Memory bank enable bit
...
///Field `MUXEN` writer - Memory bank enable bit
...
///Field `WREN` reader - Write enable bitWREN
...
///Field `WREN` writer - Write enable bitWREN
