...
///Field `PLLR` reader - PLL division factor for I2S and System clocks
pub type PLLR_R = crate::FieldReader<u8, u8>;
///Field `PLLR` writer - PLL division factor for I2S and System clocks
...
impl R {
    ...
    ///Bits 28:30 - PLL division factor for I2S and System clocks
    #[inline(always)]
...
///`reset()` method sets PLLCFGR to value 0x7f00_3010
