...
///Field `SPI6LPEN` reader - SPI6 clock enable during Sleep mode
...
///Field `SPI6LPEN` writer - SPI6 clock enable during Sleep mode
...
impl R {
    ...
    ///Bit 21 - SPI6 clock enable during Sleep mode
    #[inline(always)]
