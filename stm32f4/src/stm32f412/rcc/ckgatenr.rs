...
///Field `SRAM_CKEN` reader - SRAM controller clock enable
...
///Field `EVTCL_CKEN` reader - EVTCL clock enable
...
///Field `SRAM_CKEN` writer - SRAM controller clock enable
...
///Field `EVTCL_CKEN` writer - EVTCL clock enable
...
impl R {
    ...
    ///Bit 4 - SRAM controller clock enable
    #[inline(always)]
