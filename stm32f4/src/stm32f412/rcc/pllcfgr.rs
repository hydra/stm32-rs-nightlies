...
///Field `PLLR` reader - Main PLL division factor for I2S, DFSDM clocks
pub type PLLR_R = crate::FieldReader<u8, u8>;
///Field `PLLR` writer - Main PLL division factor for I2S, DFSDM clocks
...
impl R {
    ...
    ///Bits 28:30 - Main PLL division factor for I2S, DFSDM clocks
    #[inline(always)]
