...
///Field `REFCKON` reader - Reference clock detection enable
pub type REFCKON_R = crate::BitReader<bool>;
///Field `REFCKON` writer - Reference clock detection enable
