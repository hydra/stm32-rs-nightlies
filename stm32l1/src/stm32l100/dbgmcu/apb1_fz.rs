...
///Field `DBG_I2C2_SMBUS_TIMEOUT` reader - SMBUS timeout mode stopped when core is halted
pub type DBG_I2C2_SMBUS_TIMEOUT_R = crate::BitReader<bool>;
///Field `DBG_I2C2_SMBUS_TIMEOUT` writer - SMBUS timeout mode stopped when core is halted
