...
///Field `HTIE` reader - Half transfer error interrupt enable
...
///Field `HTIE` writer - Half transfer error interrupt enable
...
impl R {
    ...
    ///Bit 2 - Half transfer error interrupt enable
    #[inline(always)]
