...
///Field `UART9EN` reader - UART9 peripheral clocks enable
pub use TIM1EN_R as UART9EN_R;
///Field `USART10EN` reader - USART10 peripheral clocks enable
...
///Field `UART9EN` writer - UART9 peripheral clocks enable
pub use TIM1EN_W as UART9EN_W;
///Field `USART10EN` writer - USART10 peripheral clocks enable
...
impl R {
    ...
    ///Bit 6 - UART9 peripheral clocks enable
    #[inline(always)]
    pub fn uart9en(&self) -> UART9EN_R {
        UART9EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - USART10 peripheral clocks enable
    #[inline(always)]
