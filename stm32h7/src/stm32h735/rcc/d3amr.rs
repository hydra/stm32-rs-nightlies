...
///Field `DTSAMEN` reader - Digital temperature sensor Autonomous mode enable
...
///Field `DTSAMEN` writer - Digital temperature sensor Autonomous mode enable
...
impl R {
    ...
    ///Bit 26 - Digital temperature sensor Autonomous mode enable
    #[inline(always)]
