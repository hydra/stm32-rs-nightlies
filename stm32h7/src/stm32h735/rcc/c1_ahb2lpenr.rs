...
///Field `FMACLPEN` reader - FMAC enable during CSleep Mode
pub use DCMILPEN_R as FMACLPEN_R;
///Field `CORDICLPEN` reader - CORDIC enable during CSleep Mode
...
///Field `FMACLPEN` writer - FMAC enable during CSleep Mode
pub use DCMILPEN_W as FMACLPEN_W;
///Field `CORDICLPEN` writer - CORDIC enable during CSleep Mode
...
impl R {
    ...
    ///Bit 16 - FMAC enable during CSleep Mode
    #[inline(always)]
    pub fn fmaclpen(&self) -> FMACLPEN_R {
        FMACLPEN_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - CORDIC enable during CSleep Mode
    #[inline(always)]
