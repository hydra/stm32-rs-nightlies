...
///Field `UART9LPEN` reader - UART9 peripheral clocks enable during CSleep Mode
pub use TIM1LPEN_R as UART9LPEN_R;
///Field `USART10LPEN` reader - USART10 peripheral clocks enable during CSleep Mode
...
///Field `UART9LPEN` writer - UART9 peripheral clocks enable during CSleep Mode
pub use TIM1LPEN_W as UART9LPEN_W;
///Field `USART10LPEN` writer - USART10 peripheral clocks enable during CSleep Mode
...
impl R {
    ...
    ///Bit 6 - UART9 peripheral clocks enable during CSleep Mode
    #[inline(always)]
    pub fn uart9lpen(&self) -> UART9LPEN_R {
        UART9LPEN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - USART10 peripheral clocks enable during CSleep Mode
    #[inline(always)]
