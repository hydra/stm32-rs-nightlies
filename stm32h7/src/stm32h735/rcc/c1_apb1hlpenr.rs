...
///Field `TIM23LPEN` reader - TIM23 block enable during CSleep Mode
pub use CRSLPEN_R as TIM23LPEN_R;
///Field `TIM24LPEN` reader - TIM24 block enable during CSleep Mode
...
///Field `TIM23LPEN` writer - TIM23 block enable during CSleep Mode
pub use CRSLPEN_W as TIM23LPEN_W;
///Field `TIM24LPEN` writer - TIM24 block enable during CSleep Mode
...
impl R {
    ...
    ///Bit 24 - TIM23 block enable during CSleep Mode
    #[inline(always)]
    pub fn tim23lpen(&self) -> TIM23LPEN_R {
        TIM23LPEN_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - TIM24 block enable during CSleep Mode
    #[inline(always)]
