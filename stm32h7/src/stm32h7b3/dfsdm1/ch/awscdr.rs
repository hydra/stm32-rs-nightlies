...
///Field `BKSCD` reader - Break signal assignment for short-circuit detector on channel y BKSCD\[i\]
...
///Field `BKSCD` writer - Break signal assignment for short-circuit detector on channel y BKSCD\[i\]
///= 0: Break i signal not assigned to short-circuit detector on channel y BKSCD\[i\]
///= 1: Break i signal assigned to short-circuit detector on channel y
...
impl R {
    ...
    ///Bits 12:15 - Break signal assignment for short-circuit detector on channel y BKSCD\[i\]
    ///= 0: Break i signal not assigned to short-circuit detector on channel y BKSCD\[i\]
    ///= 1: Break i signal assigned to short-circuit detector on channel y
    #[inline(always)]
