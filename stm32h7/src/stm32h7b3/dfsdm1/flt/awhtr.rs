...
///Field `BKAWH` reader - Break signal assignment to analog watchdog high threshold event BKAWH\[i\]
...
///Field `BKAWH` writer - Break signal assignment to analog watchdog high threshold event BKAWH\[i\]
///= 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\]
///= 1: Break i signal is assigned to an analog watchdog high threshold event
...
impl R {
    ///Bits 0:3 - Break signal assignment to analog watchdog high threshold event BKAWH\[i\]
    ///= 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\]
    ///= 1: Break i signal is assigned to an analog watchdog high threshold event
    #[inline(always)]
