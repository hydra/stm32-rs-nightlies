...
///Field `SMP19` reader - ADC channel 19 sampling time selection
...
///Field `SMP19` writer - ADC channel 19 sampling time selection
...
impl R {
    ...
    ///Bits 27:29 - ADC channel 19 sampling time selection
    #[inline(always)]
