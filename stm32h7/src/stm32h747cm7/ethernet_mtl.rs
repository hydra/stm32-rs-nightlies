...
pub mod mtlomr;
///MTLISR (rw) register accessor: an alias for `Reg<MTLISR_SPEC>`
...
pub mod mtltx_qomr;
///MTLTxQUR (rw) register accessor: an alias for `Reg<MTLTX_QUR_SPEC>`
pub type MTLTX_QUR = crate::Reg<mtltx_qur::MTLTX_QUR_SPEC>;
///Tx queue underflow register
pub mod mtltx_qur;
///MTLTxQDR (rw) register accessor: an alias for `Reg<MTLTX_QDR_SPEC>`
...
pub mod mtlrx_qomr;
///MTLRxQMPOCR (rw) register accessor: an alias for `Reg<MTLRX_QMPOCR_SPEC>`
...
///MTLRxQDR (rw) register accessor: an alias for `Reg<MTLRX_QDR_SPEC>`
