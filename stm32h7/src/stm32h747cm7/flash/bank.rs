...
pub mod ccr;
///PRAR_CUR (rw) register accessor: an alias for `Reg<PRAR_CUR_SPEC>`
...
///FLASH secure address for bank 1
pub mod scar_prg;
///WPSN_CURR (rw) register accessor: an alias for `Reg<WPSN_CURR_SPEC>`
...
pub mod crceaddr;
///FAR (rw) register accessor: an alias for `Reg<FAR_SPEC>`
