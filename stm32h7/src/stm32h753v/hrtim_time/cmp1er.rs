...
///`read()` method returns [cmp1er::R](R) reader structure
impl crate::Readable for CMP1ER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cmp1er::W](W) writer structure
impl crate::Writable for CMP1ER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CMP1ER to value 0
