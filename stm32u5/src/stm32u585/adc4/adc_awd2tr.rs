...
pub type LT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADC_AWD2TR_SPEC, u16, u16, 12, O>;
///Field `HT2` reader - HT2
pub type HT2_R = crate::FieldReader<u16, u16>;
///Field `HT2` writer - HT2
pub type HT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADC_AWD2TR_SPEC, u16, u16, 12, O>;
impl R {
    ///Bits 0:11 - LT2
    #[inline(always)]
