...
pub struct R(crate::R<DOEPCTL8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOEPCTL8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOEPCTL8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOEPCTL8_SPEC>) -> Self {
        R(reader)
    }
}
///Register `DOEPCTL8` writer
pub struct W(crate::W<DOEPCTL8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEPCTL8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEPCTL8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEPCTL8_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MPSIZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOEPCTL8_SPEC, u16, u16, 11, O>;
///Field `USBAEP` reader - USBAEP
pub type USBAEP_R = crate::BitReader<bool>;
///Field `USBAEP` writer - USBAEP
pub type USBAEP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
...
pub type EPTYP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOEPCTL8_SPEC, u8, u8, 2, O>;
///Field `SNPM` reader - SNPM
pub type SNPM_R = crate::BitReader<bool>;
///Field `SNPM` writer - SNPM
pub type SNPM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `STALL` reader - STALL
pub type STALL_R = crate::BitReader<bool>;
///Field `STALL` writer - STALL
pub type STALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `CNAK` writer - CNAK
pub type CNAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `SNAK` writer - SNAK
pub type SNAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `SD0PID_SEVNFRM` writer - SD0PID_SEVNFRM
pub type SD0PID_SEVNFRM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `SD1PID_SODDFRM` writer - SD1PID_SODDFRM
pub type SD1PID_SODDFRM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `EPDIS` reader - EPDIS
pub type EPDIS_R = crate::BitReader<bool>;
///Field `EPDIS` writer - EPDIS
pub type EPDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
///Field `EPENA` reader - EPENA
pub type EPENA_R = crate::BitReader<bool>;
///Field `EPENA` writer - EPENA
pub type EPENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL8_SPEC, bool, O>;
impl R {
    ///Bits 0:10 - MPSIZ
    #[inline(always)]
...
///
///For information about available fields see [doepctl8](index.html) module
