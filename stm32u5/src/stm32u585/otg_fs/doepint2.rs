...
pub type AHBERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT2_SPEC, bool, O>;
...
pub type OUTPKTERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT2_SPEC, bool, O>;
///Field `BNA` reader - BNA
pub type BNA_R = crate::BitReader<bool>;
///Field `BNA` writer - BNA
pub type BNA_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT2_SPEC, bool, O>;
...
pub type STPKTRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT2_SPEC, bool, O>;
impl R {
    ///Bit 0 - XFRC
    #[inline(always)]
