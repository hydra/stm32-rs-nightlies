...
pub struct R(crate::R<GPDMA_SMISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_SMISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_SMISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_SMISR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [gpdma_smisr](index.html) module
pub struct GPDMA_SMISR_SPEC;
impl crate::RegisterSpec for GPDMA_SMISR_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_smisr::R](R) reader structure
impl crate::Readable for GPDMA_SMISR_SPEC {
    type Reader = R;
}
///`reset()` method sets GPDMA_SMISR to value 0
impl crate::Resettable for GPDMA_SMISR_SPEC {
