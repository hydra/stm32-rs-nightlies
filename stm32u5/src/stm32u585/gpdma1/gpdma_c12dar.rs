...
pub struct R(crate::R<GPDMA_C12DAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C12DAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C12DAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C12DAR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GPDMA_C12DAR` writer
pub struct W(crate::W<GPDMA_C12DAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C12DAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDMA_C12DAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C12DAR_SPEC>) -> Self {
        W(writer)
    }
}
...
///In linked-list mode, after a LLI data transfer is completed, this register is automatically updated by the GPDMA from the memory, provided the LLI is set with GPDMA_CxLLR.UDA = 1. Note: A destination address must be aligned with the programmed data width of a destination burst (DA\[2:0\]
///versus GPDMA_CxTR1.DDW_LOG2\[1:0\]). Else, a user setting error is reported and no transfer is issued.
pub type DA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C12DAR_SPEC, u32, u32, 32, O>;
impl R {
...
///
///For information about available fields see [gpdma_c12dar](index.html) module
pub struct GPDMA_C12DAR_SPEC;
impl crate::RegisterSpec for GPDMA_C12DAR_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c12dar::R](R) reader structure
impl crate::Readable for GPDMA_C12DAR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpdma_c12dar::W](W) writer structure
impl crate::Writable for GPDMA_C12DAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C12DAR to value 0
impl crate::Resettable for GPDMA_C12DAR_SPEC {
