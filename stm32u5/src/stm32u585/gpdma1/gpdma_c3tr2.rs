...
pub struct R(crate::R<GPDMA_C3TR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C3TR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C3TR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C3TR2_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GPDMA_C3TR2` writer
pub struct W(crate::W<GPDMA_C3TR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C3TR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDMA_C3TR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C3TR2_SPEC>) -> Self {
        W(writer)
    }
}
...
///value) to different active GPDMA channels (GPDMA_CxCR.EN = 1 and GPDMA_CxTR2.SWREQ = 0 for these channels). GPDMA is not intended to hardware support the case of simultaneous enabled channels incorrectly configured with a same hardware peripheral request signal, and there is no user setting error reporting.
pub type REQSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C3TR2_SPEC, u8, u8, 7, O>;
...
pub type SWREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C3TR2_SPEC, bool, O>;
...
pub type DREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C3TR2_SPEC, bool, O>;
...
pub type BREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C3TR2_SPEC, bool, O>;
...
///= 11 and (SWREQ =1 or (SWREQ = 0 and DREQ =0 )), the shortened burst transfer (by singles or/and by bursts of lower length) is conditioned once by the trigger. When the programmed destination burst is internally shortened by singles or/and by bursts of lower length (versus FIFO size, versus block size, 1-Kbyte boundary address crossing): if the trigger is conditioning the programmed destination burst (if TRIGM\[1:0\]
///= 11 and SWREQ = 0 and DREQ = 1), this shortened destination burst transfer is conditioned once by the trigger.
pub type TRIGM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C3TR2_SPEC, u8, u8, 2, O>;
...
///≠ 00.
pub type TRIGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C3TR2_SPEC, u8, u8, 6, O>;
...
pub type TRIGPOL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C3TR2_SPEC, u8, u8, 2, O>;
...
///= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI0 data transfer is null/void (i.e. directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
///=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI1.
pub type TCEM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C3TR2_SPEC, u8, u8, 2, O>;
impl R {
...
///
///For information about available fields see [gpdma_c3tr2](index.html) module
pub struct GPDMA_C3TR2_SPEC;
impl crate::RegisterSpec for GPDMA_C3TR2_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c3tr2::R](R) reader structure
impl crate::Readable for GPDMA_C3TR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpdma_c3tr2::W](W) writer structure
impl crate::Writable for GPDMA_C3TR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C3TR2 to value 0
impl crate::Resettable for GPDMA_C3TR2_SPEC {
