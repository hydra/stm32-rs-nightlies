...
pub struct R(crate::R<GPDMA_C8BR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C8BR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C8BR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C8BR1_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GPDMA_C8BR1` writer
pub struct W(crate::W<GPDMA_C8BR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C8BR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDMA_C8BR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C8BR1_SPEC>) -> Self {
        W(writer)
    }
}
...
///= 1 and destination data width different from source data width), a non-null source block size must be a multiple of the destination data width (BNDT\[2:0\]
///versus GPDMA_CxTR1.DDW_LOG2\[1:0\]). Else a user setting error is reported and no transfer is issued.
pub type BNDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C8BR1_SPEC, u16, u16, 16, O>;
impl R {
...
///
///For information about available fields see [gpdma_c8br1](index.html) module
pub struct GPDMA_C8BR1_SPEC;
impl crate::RegisterSpec for GPDMA_C8BR1_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c8br1::R](R) reader structure
impl crate::Readable for GPDMA_C8BR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpdma_c8br1::W](W) writer structure
impl crate::Writable for GPDMA_C8BR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C8BR1 to value 0
impl crate::Resettable for GPDMA_C8BR1_SPEC {
