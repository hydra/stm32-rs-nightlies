...
pub struct R(crate::R<TZSC_MPCWM4AR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TZSC_MPCWM4AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TZSC_MPCWM4AR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TZSC_MPCWM4AR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `TZSC_MPCWM4AR` writer
pub struct W(crate::W<TZSC_MPCWM4AR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TZSC_MPCWM4AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TZSC_MPCWM4AR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TZSC_MPCWM4AR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SUBA_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZSC_MPCWM4AR_SPEC, u16, u16, 11, O>;
...
pub type SUBA_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZSC_MPCWM4AR_SPEC, u16, u16, 12, O>;
impl R {
...
///
///For information about available fields see [tzsc_mpcwm4ar](index.html) module
