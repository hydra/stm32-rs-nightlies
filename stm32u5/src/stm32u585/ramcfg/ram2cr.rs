...
pub struct R(crate::R<RAM2CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAM2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAM2CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAM2CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `RAM2CR` writer
pub struct W(crate::W<RAM2CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAM2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAM2CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAM2CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ECCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2CR_SPEC, bool, O>;
///Field `ALE` reader - ALE
pub type ALE_R = crate::BitReader<bool>;
///Field `ALE` writer - ALE
pub type ALE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2CR_SPEC, bool, O>;
///Field `SRAMER` reader - SRAMER
pub type SRAMER_R = crate::BitReader<bool>;
///Field `SRAMER` writer - SRAMER
pub type SRAMER_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2CR_SPEC, bool, O>;
///Field `WSC` reader - WSC
pub type WSC_R = crate::FieldReader<u8, u8>;
///Field `WSC` writer - WSC
pub type WSC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RAM2CR_SPEC, u8, u8, 3, O>;
impl R {
    ///Bit 0 - ECCE
    #[inline(always)]
...
///
///For information about available fields see [ram2cr](index.html) module
pub struct RAM2CR_SPEC;
impl crate::RegisterSpec for RAM2CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [ram2cr::R](R) reader structure
impl crate::Readable for RAM2CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ram2cr::W](W) writer structure
impl crate::Writable for RAM2CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RAM2CR to value 0
impl crate::Resettable for RAM2CR_SPEC {
