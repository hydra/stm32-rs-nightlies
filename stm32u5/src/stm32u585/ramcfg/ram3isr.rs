...
pub struct R(crate::R<RAM3ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAM3ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAM3ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAM3ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [ram3isr](index.html) module
pub struct RAM3ISR_SPEC;
impl crate::RegisterSpec for RAM3ISR_SPEC {
    type Ux = u32;
}
///`read()` method returns [ram3isr::R](R) reader structure
impl crate::Readable for RAM3ISR_SPEC {
    type Reader = R;
}
///`reset()` method sets RAM3ISR to value 0
impl crate::Resettable for RAM3ISR_SPEC {
