...
pub type ETRSEL_R = crate::FieldReader<u32, u32>;
///Field `ETRSEL` writer - DMA register for burst accesses
pub type ETRSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etrsel(&mut self) -> ETRSEL_W<0> {
        ETRSEL_W::new(self)
    }
