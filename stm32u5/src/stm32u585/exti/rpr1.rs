...
pub type RPIF17_R = crate::BitReader<bool>;
///Field `RPIF17` writer - configurable event inputs x rising edge pending bit
pub type RPIF17_W<'a, const O: u8> = crate::BitWriter<'a, u32, RPR1_SPEC, bool, O>;
///Field `RPIF18` reader - configurable event inputs x rising edge pending bit
pub type RPIF18_R = crate::BitReader<bool>;
///Field `RPIF18` writer - configurable event inputs x rising edge pending bit
pub type RPIF18_W<'a, const O: u8> = crate::BitWriter<'a, u32, RPR1_SPEC, bool, O>;
///Field `RPIF19` reader - configurable event inputs x rising edge pending bit
pub type RPIF19_R = crate::BitReader<bool>;
///Field `RPIF19` writer - configurable event inputs x rising edge pending bit
pub type RPIF19_W<'a, const O: u8> = crate::BitWriter<'a, u32, RPR1_SPEC, bool, O>;
///Field `RPIF20` reader - configurable event inputs x rising edge pending bit
pub type RPIF20_R = crate::BitReader<bool>;
///Field `RPIF20` writer - configurable event inputs x rising edge pending bit
pub type RPIF20_W<'a, const O: u8> = crate::BitWriter<'a, u32, RPR1_SPEC, bool, O>;
///Field `RPIF21` reader - configurable event inputs x rising edge pending bit
pub type RPIF21_R = crate::BitReader<bool>;
///Field `RPIF21` writer - configurable event inputs x rising edge pending bit
pub type RPIF21_W<'a, const O: u8> = crate::BitWriter<'a, u32, RPR1_SPEC, bool, O>;
///Field `RPIF22` reader - configurable event inputs x rising edge pending bit
pub type RPIF22_R = crate::BitReader<bool>;
///Field `RPIF22` writer - configurable event inputs x rising edge pending bit
...
impl R {
    ...
    ///Bit 19 - configurable event inputs x rising edge pending bit
    #[inline(always)]
    pub fn rpif19(&self) -> RPIF19_R {
        RPIF19_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - configurable event inputs x rising edge pending bit
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rpif19(&mut self) -> RPIF19_W<19> {
        RPIF19_W::new(self)
    }
    ///Bit 20 - configurable event inputs x rising edge pending bit
    #[inline(always)]
