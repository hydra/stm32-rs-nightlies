...
///Field `FT17` reader - Falling trigger event configuration bit of configurable event input x
pub type FT17_R = crate::BitReader<bool>;
///Field `FT17` writer - Falling trigger event configuration bit of configurable event input x
pub type FT17_W<'a, const O: u8> = crate::BitWriter<'a, u32, FTSR1_SPEC, bool, O>;
///Field `FT18` reader - Falling trigger event configuration bit of configurable event input x
pub type FT18_R = crate::BitReader<bool>;
///Field `FT18` writer - Falling trigger event configuration bit of configurable event input x
pub type FT18_W<'a, const O: u8> = crate::BitWriter<'a, u32, FTSR1_SPEC, bool, O>;
///Field `FT19` reader - Falling trigger event configuration bit of configurable event input x
pub type FT19_R = crate::BitReader<bool>;
///Field `FT19` writer - Falling trigger event configuration bit of configurable event input x
