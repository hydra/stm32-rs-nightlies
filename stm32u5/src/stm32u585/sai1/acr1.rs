...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ACR1_SPEC, u8, u8, 2, O>;
...
pub type PRTCFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ACR1_SPEC, u8, u8, 2, O>;
///Field `DS` reader - Data size
pub type DS_R = crate::FieldReader<u8, u8>;
///Field `DS` writer - Data size
pub type DS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ACR1_SPEC, u8, u8, 3, O>;
...
pub type LSBFIRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, ACR1_SPEC, bool, O>;
///Field `CKSTR` reader - Clock strobing edge
pub type CKSTR_R = crate::BitReader<bool>;
///Field `CKSTR` writer - Clock strobing edge
pub type CKSTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ACR1_SPEC, bool, O>;
