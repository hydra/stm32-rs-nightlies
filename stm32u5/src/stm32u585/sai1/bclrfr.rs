...
pub type COVRUDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, bool, O>;
///Field `CMUTEDET` writer - Mute detection flag
pub type CMUTEDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, bool, O>;
///Field `CWCKCFG` writer - Clear wrong clock configuration flag
pub type CWCKCFG_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, bool, O>;
///Field `CCNRDY` writer - Clear codec not ready flag
pub type CCNRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, bool, O>;
///Field `CAFSDET` writer - Clear anticipated frame synchronization detection flag
pub type CAFSDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, bool, O>;
///Field `CLFSDET` writer - Clear late frame synchronization detection flag
pub type CLFSDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, bool, O>;
impl W {
