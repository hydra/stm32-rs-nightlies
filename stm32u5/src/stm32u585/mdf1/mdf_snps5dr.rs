...
pub struct R(crate::R<MDF_SNPS5DR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_SNPS5DR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_SNPS5DR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_SNPS5DR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [mdf_snps5dr](index.html) module
pub struct MDF_SNPS5DR_SPEC;
impl crate::RegisterSpec for MDF_SNPS5DR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_snps5dr::R](R) reader structure
impl crate::Readable for MDF_SNPS5DR_SPEC {
    type Reader = R;
}
///`reset()` method sets MDF_SNPS5DR to value 0
impl crate::Resettable for MDF_SNPS5DR_SPEC {
