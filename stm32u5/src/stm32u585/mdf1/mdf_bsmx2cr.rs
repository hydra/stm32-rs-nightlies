...
pub struct R(crate::R<MDF_BSMX2CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_BSMX2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_BSMX2CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_BSMX2CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_BSMX2CR` writer
pub struct W(crate::W<MDF_BSMX2CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_BSMX2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_BSMX2CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_BSMX2CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BSSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_BSMX2CR_SPEC, u8, u8, 5, O>;
...
///
///For information about available fields see [mdf_bsmx2cr](index.html) module
pub struct MDF_BSMX2CR_SPEC;
impl crate::RegisterSpec for MDF_BSMX2CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_bsmx2cr::R](R) reader structure
impl crate::Readable for MDF_BSMX2CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_bsmx2cr::W](W) writer structure
impl crate::Writable for MDF_BSMX2CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_BSMX2CR to value 0
impl crate::Resettable for MDF_BSMX2CR_SPEC {
