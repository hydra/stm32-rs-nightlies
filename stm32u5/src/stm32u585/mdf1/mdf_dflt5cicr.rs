...
pub struct R(crate::R<MDF_DFLT5CICR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_DFLT5CICR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_DFLT5CICR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_DFLT5CICR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_DFLT5CICR` writer
pub struct W(crate::W<MDF_DFLT5CICR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_DFLT5CICR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_DFLT5CICR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_DFLT5CICR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATSRC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT5CICR_SPEC, u8, u8, 2, O>;
...
///is equal to 0xx , the CIC is split into two filters: - The main CIC (MCIC) - The auxiliary CIC (ACIC), used for the out-off limit detector - 000: The CIC is split into 2 filters, and the main CIC (MCIC) is configured in FastSinc filter - 001: The CIC is split into 2 filters, and the main CIC (MCIC) is configured in Sinc1 filter - 010: The CIC is split into 2 filters, and the main CIC (MCIC) is configured in Sinc2 filter - 011: The CIC is split into 2 filters, and the main CIC (MCIC) is configured in Sinc3 filter - 100: The CIC is configured in single sinc4 filter others: The CIC is configured in single sinc5 filter This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type CICMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT5CICR_SPEC, u8, u8, 3, O>;
...
pub type MCICD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT5CICR_SPEC, u16, u16, 9, O>;
...
///field will inform the application on the current gain value. - 100000: - 48.2 dB, or shift right by 8 bits (default value) - 100001: - 44.6 dB, - 100010: - 42.1 dB, or shift right by 7 bits - 100011: - 38.6 dB, ... - 101110: -6 dB, or shift right by 1 bit - 101111: -2.5 dB, - 000000: 0 dB - 000001: + 3.5 dB, - 000010: + 6 dB, or shift left by 1 bit ... - 011000: + 72 dB, or shift left by 12 bits
pub type SCALE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT5CICR_SPEC, u8, u8, 6, O>;
impl R {
...
///
///For information about available fields see [mdf_dflt5cicr](index.html) module
pub struct MDF_DFLT5CICR_SPEC;
impl crate::RegisterSpec for MDF_DFLT5CICR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_dflt5cicr::R](R) reader structure
impl crate::Readable for MDF_DFLT5CICR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_dflt5cicr::W](W) writer structure
impl crate::Writable for MDF_DFLT5CICR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_DFLT5CICR to value 0
impl crate::Resettable for MDF_DFLT5CICR_SPEC {
