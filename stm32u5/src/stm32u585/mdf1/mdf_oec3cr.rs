...
pub struct R(crate::R<MDF_OEC3CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_OEC3CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_OEC3CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_OEC3CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_OEC3CR` writer
pub struct W(crate::W<MDF_OEC3CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_OEC3CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_OEC3CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_OEC3CR_SPEC>) -> Self {
        W(writer)
    }
}
...
///field will inform the application on the current offset value. OFFSET\[25:0\]
///represents the value to be subtracted to the signal before going to the SCALE.
pub type OFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_OEC3CR_SPEC, u32, u32, 26, O>;
impl R {
...
///
///For information about available fields see [mdf_oec3cr](index.html) module
pub struct MDF_OEC3CR_SPEC;
impl crate::RegisterSpec for MDF_OEC3CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_oec3cr::R](R) reader structure
impl crate::Readable for MDF_OEC3CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_oec3cr::W](W) writer structure
impl crate::Writable for MDF_OEC3CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_OEC3CR to value 0
impl crate::Resettable for MDF_OEC3CR_SPEC {
