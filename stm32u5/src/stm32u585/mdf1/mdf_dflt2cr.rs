...
pub struct R(crate::R<MDF_DFLT2CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_DFLT2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_DFLT2CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_DFLT2CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_DFLT2CR` writer
pub struct W(crate::W<MDF_DFLT2CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_DFLT2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_DFLT2CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_DFLT2CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DFLTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT2CR_SPEC, bool, O>;
...
pub type DMAEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT2CR_SPEC, bool, O>;
...
pub type FTH_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT2CR_SPEC, bool, O>;
...
pub type ACQMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT2CR_SPEC, u8, u8, 3, O>;
...
pub type TRGSENS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT2CR_SPEC, bool, O>;
...
///is selected ... - 1111: mdf_trg\[13\]
///is selected This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type TRGSRC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT2CR_SPEC, u8, u8, 4, O>;
...
///of MDF_SNPSxDR register, leaving a data resolution of 16 bits. This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type SNPSFMT_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT2CR_SPEC, bool, O>;
...
pub type NBDIS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT2CR_SPEC, u8, u8, 8, O>;
...
///
///For information about available fields see [mdf_dflt2cr](index.html) module
pub struct MDF_DFLT2CR_SPEC;
impl crate::RegisterSpec for MDF_DFLT2CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_dflt2cr::R](R) reader structure
impl crate::Readable for MDF_DFLT2CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_dflt2cr::W](W) writer structure
impl crate::Writable for MDF_DFLT2CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_DFLT2CR to value 0
impl crate::Resettable for MDF_DFLT2CR_SPEC {
