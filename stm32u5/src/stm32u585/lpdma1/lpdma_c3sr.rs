...
pub struct R(crate::R<LPDMA_C3SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPDMA_C3SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPDMA_C3SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPDMA_C3SR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [lpdma_c3sr](index.html) module
pub struct LPDMA_C3SR_SPEC;
impl crate::RegisterSpec for LPDMA_C3SR_SPEC {
    type Ux = u32;
}
///`read()` method returns [lpdma_c3sr::R](R) reader structure
impl crate::Readable for LPDMA_C3SR_SPEC {
    type Reader = R;
}
///`reset()` method sets LPDMA_C3SR to value 0x01
impl crate::Resettable for LPDMA_C3SR_SPEC {
