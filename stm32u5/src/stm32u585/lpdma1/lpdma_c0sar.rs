...
pub struct R(crate::R<LPDMA_C0SAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPDMA_C0SAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPDMA_C0SAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPDMA_C0SAR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `LPDMA_C0SAR` writer
pub struct W(crate::W<LPDMA_C0SAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPDMA_C0SAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPDMA_C0SAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPDMA_C0SAR_SPEC>) -> Self {
        W(writer)
    }
}
...
///versus LPDMA_CxTR1.SDW_LOG2\[1:0\]). Else, a user setting error is reported and no transfer is issued.
pub type SA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C0SAR_SPEC, u32, u32, 32, O>;
impl R {
...
///
///For information about available fields see [lpdma_c0sar](index.html) module
pub struct LPDMA_C0SAR_SPEC;
impl crate::RegisterSpec for LPDMA_C0SAR_SPEC {
    type Ux = u32;
}
///`read()` method returns [lpdma_c0sar::R](R) reader structure
impl crate::Readable for LPDMA_C0SAR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lpdma_c0sar::W](W) writer structure
impl crate::Writable for LPDMA_C0SAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LPDMA_C0SAR to value 0
impl crate::Resettable for LPDMA_C0SAR_SPEC {
