...
pub struct R(crate::R<LPDMA_C1BR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPDMA_C1BR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPDMA_C1BR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPDMA_C1BR1_SPEC>) -> Self {
        R(reader)
    }
}
///Register `LPDMA_C1BR1` writer
pub struct W(crate::W<LPDMA_C1BR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPDMA_C1BR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPDMA_C1BR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPDMA_C1BR1_SPEC>) -> Self {
        W(writer)
    }
}
...
///= 0, this field is internally restored to the programmed value (infinite/continuous last LLI). - if LPDMA_CxLLR = 0, this field is kept as zero following the last LLI data transfer. Note: A non-null source block size must be a multiple of the source data width (BNDT\[2:0\]
///versus LPDMA_CxTR1.SDW_LOG2\[1:0\]). Else a user setting error is reported and none transfer is issued.
pub type BNDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1BR1_SPEC, u16, u16, 16, O>;
impl R {
...
///
///For information about available fields see [lpdma_c1br1](index.html) module
pub struct LPDMA_C1BR1_SPEC;
impl crate::RegisterSpec for LPDMA_C1BR1_SPEC {
    type Ux = u32;
}
///`read()` method returns [lpdma_c1br1::R](R) reader structure
impl crate::Readable for LPDMA_C1BR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lpdma_c1br1::W](W) writer structure
impl crate::Writable for LPDMA_C1BR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LPDMA_C1BR1 to value 0
impl crate::Resettable for LPDMA_C1BR1_SPEC {
