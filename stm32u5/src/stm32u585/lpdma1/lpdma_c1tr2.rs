...
pub struct R(crate::R<LPDMA_C1TR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPDMA_C1TR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPDMA_C1TR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPDMA_C1TR2_SPEC>) -> Self {
        R(reader)
    }
}
///Register `LPDMA_C1TR2` writer
pub struct W(crate::W<LPDMA_C1TR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPDMA_C1TR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPDMA_C1TR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPDMA_C1TR2_SPEC>) -> Self {
        W(writer)
    }
}
...
///value) to different active DMA channels (LPDMA_CxCR.EN = 1 and LPDMA_CxTR2.SWREQ = 0 for these channels). DMA is not intended to hardware support the case of simultaneous enabled channels incorrectly configured with a same hardware peripheral request signal, and there is no user setting error reporting.
pub type REQSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR2_SPEC, u8, u8, 5, O>;
...
pub type SWREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR2_SPEC, bool, O>;
...
pub type BREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR2_SPEC, bool, O>;
...
///is not modified, and the channel is enabled. Transferring a next LLIn+1 that updates the LPDMA_CxTR2 with a new value for any of TRIGSEL\[4:0\]
///or TRIGPOL\[1:0\], resets the monitoring, trashing the memorized hit of the formerly defined LLIn trigger. After a first new trigger hitn+1 is memorized, if another second trigger hitn+2 is detected and if the hitn triggered transfer is still not completed, hitn+2 is lost and not memorized, and a trigger overrun flag is reported (LPDMA_CxSR.TOF = 1), an interrupt is generated if enabled (LPDMA_CxCR.TOIE = 1). The channel is not automatically disabled by hardware due to a trigger overrun.
pub type TRIGM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR2_SPEC, u8, u8, 2, O>;
...
///= 00.
pub type TRIGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR2_SPEC, u8, u8, 5, O>;
...
pub type TRIGPOL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR2_SPEC, u8, u8, 2, O>;
...
///= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI0 data transfer is null/void (i.e. directly programmed by the internal register file with LPDMA_CxBR1.BNDT\[15:0\]
///=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI1.
pub type TCEM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR2_SPEC, u8, u8, 2, O>;
impl R {
...
///
///For information about available fields see [lpdma_c1tr2](index.html) module
pub struct LPDMA_C1TR2_SPEC;
impl crate::RegisterSpec for LPDMA_C1TR2_SPEC {
    type Ux = u32;
}
///`read()` method returns [lpdma_c1tr2::R](R) reader structure
impl crate::Readable for LPDMA_C1TR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lpdma_c1tr2::W](W) writer structure
impl crate::Writable for LPDMA_C1TR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LPDMA_C1TR2 to value 0
impl crate::Resettable for LPDMA_C1TR2_SPEC {
