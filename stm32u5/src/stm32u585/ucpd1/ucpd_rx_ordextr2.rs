///Register `UCPD_RX_ORDEXTR2` reader
...
///Register `UCPD_RX_ORDEXTR2` writer
...
///`read()` method returns [ucpd_rx_ordextr2::R](R) reader structure
impl crate::Readable for UCPD_RX_ORDEXTR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ucpd_rx_ordextr2::W](W) writer structure
impl crate::Writable for UCPD_RX_ORDEXTR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets UCPD_RX_ORDEXTR2 to value 0
