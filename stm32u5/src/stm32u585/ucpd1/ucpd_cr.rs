...
pub type CC1VCONNEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UCPD_CR_SPEC, bool, O>;
...
pub type CC2VCONNEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UCPD_CR_SPEC, bool, O>;
...
///`read()` method returns [ucpd_cr::R](R) reader structure
impl crate::Readable for UCPD_CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ucpd_cr::W](W) writer structure
impl crate::Writable for UCPD_CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets UCPD_CR to value 0
