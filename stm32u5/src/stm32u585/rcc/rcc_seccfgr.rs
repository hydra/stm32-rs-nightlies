...
pub struct R(crate::R<RCC_SECCFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_SECCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_SECCFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_SECCFGR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `RCC_SECCFGR` writer
pub struct W(crate::W<RCC_SECCFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_SECCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_SECCFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_SECCFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type HSISEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type HSESEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
///Field `MSISEC` reader - MSI clock configuration and status bits security Set and reset by software.
pub type MSISEC_R = crate::BitReader<bool>;
///Field `MSISEC` writer - MSI clock configuration and status bits security Set and reset by software.
pub type MSISEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type LSISEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type LSESEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type SYSCLKSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type PRESCSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type PLL1SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type PLL2SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type PLL3SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
///Field `ICLKSEC` reader - intermediate clock source selection security Set and reset by software.
pub type ICLKSEC_R = crate::BitReader<bool>;
///Field `ICLKSEC` writer - intermediate clock source selection security Set and reset by software.
pub type ICLKSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type HSI48SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
...
pub type RMVFSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_SECCFGR_SPEC, bool, O>;
impl R {
    ...
    ///Bit 2 - MSI clock configuration and status bits security Set and reset by software.
    #[inline(always)]
    ...
    ///Bit 10 - intermediate clock source selection security Set and reset by software.
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iclksec(&mut self) -> ICLKSEC_W<10> {
        ICLKSEC_W::new(self)
    }
    ///Bit 11 - HSI48 clock configuration and status bits security Set and reset by software.
    #[inline(always)]
...
///
///For information about available fields see [rcc_seccfgr](index.html) module
pub struct RCC_SECCFGR_SPEC;
impl crate::RegisterSpec for RCC_SECCFGR_SPEC {
    type Ux = u32;
}
///`read()` method returns [rcc_seccfgr::R](R) reader structure
impl crate::Readable for RCC_SECCFGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_seccfgr::W](W) writer structure
impl crate::Writable for RCC_SECCFGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_SECCFGR to value 0
impl crate::Resettable for RCC_SECCFGR_SPEC {
