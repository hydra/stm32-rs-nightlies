...
pub struct R(crate::R<RCC_PLL3DIVR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_PLL3DIVR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_PLL3DIVR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_PLL3DIVR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `RCC_PLL3DIVR` writer
pub struct W(crate::W<RCC_PLL3DIVR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_PLL3DIVR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_PLL3DIVR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_PLL3DIVR_SPEC>) -> Self {
        W(writer)
    }
}
///Field `PLL3N` reader - Multiplication factor for PLL3 VCO Set and reset by software to control the multiplication factor of the VCO. These bits can be written only when the PLL is disabled (PLL3ON = 0 and PLL3RDY = 0). ... ... Others: reserved VCO output frequency = Fref3_ck x PLL3N, when fractional value 0 has been loaded into PLL3FRACN, with: PLL3N between 4 and 512 input frequency Fref3_ck between 4 and 16MHz
pub type PLL3N_R = crate::FieldReader<u16, u16>;
///Field `PLL3N` writer - Multiplication factor for PLL3 VCO Set and reset by software to control the multiplication factor of the VCO. These bits can be written only when the PLL is disabled (PLL3ON = 0 and PLL3RDY = 0). ... ... Others: reserved VCO output frequency = Fref3_ck x PLL3N, when fractional value 0 has been loaded into PLL3FRACN, with: PLL3N between 4 and 512 input frequency Fref3_ck between 4 and 16MHz
pub type PLL3N_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3DIVR_SPEC, u16, u16, 9, O>;
...
pub type PLL3P_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3DIVR_SPEC, u8, u8, 7, O>;
...
pub type PLL3Q_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3DIVR_SPEC, u8, u8, 7, O>;
///Field `PLL3R` reader - PLL3 DIVR division factor Set and reset by software to control the frequency of the pll3_r_ck clock. These bits can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ...
pub type PLL3R_R = crate::FieldReader<u8, u8>;
///Field `PLL3R` writer - PLL3 DIVR division factor Set and reset by software to control the frequency of the pll3_r_ck clock. These bits can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ...
pub type PLL3R_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3DIVR_SPEC, u8, u8, 7, O>;
impl R {
    ...
    ///Bits 24:30 - PLL3 DIVR division factor Set and reset by software to control the frequency of the pll3_r_ck clock. These bits can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ...
    #[inline(always)]
...
///
///For information about available fields see [rcc_pll3divr](index.html) module
pub struct RCC_PLL3DIVR_SPEC;
impl crate::RegisterSpec for RCC_PLL3DIVR_SPEC {
    type Ux = u32;
}
///`read()` method returns [rcc_pll3divr::R](R) reader structure
impl crate::Readable for RCC_PLL3DIVR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_pll3divr::W](W) writer structure
impl crate::Writable for RCC_PLL3DIVR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_PLL3DIVR to value 0x0101_0280
impl crate::Resettable for RCC_PLL3DIVR_SPEC {
