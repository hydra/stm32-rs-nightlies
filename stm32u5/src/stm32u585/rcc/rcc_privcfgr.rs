...
pub struct R(crate::R<RCC_PRIVCFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_PRIVCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_PRIVCFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_PRIVCFGR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `RCC_PRIVCFGR` writer
pub struct W(crate::W<RCC_PRIVCFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_PRIVCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_PRIVCFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_PRIVCFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SPRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_PRIVCFGR_SPEC, bool, O>;
...
pub type NSPRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_PRIVCFGR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [rcc_privcfgr](index.html) module
pub struct RCC_PRIVCFGR_SPEC;
impl crate::RegisterSpec for RCC_PRIVCFGR_SPEC {
    type Ux = u32;
}
///`read()` method returns [rcc_privcfgr::R](R) reader structure
impl crate::Readable for RCC_PRIVCFGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [rcc_privcfgr::W](W) writer structure
impl crate::Writable for RCC_PRIVCFGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RCC_PRIVCFGR to value 0
impl crate::Resettable for RCC_PRIVCFGR_SPEC {
