...
pub struct RegisterBlock {
    ...
    ///0x04 - offset trimming register in normal mode
    pub opamp1_otr: OPAMP1_OTR,
    ///0x08 - offset trimming register in low-power mode
    pub opamp1_lpotr: OPAMP1_LPOTR,
    _reserved3: [u8; 0x04],
    ///0x10 - control/status register
    pub opamp2_crs: OPAMP2_CRS,
    ///0x14 - offset trimming register in normal mode
    pub opamp2_otr: OPAMP2_OTR,
    ///0x18 - offset trimming register in low-power mode
...
///OPAMP2_CRS (rw) register accessor: an alias for `Reg<OPAMP2_CRS_SPEC>`
