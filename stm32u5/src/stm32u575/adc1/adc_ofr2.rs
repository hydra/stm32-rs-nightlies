...
///= 4, this is OFFSET1\[25:0\]
///that is subtracted when converting channel 4.
pub type OFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADC_OFR2_SPEC, u32, u32, 24, O>;
...
pub type POSOFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADC_OFR2_SPEC, bool, O>;
...
pub type USAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADC_OFR2_SPEC, bool, O>;
...
pub type SSAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADC_OFR2_SPEC, bool, O>;
...
///bits applies. Note: The software is allowed to write these bits only when ADSTART = 0 and JADSTART = 0 (which ensures that no conversion is ongoing). If OFFSETy_EN bit is set, it is not allowed to select the same channel in different ADC_OFRy registers.
pub type OFFSET_CH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADC_OFR2_SPEC, u8, u8, 5, O>;
impl R {
