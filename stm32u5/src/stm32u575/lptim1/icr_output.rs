...
pub type CC1IF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_OUTPUT_SPEC, bool, O>;
...
pub type CC2CF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_OUTPUT_SPEC, bool, O>;
///Field `CMP2OKCF` writer - Compare register 2 update OK clear flag
pub type CMP2OKCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_OUTPUT_SPEC, bool, O>;
