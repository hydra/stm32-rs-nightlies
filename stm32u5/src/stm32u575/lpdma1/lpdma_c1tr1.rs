...
pub struct R(crate::R<LPDMA_C1TR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPDMA_C1TR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPDMA_C1TR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPDMA_C1TR1_SPEC>) -> Self {
        R(reader)
    }
}
///Register `LPDMA_C1TR1` writer
pub struct W(crate::W<LPDMA_C1TR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPDMA_C1TR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPDMA_C1TR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPDMA_C1TR1_SPEC>) -> Self {
        W(writer)
    }
}
...
///versus SDW_LOG2\[1:0\]). Otherwise, a user setting error is reported and no transfer is issued. A source single transfer must have an aligned address with its data width (start address LPDMA_CxSAR\[2:0\]
///versus SDW_LOG2\[1:0\]). Otherwise, a user setting error is reported and none transfer is issued.
pub type SDW_LOG2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR1_SPEC, u8, u8, 2, O>;
...
pub type SINC_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR1_SPEC, bool, O>;
...
pub type PAM_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR1_SPEC, bool, O>;
...
pub type SSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR1_SPEC, bool, O>;
...
///versus DDW_LOG2\[1:0\]). Otherwise a user setting error is reported and none transfer is issued.
pub type DDW_LOG2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C1TR1_SPEC, u8, u8, 2, O>;
...
pub type DINC_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR1_SPEC, bool, O>;
...
pub type DSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C1TR1_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [lpdma_c1tr1](index.html) module
pub struct LPDMA_C1TR1_SPEC;
impl crate::RegisterSpec for LPDMA_C1TR1_SPEC {
    type Ux = u32;
}
///`read()` method returns [lpdma_c1tr1::R](R) reader structure
impl crate::Readable for LPDMA_C1TR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lpdma_c1tr1::W](W) writer structure
impl crate::Writable for LPDMA_C1TR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LPDMA_C1TR1 to value 0
impl crate::Resettable for LPDMA_C1TR1_SPEC {
