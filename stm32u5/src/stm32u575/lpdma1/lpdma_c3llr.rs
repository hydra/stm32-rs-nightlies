...
pub struct R(crate::R<LPDMA_C3LLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPDMA_C3LLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPDMA_C3LLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPDMA_C3LLR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `LPDMA_C3LLR` writer
pub struct W(crate::W<LPDMA_C3LLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPDMA_C3LLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPDMA_C3LLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPDMA_C3LLR_SPEC>) -> Self {
        W(writer)
    }
}
...
///= 0, the current LLI is the last one. The channel transfer is completed without any update of the linked-list DMA register file. Else, this field is the pointer to the memory address offset from which the next linked-list data structure is automatically fetched from, once the data transfer is completed, in order to conditionally update the linked-list DMA internal register file (LPDMA_CxCTR1, LPDMA_CxTR2, LPDMA_CxBR1, LPDMA_CxSAR, LPDMA_CxDAR and LPDMA_CxLLR). Note: The user must program the pointer to be 32-bit aligned. The two low-significant bits are write ignored.
pub type LA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPDMA_C3LLR_SPEC, u16, u16, 14, O>;
...
pub type ULL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C3LLR_SPEC, bool, O>;
...
pub type UDA_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C3LLR_SPEC, bool, O>;
...
pub type USA_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C3LLR_SPEC, bool, O>;
...
pub type UB1_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C3LLR_SPEC, bool, O>;
...
pub type UT2_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C3LLR_SPEC, bool, O>;
...
pub type UT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPDMA_C3LLR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [lpdma_c3llr](index.html) module
pub struct LPDMA_C3LLR_SPEC;
impl crate::RegisterSpec for LPDMA_C3LLR_SPEC {
    type Ux = u32;
}
///`read()` method returns [lpdma_c3llr::R](R) reader structure
impl crate::Readable for LPDMA_C3LLR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lpdma_c3llr::W](W) writer structure
impl crate::Writable for LPDMA_C3LLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets LPDMA_C3LLR to value 0
impl crate::Resettable for LPDMA_C3LLR_SPEC {
