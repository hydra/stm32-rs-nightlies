...
pub struct R(crate::R<RAM1ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAM1ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAM1ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAM1ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [ram1isr](index.html) module
pub struct RAM1ISR_SPEC;
impl crate::RegisterSpec for RAM1ISR_SPEC {
    type Ux = u32;
}
///`read()` method returns [ram1isr::R](R) reader structure
impl crate::Readable for RAM1ISR_SPEC {
    type Reader = R;
}
///`reset()` method sets RAM1ISR to value 0
impl crate::Resettable for RAM1ISR_SPEC {
