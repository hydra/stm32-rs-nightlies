...
pub struct W(crate::W<FCR4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FCR4_SPEC>;
    #[inline(always)]
...
impl From<crate::W<FCR4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FCR4_SPEC>) -> Self {
        W(writer)
    }
}
///Field `CGPDMA1F` writer - clear the illegal access flag for GPDMA1
pub type CGPDMA1F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CFLASHF` writer - clear the illegal access flag for FLASH memory
pub type CFLASHF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CFLASH_REGF` writer - clear the illegal access flag for FLASH registers
pub type CFLASH_REGF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `COTFDEC1F` writer - clear the illegal access flag for OTFDEC1
pub type COTFDEC1F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `COTFDEC2F` writer - clear the illegal access flag for OTFDEC2
pub type COTFDEC2F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CTZSC1F` writer - clear the illegal access flag for GTZC1 TZSC registers
pub type CTZSC1F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CTZIC1F` writer - clear the illegal access flag for GTZC1 TZIC registers
pub type CTZIC1F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `COCTOSPI1_MEMF` writer - clear the illegal access flag for MPCWM1 (OCTOSPI1) memory bank
pub type COCTOSPI1_MEMF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CFSMC_MEMF` writer - clear the illegal access flag for MPCWM2 (FSMC NAND) and MPCWM3
pub type CFSMC_MEMF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CBKPSRAMF` writer - clear the illegal access flag for MPCWM3 (BKPSRAM) memory bank
pub type CBKPSRAMF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `COCTOSPI2_MEMF` writer - clear the illegal access flag for OCTOSPI2 memory bank
pub type COCTOSPI2_MEMF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CSRAM1F` writer - clear the illegal access flag for SRAM1
pub type CSRAM1F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CMPCBB1_REGF` writer - clear the illegal access flag for MPCBB1 registers
pub type CMPCBB1_REGF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CSRAM2F` writer - clear the illegal access flag for SRAM2
pub type CSRAM2F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CMPCBB2_REGF` writer - clear the illegal access flag for MPCBB2 registers
pub type CMPCBB2_REGF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CSRAM3F` writer - clear the illegal access flag for SRAM3
pub type CSRAM3F_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
///Field `CMPCBB3_REGF` writer - clear the illegal access flag for MPCBB3 registers
pub type CMPCBB3_REGF_W<'a, const O: u8> = crate::BitWriter<'a, u32, FCR4_SPEC, bool, O>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cflashf(&mut self) -> CFLASHF_W<1> {
        CFLASHF_W::new(self)
    }
...
///
///For information about available fields see [fcr4](index.html) module
pub struct FCR4_SPEC;
impl crate::RegisterSpec for FCR4_SPEC {
    type Ux = u32;
}
///`write(|w| ..)` method takes [fcr4::W](W) writer structure
impl crate::Writable for FCR4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets FCR4 to value 0
impl crate::Resettable for FCR4_SPEC {
