...
///key register 7
pub mod keyr7;
///SUSP0R (w) register accessor: an alias for `Reg<SUSP0R_SPEC>`
pub type SUSP0R = crate::Reg<susp0r::SUSP0R_SPEC>;
///suspend registers
pub mod susp0r;
///SUSP1R (w) register accessor: an alias for `Reg<SUSP1R_SPEC>`
pub type SUSP1R = crate::Reg<susp1r::SUSP1R_SPEC>;
///suspend registers
pub mod susp1r;
///SUSP2R (w) register accessor: an alias for `Reg<SUSP2R_SPEC>`
pub type SUSP2R = crate::Reg<susp2r::SUSP2R_SPEC>;
///suspend registers
pub mod susp2r;
///SUSP3R (w) register accessor: an alias for `Reg<SUSP3R_SPEC>`
pub type SUSP3R = crate::Reg<susp3r::SUSP3R_SPEC>;
///suspend registers
pub mod susp3r;
///SUSP4R (w) register accessor: an alias for `Reg<SUSP4R_SPEC>`
pub type SUSP4R = crate::Reg<susp4r::SUSP4R_SPEC>;
///suspend registers
pub mod susp4r;
///SUSP5R (w) register accessor: an alias for `Reg<SUSP5R_SPEC>`
pub type SUSP5R = crate::Reg<susp5r::SUSP5R_SPEC>;
///suspend registers
pub mod susp5r;
///SUSP6R (w) register accessor: an alias for `Reg<SUSP6R_SPEC>`
pub type SUSP6R = crate::Reg<susp6r::SUSP6R_SPEC>;
///suspend registers
pub mod susp6r;
///SUSP7R (w) register accessor: an alias for `Reg<SUSP7R_SPEC>`
