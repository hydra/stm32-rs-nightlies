...
pub type LT3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADC_AWD3TR_SPEC, u16, u16, 12, O>;
///Field `HT3` reader - HT3
pub type HT3_R = crate::FieldReader<u16, u16>;
///Field `HT3` writer - HT3
pub type HT3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADC_AWD3TR_SPEC, u16, u16, 12, O>;
impl R {
    ///Bits 0:11 - LT3
    #[inline(always)]
