...
pub struct R(crate::R<MPCBB4_CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MPCBB4_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MPCBB4_CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MPCBB4_CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MPCBB4_CR` writer
pub struct W(crate::W<MPCBB4_CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MPCBB4_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MPCBB4_CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MPCBB4_CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCBB4_CR_SPEC, bool, O>;
...
pub type INVSECSTATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCBB4_CR_SPEC, bool, O>;
...
pub type SRWILADIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCBB4_CR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [mpcbb4_cr](index.html) module
pub struct MPCBB4_CR_SPEC;
impl crate::RegisterSpec for MPCBB4_CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mpcbb4_cr::R](R) reader structure
impl crate::Readable for MPCBB4_CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcbb4_cr::W](W) writer structure
impl crate::Writable for MPCBB4_CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCBB4_CR to value 0
impl crate::Resettable for MPCBB4_CR_SPEC {
