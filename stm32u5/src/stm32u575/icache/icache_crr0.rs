...
///`read()` method returns [icache_crr0::R](R) reader structure
impl crate::Readable for ICACHE_CRR0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [icache_crr0::W](W) writer structure
impl crate::Writable for ICACHE_CRR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets ICACHE_CRR0 to value 0x0200
