...
pub type OC3M_BIT3_R = crate::BitReader<bool>;
///Field `OC3M_bit3` writer - Output Compare 1 mode - bit 3
pub type OC3M_BIT3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC4M_BIT3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCMR2_OUTPUT_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc3m_bit3(&mut self) -> OC3M_BIT3_W<16> {
        OC3M_BIT3_W::new(self)
    }
    ///Bit 24 - Output Compare 2 mode - bit 3
    #[inline(always)]
    #[must_use]
