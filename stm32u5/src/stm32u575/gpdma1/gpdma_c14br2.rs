...
pub struct R(crate::R<GPDMA_C14BR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C14BR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C14BR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C14BR2_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GPDMA_C14BR2` writer
pub struct W(crate::W<GPDMA_C14BR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C14BR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDMA_C14BR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C14BR2_SPEC>) -> Self {
        W(writer)
    }
}
...
///versus GPDMA_CxTR1.SDW_LOG2\[1:0\]). Else a user setting error is reported and no transfer is issued.
pub type BRSAO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C14BR2_SPEC, u16, u16, 16, O>;
...
///versus GPDMA_CxTR1.DDW_LOG2\[1:0\]). Else a user setting error is reported and no transfer is issued.
pub type BRDAO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C14BR2_SPEC, u16, u16, 16, O>;
impl R {
...
///
///For information about available fields see [gpdma_c14br2](index.html) module
pub struct GPDMA_C14BR2_SPEC;
impl crate::RegisterSpec for GPDMA_C14BR2_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c14br2::R](R) reader structure
impl crate::Readable for GPDMA_C14BR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpdma_c14br2::W](W) writer structure
impl crate::Writable for GPDMA_C14BR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C14BR2 to value 0
impl crate::Resettable for GPDMA_C14BR2_SPEC {
