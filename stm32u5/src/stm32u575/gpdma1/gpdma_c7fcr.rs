...
pub struct W(crate::W<GPDMA_C7FCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C7FCR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<GPDMA_C7FCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C7FCR_SPEC>) -> Self {
        W(writer)
    }
}
///Field `TCF` writer - transfer complete flag clear
pub type TCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
///Field `HTF` writer - half transfer flag clear
pub type HTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
///Field `DTEF` writer - data transfer error flag clear
pub type DTEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
///Field `ULEF` writer - update link transfer error flag clear
pub type ULEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
///Field `USEF` writer - user setting error flag clear
pub type USEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
///Field `SUSPF` writer - completed suspension flag clear
pub type SUSPF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
///Field `TOF` writer - trigger overrun flag clear
pub type TOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C7FCR_SPEC, bool, O>;
impl W {
...
///
///For information about available fields see [gpdma_c7fcr](index.html) module
pub struct GPDMA_C7FCR_SPEC;
impl crate::RegisterSpec for GPDMA_C7FCR_SPEC {
    type Ux = u32;
}
///`write(|w| ..)` method takes [gpdma_c7fcr::W](W) writer structure
impl crate::Writable for GPDMA_C7FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C7FCR to value 0
impl crate::Resettable for GPDMA_C7FCR_SPEC {
