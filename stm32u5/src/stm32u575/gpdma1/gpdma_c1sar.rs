...
pub struct R(crate::R<GPDMA_C1SAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C1SAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C1SAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C1SAR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GPDMA_C1SAR` writer
pub struct W(crate::W<GPDMA_C1SAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C1SAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDMA_C1SAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C1SAR_SPEC>) -> Self {
        W(writer)
    }
}
...
///versus GPDMA_CxTR1.SDW_LOG2\[1:0\]). Else, a user setting error is reported and no transfer is issued. When the source block size is not a multiple of the source burst size and is a multiple of the source data width, the last programmed source burst is not completed and is internally shorten to match the block size. In this case, the additional GPDMA_CxTR3.SAO\[12:0\]
///is not applied.
pub type SA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C1SAR_SPEC, u32, u32, 32, O>;
impl R {
...
///
///For information about available fields see [gpdma_c1sar](index.html) module
pub struct GPDMA_C1SAR_SPEC;
impl crate::RegisterSpec for GPDMA_C1SAR_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c1sar::R](R) reader structure
impl crate::Readable for GPDMA_C1SAR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpdma_c1sar::W](W) writer structure
impl crate::Writable for GPDMA_C1SAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C1SAR to value 0
impl crate::Resettable for GPDMA_C1SAR_SPEC {
