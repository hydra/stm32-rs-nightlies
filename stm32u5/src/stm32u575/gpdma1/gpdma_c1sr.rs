...
pub struct R(crate::R<GPDMA_C1SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C1SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C1SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C1SR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [gpdma_c1sr](index.html) module
pub struct GPDMA_C1SR_SPEC;
impl crate::RegisterSpec for GPDMA_C1SR_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c1sr::R](R) reader structure
impl crate::Readable for GPDMA_C1SR_SPEC {
    type Reader = R;
}
///`reset()` method sets GPDMA_C1SR to value 0x01
impl crate::Resettable for GPDMA_C1SR_SPEC {
