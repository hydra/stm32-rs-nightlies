...
pub struct R(crate::R<GPDMA_C11LLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDMA_C11LLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDMA_C11LLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDMA_C11LLR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GPDMA_C11LLR` writer
pub struct W(crate::W<GPDMA_C11LLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDMA_C11LLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDMA_C11LLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDMA_C11LLR_SPEC>) -> Self {
        W(writer)
    }
}
...
///= 0, the current LLI is the last one. The channel transfer is completed without any update of the linked-list GPDMA register file. Else, this field is the pointer to the memory address offset from which the next linked-list data structure is automatically fetched from, once the data transfer is completed, in order to conditionally update the linked-list GPDMA internal register file (GPDMA_CxCTR1, GPDMA_CxTR2, GPDMA_CxBR1, GPDMA_CxSAR, GPDMA_CxDAR and GPDMA_CxLLR). Note: The user must program the pointer to be 32-bit aligned. The two low-significant bits are write ignored.
pub type LA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPDMA_C11LLR_SPEC, u16, u16, 14, O>;
...
pub type ULL_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C11LLR_SPEC, bool, O>;
...
pub type UDA_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C11LLR_SPEC, bool, O>;
...
pub type USA_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C11LLR_SPEC, bool, O>;
...
///is then restored to the programmed value after data transfer is completed and before the link transfer.
pub type UB1_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C11LLR_SPEC, bool, O>;
...
pub type UT2_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C11LLR_SPEC, bool, O>;
...
pub type UT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPDMA_C11LLR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [gpdma_c11llr](index.html) module
pub struct GPDMA_C11LLR_SPEC;
impl crate::RegisterSpec for GPDMA_C11LLR_SPEC {
    type Ux = u32;
}
///`read()` method returns [gpdma_c11llr::R](R) reader structure
impl crate::Readable for GPDMA_C11LLR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gpdma_c11llr::W](W) writer structure
impl crate::Writable for GPDMA_C11LLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GPDMA_C11LLR to value 0
impl crate::Resettable for GPDMA_C11LLR_SPEC {
