...
pub struct R(crate::R<TZSC_MPCWM2AR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TZSC_MPCWM2AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TZSC_MPCWM2AR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TZSC_MPCWM2AR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `TZSC_MPCWM2AR` writer
pub struct W(crate::W<TZSC_MPCWM2AR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TZSC_MPCWM2AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TZSC_MPCWM2AR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TZSC_MPCWM2AR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SUBA_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZSC_MPCWM2AR_SPEC, u16, u16, 11, O>;
...
pub type SUBA_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZSC_MPCWM2AR_SPEC, u16, u16, 12, O>;
impl R {
...
///
///For information about available fields see [tzsc_mpcwm2ar](index.html) module
pub struct TZSC_MPCWM2AR_SPEC;
impl crate::RegisterSpec for TZSC_MPCWM2AR_SPEC {
    type Ux = u32;
}
///`read()` method returns [tzsc_mpcwm2ar::R](R) reader structure
impl crate::Readable for TZSC_MPCWM2AR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tzsc_mpcwm2ar::W](W) writer structure
impl crate::Writable for TZSC_MPCWM2AR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TZSC_MPCWM2AR to value 0
impl crate::Resettable for TZSC_MPCWM2AR_SPEC {
