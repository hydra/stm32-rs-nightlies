...
pub type FTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BCR2_SPEC, u8, u8, 3, O>;
///Field `FFLUSH` reader - FIFO flush
pub type FFLUSH_R = crate::BitReader<bool>;
///Field `FFLUSH` writer - FIFO flush
pub type FFLUSH_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCR2_SPEC, bool, O>;
