...
pub type XFRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `CHH` reader - CHH
pub type CHH_R = crate::BitReader<bool>;
///Field `CHH` writer - CHH
pub type CHH_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `STALL` reader - STALL
pub type STALL_R = crate::BitReader<bool>;
///Field `STALL` writer - STALL
pub type STALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `NAK` reader - NAK
pub type NAK_R = crate::BitReader<bool>;
///Field `NAK` writer - NAK
pub type NAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `ACK` reader - ACK
pub type ACK_R = crate::BitReader<bool>;
///Field `ACK` writer - ACK
pub type ACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `TXERR` reader - TXERR
pub type TXERR_R = crate::BitReader<bool>;
///Field `TXERR` writer - TXERR
pub type TXERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `BBERR` reader - BBERR
pub type BBERR_R = crate::BitReader<bool>;
///Field `BBERR` writer - BBERR
pub type BBERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `FRMOR` reader - FRMOR
pub type FRMOR_R = crate::BitReader<bool>;
///Field `FRMOR` writer - FRMOR
pub type FRMOR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
///Field `DTERR` reader - DTERR
pub type DTERR_R = crate::BitReader<bool>;
///Field `DTERR` writer - DTERR
pub type DTERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT10_SPEC, bool, O>;
impl R {
    ///Bit 0 - XFRC
    #[inline(always)]
