...
pub type PSRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GRSTCTL_SPEC, bool, O>;
///Field `FSRST` reader - FSRST
pub type FSRST_R = crate::BitReader<bool>;
///Field `FSRST` writer - FSRST
pub type FSRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GRSTCTL_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsrst(&mut self) -> FSRST_W<2> {
        FSRST_W::new(self)
    }
    ///Bit 4 - RXFFLSH
    #[inline(always)]
