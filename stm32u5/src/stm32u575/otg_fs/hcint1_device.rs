...
pub struct R(crate::R<HCINT1_DEVICE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HCINT1_DEVICE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HCINT1_DEVICE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HCINT1_DEVICE_SPEC>) -> Self {
        R(reader)
    }
}
///Register `HCINT1_DEVICE` writer
pub struct W(crate::W<HCINT1_DEVICE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HCINT1_DEVICE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HCINT1_DEVICE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HCINT1_DEVICE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `CHH` reader - CHH
pub type CHH_R = crate::BitReader<bool>;
///Field `CHH` writer - CHH
pub type CHH_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `STALL` reader - STALL
pub type STALL_R = crate::BitReader<bool>;
///Field `STALL` writer - STALL
pub type STALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `NAK` reader - NAK
pub type NAK_R = crate::BitReader<bool>;
///Field `NAK` writer - NAK
pub type NAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `ACK` reader - ACK
pub type ACK_R = crate::BitReader<bool>;
///Field `ACK` writer - ACK
pub type ACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `TXERR` reader - TXERR
pub type TXERR_R = crate::BitReader<bool>;
///Field `TXERR` writer - TXERR
pub type TXERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `BBERR` reader - BBERR
pub type BBERR_R = crate::BitReader<bool>;
///Field `BBERR` writer - BBERR
pub type BBERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `FRMOR` reader - FRMOR
pub type FRMOR_R = crate::BitReader<bool>;
///Field `FRMOR` writer - FRMOR
pub type FRMOR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
///Field `DTERR` reader - DTERR
pub type DTERR_R = crate::BitReader<bool>;
///Field `DTERR` writer - DTERR
pub type DTERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCINT1_DEVICE_SPEC, bool, O>;
impl R {
    ///Bit 0 - XFRC
    #[inline(always)]
...
///
///For information about available fields see [hcint1_device](index.html) module
pub struct HCINT1_DEVICE_SPEC;
impl crate::RegisterSpec for HCINT1_DEVICE_SPEC {
    type Ux = u32;
}
///`read()` method returns [hcint1_device::R](R) reader structure
impl crate::Readable for HCINT1_DEVICE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hcint1_device::W](W) writer structure
impl crate::Writable for HCINT1_DEVICE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets HCINT1_DEVICE to value 0
impl crate::Resettable for HCINT1_DEVICE_SPEC {
