...
pub type AHBERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
...
pub type STSPHSRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
...
pub type OUTPKTERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
///Field `BNA` reader - BNA
pub type BNA_R = crate::BitReader<bool>;
///Field `BNA` writer - BNA
pub type BNA_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
///Field `BERR` reader - BERR
pub type BERR_R = crate::BitReader<bool>;
///Field `BERR` writer - BERR
pub type BERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
///Field `NAK` reader - NAK
pub type NAK_R = crate::BitReader<bool>;
///Field `NAK` writer - NAK
pub type NAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
...
pub type STPKTRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT4_SPEC, bool, O>;
impl R {
    ///Bit 0 - XFRC
    #[inline(always)]
