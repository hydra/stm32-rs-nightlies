...
pub struct R(crate::R<MDF_DFLT4ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_DFLT4ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_DFLT4ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_DFLT4ISR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_DFLT4ISR` writer
pub struct W(crate::W<MDF_DFLT4ISR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_DFLT4ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_DFLT4ISR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_DFLT4ISR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DOVRF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type SSDRF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type OLDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type SSOVRF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type SCDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type SATF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type CKABF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
...
pub type RFOVRF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4ISR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [mdf_dflt4isr](index.html) module
pub struct MDF_DFLT4ISR_SPEC;
impl crate::RegisterSpec for MDF_DFLT4ISR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_dflt4isr::R](R) reader structure
impl crate::Readable for MDF_DFLT4ISR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_dflt4isr::W](W) writer structure
impl crate::Writable for MDF_DFLT4ISR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_DFLT4ISR to value 0
impl crate::Resettable for MDF_DFLT4ISR_SPEC {
