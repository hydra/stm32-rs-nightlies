...
pub struct R(crate::R<MDF_DFLT4RSFR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_DFLT4RSFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_DFLT4RSFR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_DFLT4RSFR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_DFLT4RSFR` writer
pub struct W(crate::W<MDF_DFLT4RSFR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_DFLT4RSFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_DFLT4RSFR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_DFLT4RSFR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RSFLTBYP_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4RSFR_SPEC, bool, O>;
...
pub type RSFLTD_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4RSFR_SPEC, bool, O>;
...
pub type HPFBYP_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT4RSFR_SPEC, bool, O>;
...
pub type HPFC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT4RSFR_SPEC, u8, u8, 2, O>;
impl R {
...
///
///For information about available fields see [mdf_dflt4rsfr](index.html) module
pub struct MDF_DFLT4RSFR_SPEC;
impl crate::RegisterSpec for MDF_DFLT4RSFR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_dflt4rsfr::R](R) reader structure
impl crate::Readable for MDF_DFLT4RSFR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_dflt4rsfr::W](W) writer structure
impl crate::Writable for MDF_DFLT4RSFR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_DFLT4RSFR to value 0
impl crate::Resettable for MDF_DFLT4RSFR_SPEC {
