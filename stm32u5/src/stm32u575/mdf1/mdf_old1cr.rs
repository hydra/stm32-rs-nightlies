...
pub struct R(crate::R<MDF_OLD1CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_OLD1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_OLD1CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_OLD1CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_OLD1CR` writer
pub struct W(crate::W<MDF_OLD1CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_OLD1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_OLD1CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_OLD1CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OLDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_OLD1CR_SPEC, bool, O>;
...
pub type THINB_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_OLD1CR_SPEC, bool, O>;
...
///= 0: Break signal (mdf_break\[i\]) is not assigned to threshold event BKOLD\[i\]
///= 1: Break signal (mdf_break\[i\]) is assigned to threshold event This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type BKOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_OLD1CR_SPEC, u8, u8, 4, O>;
...
///= 0xx . - 00: FastSinc filter type - 01: Sinc1 filter type - 10: Sinc2 filter type - 11: Sinc3 filter type This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type ACICN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_OLD1CR_SPEC, u8, u8, 2, O>;
...
///= 0xx . The decimation ratio is given by (ACICD+1). - 0: Decimation ratio is 1 - 1: Decimation ratio is 2 - 2: Decimation ratio is 3 - 3: Decimation ratio is 4 ... - 31: Decimation ratio is 32 This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type ACICD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_OLD1CR_SPEC, u8, u8, 5, O>;
...
///
///For information about available fields see [mdf_old1cr](index.html) module
pub struct MDF_OLD1CR_SPEC;
impl crate::RegisterSpec for MDF_OLD1CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_old1cr::R](R) reader structure
impl crate::Readable for MDF_OLD1CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_old1cr::W](W) writer structure
impl crate::Writable for MDF_OLD1CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_OLD1CR to value 0
impl crate::Resettable for MDF_OLD1CR_SPEC {
