...
pub struct R(crate::R<MDF_SITF3CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_SITF3CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_SITF3CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_SITF3CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_SITF3CR` writer
pub struct W(crate::W<MDF_SITF3CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_SITF3CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_SITF3CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_SITF3CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SITFEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_SITF3CR_SPEC, bool, O>;
...
pub type SCKSRC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_SITF3CR_SPEC, u8, u8, 2, O>;
...
pub type SITFMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_SITF3CR_SPEC, u8, u8, 2, O>;
...
///lower than 4 are invalid. This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type STH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_SITF3CR_SPEC, u8, u8, 5, O>;
...
///
///For information about available fields see [mdf_sitf3cr](index.html) module
pub struct MDF_SITF3CR_SPEC;
impl crate::RegisterSpec for MDF_SITF3CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_sitf3cr::R](R) reader structure
impl crate::Readable for MDF_SITF3CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_sitf3cr::W](W) writer structure
impl crate::Writable for MDF_SITF3CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_SITF3CR to value 0x1f00
impl crate::Resettable for MDF_SITF3CR_SPEC {
