...
pub struct R(crate::R<MDF_OLD1THLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_OLD1THLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_OLD1THLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_OLD1THLR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_OLD1THLR` writer
pub struct W(crate::W<MDF_OLD1THLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_OLD1THLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_OLD1THLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_OLD1THLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OLDTHL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MDF_OLD1THLR_SPEC, u32, u32, 26, O>;
impl R {
...
///
///For information about available fields see [mdf_old1thlr](index.html) module
pub struct MDF_OLD1THLR_SPEC;
impl crate::RegisterSpec for MDF_OLD1THLR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_old1thlr::R](R) reader structure
impl crate::Readable for MDF_OLD1THLR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_old1thlr::W](W) writer structure
impl crate::Writable for MDF_OLD1THLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_OLD1THLR to value 0
impl crate::Resettable for MDF_OLD1THLR_SPEC {
