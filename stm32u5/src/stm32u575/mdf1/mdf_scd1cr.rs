...
pub struct R(crate::R<MDF_SCD1CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_SCD1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_SCD1CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_SCD1CR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_SCD1CR` writer
pub struct W(crate::W<MDF_SCD1CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_SCD1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_SCD1CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_SCD1CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SCDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_SCD1CR_SPEC, bool, O>;
...
///= 0: Break signal (mdf_break\[i\]) is not assigned to this SCD event BKSCD\[i\]
///= 1: Break signal (mdf_break\[i\]) is assigned to this SCD event This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
pub type BKSCD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_SCD1CR_SPEC, u8, u8, 4, O>;
...
pub type SCDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_SCD1CR_SPEC, u8, u8, 8, O>;
...
///
///For information about available fields see [mdf_scd1cr](index.html) module
pub struct MDF_SCD1CR_SPEC;
impl crate::RegisterSpec for MDF_SCD1CR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_scd1cr::R](R) reader structure
impl crate::Readable for MDF_SCD1CR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_scd1cr::W](W) writer structure
impl crate::Writable for MDF_SCD1CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_SCD1CR to value 0
impl crate::Resettable for MDF_SCD1CR_SPEC {
