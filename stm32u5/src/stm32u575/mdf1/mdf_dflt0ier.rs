...
pub struct R(crate::R<MDF_DFLT0IER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_DFLT0IER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_DFLT0IER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_DFLT0IER_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_DFLT0IER` writer
pub struct W(crate::W<MDF_DFLT0IER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_DFLT0IER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_DFLT0IER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_DFLT0IER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FTHIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type DOVRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type SSDRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type OLDIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type SSOVRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type SCDIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type SATIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type CKABIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
...
pub type RFOVRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDF_DFLT0IER_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [mdf_dflt0ier](index.html) module
pub struct MDF_DFLT0IER_SPEC;
impl crate::RegisterSpec for MDF_DFLT0IER_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_dflt0ier::R](R) reader structure
impl crate::Readable for MDF_DFLT0IER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_dflt0ier::W](W) writer structure
impl crate::Writable for MDF_DFLT0IER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_DFLT0IER to value 0
impl crate::Resettable for MDF_DFLT0IER_SPEC {
