...
pub struct R(crate::R<MDF_DFLT2INTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDF_DFLT2INTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDF_DFLT2INTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDF_DFLT2INTR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MDF_DFLT2INTR` writer
pub struct W(crate::W<MDF_DFLT2INTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDF_DFLT2INTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDF_DFLT2INTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDF_DFLT2INTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INTDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT2INTR_SPEC, u8, u8, 2, O>;
...
pub type INTVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDF_DFLT2INTR_SPEC, u8, u8, 7, O>;
impl R {
...
///
///For information about available fields see [mdf_dflt2intr](index.html) module
pub struct MDF_DFLT2INTR_SPEC;
impl crate::RegisterSpec for MDF_DFLT2INTR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mdf_dflt2intr::R](R) reader structure
impl crate::Readable for MDF_DFLT2INTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mdf_dflt2intr::W](W) writer structure
impl crate::Writable for MDF_DFLT2INTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MDF_DFLT2INTR to value 0
impl crate::Resettable for MDF_DFLT2INTR_SPEC {
