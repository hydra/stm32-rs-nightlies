...
pub type MMS0_2_R = crate::FieldReader<u8, u8>;
///Field `MMS0_2` writer - Master mode selection
pub type MMS0_2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_CR2_SPEC, u8, u8, 3, O>;
...
pub type MMS_3_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_CR2_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mms0_2(&mut self) -> MMS0_2_W<4> {
        MMS0_2_W::new(self)
    }
    ///Bit 7 - TI1 selection
    #[inline(always)]
