...
///Field `SWI17` reader - Software interrupt on event x
pub type SWI17_R = crate::BitReader<bool>;
///Field `SWI17` writer - Software interrupt on event x
pub type SWI17_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWIER1_SPEC, bool, O>;
///Field `SWI18` reader - Software interrupt on event x
pub type SWI18_R = crate::BitReader<bool>;
///Field `SWI18` writer - Software interrupt on event x
pub type SWI18_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWIER1_SPEC, bool, O>;
///Field `SWI19` reader - Software interrupt on event x
pub type SWI19_R = crate::BitReader<bool>;
///Field `SWI19` writer - Software interrupt on event x
...
impl R {
    ...
    ///Bit 17 - Software interrupt on event x
    #[inline(always)]
    ...
    ///Bit 19 - Software interrupt on event x
    #[inline(always)]
