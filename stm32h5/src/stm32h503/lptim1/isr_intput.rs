...
pub struct R(crate::R<ISR_INTPUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ISR_INTPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISR_INTPUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISR_INTPUT_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [isr_intput](index.html) module
