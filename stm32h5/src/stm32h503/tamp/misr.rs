...
///Field `ITAMP12MF` reader - internal tamper 12 interrupt masked flag This flag is set by hardware when the internal tamper 12 interrupt is raised.
pub type ITAMP12MF_R = crate::BitReader<bool>;
///Field `ITAMP13MF` reader - internal tamper 13 interrupt masked flag This flag is set by hardware when the internal tamper 13 interrupt is raised.
