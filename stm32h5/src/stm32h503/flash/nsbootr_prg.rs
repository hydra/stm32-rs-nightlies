...
///Field `NSBOOT_LOCK` writer - A field locking the values of SWAP_BANK, and NSBOOTADD settings.
pub type NSBOOT_LOCK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, NSBOOTR_PRG_SPEC, u8, u8, 8, O>;
///Field `NSBOOTADD` reader - Unique boot entry address These bits allow configuring the BOOT address
pub type NSBOOTADD_R = crate::FieldReader<u32, u32>;
///Field `NSBOOTADD` writer - Unique boot entry address These bits allow configuring the BOOT address
