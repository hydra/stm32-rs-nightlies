...
pub struct R(crate::R<M3IER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<M3IER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<M3IER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<M3IER_SPEC>) -> Self {
        R(reader)
    }
}
///Register `M3IER` writer
pub struct W(crate::W<M3IER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M3IER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<M3IER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M3IER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M3IER_SPEC, bool, O>;
...
pub type DEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M3IER_SPEC, bool, O>;
...
pub type ECCNMI_W<'a, const O: u8> = crate::BitWriter<'a, u32, M3IER_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [m3ier](index.html) module
