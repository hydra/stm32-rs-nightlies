...
pub struct R(crate::R<M3ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<M3ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<M3ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<M3ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [m3isr](index.html) module
