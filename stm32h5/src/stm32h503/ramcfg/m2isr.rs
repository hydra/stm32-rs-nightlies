...
pub struct R(crate::R<M2ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<M2ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<M2ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<M2ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [m2isr](index.html) module
