...
///Field `CS1` reader - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
pub type CS1_R = crate::FieldReader<u32, u32>;
///Field `CS1` writer - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
pub type CS1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSR1_SPEC, u32, u32, 32, O>;
impl R {
