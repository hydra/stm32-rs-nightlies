...
///`read()` method returns [i3c_devr2::R](R) reader structure
impl crate::Readable for I3C_DEVR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [i3c_devr2::W](W) writer structure
impl crate::Writable for I3C_DEVR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets I3C_DEVR2 to value 0
