...
///`read()` method returns [i3c_crcapr::R](R) reader structure
impl crate::Readable for I3C_CRCAPR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [i3c_crcapr::W](W) writer structure
impl crate::Writable for I3C_CRCAPR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets I3C_CRCAPR to value 0
