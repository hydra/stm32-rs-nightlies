...
///`read()` method returns [i3c_ibidr::R](R) reader structure
impl crate::Readable for I3C_IBIDR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [i3c_ibidr::W](W) writer structure
impl crate::Writable for I3C_IBIDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets I3C_IBIDR to value 0
