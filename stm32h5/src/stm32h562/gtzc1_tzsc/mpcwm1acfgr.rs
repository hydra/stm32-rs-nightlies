...
pub struct R(crate::R<MPCWM1ACFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MPCWM1ACFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MPCWM1ACFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MPCWM1ACFGR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MPCWM1ACFGR` writer
pub struct W(crate::W<MPCWM1ACFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MPCWM1ACFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MPCWM1ACFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MPCWM1ACFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM1ACFGR_SPEC, bool, O>;
...
pub type SRLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM1ACFGR_SPEC, bool, O>;
...
pub type SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM1ACFGR_SPEC, bool, O>;
...
pub type PRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM1ACFGR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [mpcwm1acfgr](index.html) module
pub struct MPCWM1ACFGR_SPEC;
impl crate::RegisterSpec for MPCWM1ACFGR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mpcwm1acfgr::R](R) reader structure
impl crate::Readable for MPCWM1ACFGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcwm1acfgr::W](W) writer structure
impl crate::Writable for MPCWM1ACFGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCWM1ACFGR to value 0
impl crate::Resettable for MPCWM1ACFGR_SPEC {
