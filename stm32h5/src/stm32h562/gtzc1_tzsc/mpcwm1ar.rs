...
pub struct R(crate::R<MPCWM1AR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MPCWM1AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MPCWM1AR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MPCWM1AR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MPCWM1AR` writer
pub struct W(crate::W<MPCWM1AR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MPCWM1AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MPCWM1AR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MPCWM1AR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SUBA_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MPCWM1AR_SPEC, u16, u16, 11, O>;
...
pub type SUBA_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MPCWM1AR_SPEC, u16, u16, 12, O>;
impl R {
    ///Bits 0:10 - Start of sub-region A in region x This field defines the address offset of the sub-region A, to be multiplied by the granularity defined in Table�30, versus the start of the region x. External memories that are watermark controlled, start fully non-secure at reset when TZEN�=�0xC3. When TZEN�=�0xB4, external memories start fully secure (inverted reset value).
    #[inline(always)]
...
///
///For information about available fields see [mpcwm1ar](index.html) module
pub struct MPCWM1AR_SPEC;
impl crate::RegisterSpec for MPCWM1AR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mpcwm1ar::R](R) reader structure
impl crate::Readable for MPCWM1AR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcwm1ar::W](W) writer structure
impl crate::Writable for MPCWM1AR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCWM1AR to value 0
impl crate::Resettable for MPCWM1AR_SPEC {
