...
///`read()` method returns [tim5_ccr2::R](R) reader structure
impl crate::Readable for TIM5_CCR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim5_ccr2::W](W) writer structure
impl crate::Writable for TIM5_CCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM5_CCR2 to value 0
