///Register `GTZC1_MPCBB2_PRIVCFGR6` reader
...
///Register `GTZC1_MPCBB2_PRIVCFGR6` writer
...
///`read()` method returns [gtzc1_mpcbb2_privcfgr6::R](R) reader structure
impl crate::Readable for GTZC1_MPCBB2_PRIVCFGR6_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gtzc1_mpcbb2_privcfgr6::W](W) writer structure
impl crate::Writable for GTZC1_MPCBB2_PRIVCFGR6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GTZC1_MPCBB2_PRIVCFGR6 to value 0xffff_ffff
