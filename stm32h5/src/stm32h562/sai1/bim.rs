...
pub type OVRUDRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, OVRUDRIE_A, O>;
...
pub type MUTEDETIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, MUTEDETIE_A, O>;
...
///= 0) and NODIV = 0. It generates an interrupt if the WCKCFG flag in the SAI_xSR register is set. Note: This bit is used only in Free protocol mode and is meaningless in other modes.
pub type WCKCFGIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, WCKCFGIE_A, O>;
...
pub type FREQIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, FREQIE_A, O>;
...
///bits and the audio block is operates as a receiver.
pub type CNRDYIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, CNRDYIE_A, O>;
...
pub type AFSDETIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, AFSDETIE_A, O>;
...
pub type LFSDETIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, BIM_SPEC, LFSDETIE_A, O>;
