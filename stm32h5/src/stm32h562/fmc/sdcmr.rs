...
///Field `MRD` reader - Mode Register definition This 13-bit field defines the SDRAM Mode Register content. The Mode Register is programmed using the Load Mode Register command.
pub type MRD_R = crate::FieldReader<u16, u16>;
///Field `MRD` writer - Mode Register definition This 13-bit field defines the SDRAM Mode Register content. The Mode Register is programmed using the Load Mode Register command.
pub type MRD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SDCMR_SPEC, u16, u16, 13, O>;
impl R {
    ...
    ///Bits 9:21 - Mode Register definition This 13-bit field defines the SDRAM Mode Register content. The Mode Register is programmed using the Load Mode Register command.
    #[inline(always)]
