///Register `GTZC1_MPCBB1_PRIVCFGR4` reader
...
///Register `GTZC1_MPCBB1_PRIVCFGR4` writer
...
///`read()` method returns [gtzc1_mpcbb1_privcfgr4::R](R) reader structure
impl crate::Readable for GTZC1_MPCBB1_PRIVCFGR4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gtzc1_mpcbb1_privcfgr4::W](W) writer structure
impl crate::Writable for GTZC1_MPCBB1_PRIVCFGR4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GTZC1_MPCBB1_PRIVCFGR4 to value 0xffff_ffff
