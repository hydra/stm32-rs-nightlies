...
pub struct R(crate::R<ERCFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ERCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ERCFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ERCFGR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `ERCFGR` writer
pub struct W(crate::W<ERCFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ERCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ERCFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ERCFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ERCFG0_W<'a, const O: u8> = crate::BitWriter<'a, u32, ERCFGR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [ercfgr](index.html) module
