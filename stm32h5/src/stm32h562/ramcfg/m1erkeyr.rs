...
pub struct W(crate::W<M1ERKEYR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M1ERKEYR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<M1ERKEYR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M1ERKEYR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ERASEKEY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, M1ERKEYR_SPEC, u8, u8, 8, O>;
impl W {
...
///
///For information about available fields see [m1erkeyr](index.html) module
