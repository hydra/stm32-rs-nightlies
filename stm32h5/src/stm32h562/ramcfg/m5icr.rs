...
pub struct R(crate::R<M5ICR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<M5ICR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<M5ICR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<M5ICR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `M5ICR` writer
pub struct W(crate::W<M5ICR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M5ICR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<M5ICR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M5ICR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CSEDC_W<'a, const O: u8> = crate::BitWriter<'a, u32, M5ICR_SPEC, bool, O>;
...
pub type CDED_W<'a, const O: u8> = crate::BitWriter<'a, u32, M5ICR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [m5icr](index.html) module
