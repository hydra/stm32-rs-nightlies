...
pub struct W(crate::W<M5ECCKEYR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M5ECCKEYR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<M5ECCKEYR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M5ECCKEYR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ECCKEY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, M5ECCKEYR_SPEC, u8, u8, 8, O>;
impl W {
...
///
///For information about available fields see [m5ecckeyr](index.html) module
