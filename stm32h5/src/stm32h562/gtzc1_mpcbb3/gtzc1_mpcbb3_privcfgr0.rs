///Register `GTZC1_MPCBB3_PRIVCFGR0` reader
...
///Register `GTZC1_MPCBB3_PRIVCFGR0` writer
...
///`read()` method returns [gtzc1_mpcbb3_privcfgr0::R](R) reader structure
impl crate::Readable for GTZC1_MPCBB3_PRIVCFGR0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gtzc1_mpcbb3_privcfgr0::W](W) writer structure
impl crate::Writable for GTZC1_MPCBB3_PRIVCFGR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GTZC1_MPCBB3_PRIVCFGR0 to value 0xffff_ffff
