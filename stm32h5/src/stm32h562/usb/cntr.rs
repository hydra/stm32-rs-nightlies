...
pub type USBRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNTR_SPEC, bool, O>;
...
pub type L2RES_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNTR_SPEC, bool, O>;
///Field `L1RES` reader - L1 remote wakeup / resume driver Device mode Software sets this bit to send a LPM L1 50 μs remote wakeup signaling to the host. After the signaling ends, this bit is cleared by hardware.
pub type L1RES_R = crate::BitReader<bool>;
///Field `L1RES` writer - L1 remote wakeup / resume driver Device mode Software sets this bit to send a LPM L1 50 μs remote wakeup signaling to the host. After the signaling ends, this bit is cleared by hardware.
pub type L1RES_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNTR_SPEC, bool, O>;
...
pub type RST_DCONM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNTR_SPEC, bool, O>;
...
pub type DDISCM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNTR_SPEC, bool, O>;
