...
pub type THREE_ERR_TX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHEP0R_SPEC, u8, u8, 2, O>;
...
pub type THREE_ERR_RX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHEP0R_SPEC, u8, u8, 2, O>;
impl R {
