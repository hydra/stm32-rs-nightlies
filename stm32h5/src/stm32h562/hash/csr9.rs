...
///Field `CSx` reader - Context swap 9 Refer to introduction.
pub type CSX_R = crate::FieldReader<u32, u32>;
///Field `CSx` writer - Context swap 9 Refer to introduction.
pub type CSX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSR9_SPEC, u32, u32, 32, O>;
impl R {
    ///Bits 0:31 - Context swap 9 Refer to introduction.
    #[inline(always)]
