///Register `TIM4_CCMR1_Output` reader
...
///Register `TIM4_CCMR1_Output` writer
...
///`read()` method returns [tim4_ccmr1_output::R](R) reader structure
impl crate::Readable for TIM4_CCMR1_OUTPUT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim4_ccmr1_output::W](W) writer structure
impl crate::Writable for TIM4_CCMR1_OUTPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM4_CCMR1_Output to value 0
