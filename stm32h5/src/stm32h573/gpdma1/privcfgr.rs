...
///Field `PRIV0` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV0_R = crate::BitReader<bool>;
///Field `PRIV0` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV1` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV1_R = crate::BitReader<bool>;
///Field `PRIV1` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV2` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV2_R = crate::BitReader<bool>;
///Field `PRIV2` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV3` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV3_R = crate::BitReader<bool>;
///Field `PRIV3` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV3_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV4` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV4_R = crate::BitReader<bool>;
///Field `PRIV4` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV4_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV5` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV5_R = crate::BitReader<bool>;
///Field `PRIV5` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV5_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV6` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV6_R = crate::BitReader<bool>;
///Field `PRIV6` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV6_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
///Field `PRIV7` reader - privileged state of channel x (x = 7 to 0)
pub type PRIV7_R = crate::BitReader<bool>;
///Field `PRIV7` writer - privileged state of channel x (x = 7 to 0)
pub type PRIV7_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRIVCFGR_SPEC, bool, O>;
impl R {
    ///Bit 0 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv0(&self) -> PRIV0_R {
        PRIV0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv1(&self) -> PRIV1_R {
        PRIV1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv2(&self) -> PRIV2_R {
        PRIV2_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv3(&self) -> PRIV3_R {
        PRIV3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv4(&self) -> PRIV4_R {
        PRIV4_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv5(&self) -> PRIV5_R {
        PRIV5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
    pub fn priv6(&self) -> PRIV6_R {
        PRIV6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - privileged state of channel x (x = 7 to 0)
    #[inline(always)]
