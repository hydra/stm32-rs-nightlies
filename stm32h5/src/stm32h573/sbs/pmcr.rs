...
///Field `ETH_SEL_PHY` reader - Ethernet PHY interface selection Other: reserved
pub type ETH_SEL_PHY_R = crate::FieldReader<u8, u8>;
///Field `ETH_SEL_PHY` writer - Ethernet PHY interface selection Other: reserved
pub type ETH_SEL_PHY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMCR_SPEC, u8, u8, 3, O>;
impl R {
