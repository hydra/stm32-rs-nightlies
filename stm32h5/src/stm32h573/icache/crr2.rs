...
pub struct R(crate::R<CRR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CRR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CRR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRR2_SPEC>) -> Self {
        R(reader)
    }
}
///Register `CRR2` writer
pub struct W(crate::W<CRR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CRR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CRR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CRR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REMAPADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CRR2_SPEC, u16, u16, 11, O>;
...
pub type MSTSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRR2_SPEC, bool, O>;
...
pub type HBURST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRR2_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [crr2](index.html) module
pub struct CRR2_SPEC;
impl crate::RegisterSpec for CRR2_SPEC {
    type Ux = u32;
}
///`read()` method returns [crr2::R](R) reader structure
impl crate::Readable for CRR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [crr2::W](W) writer structure
impl crate::Writable for CRR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CRR2 to value 0x0200
impl crate::Resettable for CRR2_SPEC {
