///Register `TIM15_CCMR1_Input` reader
...
///Register `TIM15_CCMR1_Input` writer
...
///Field `IC1PSC` reader - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=’0’ (TIM15_CCER register).
pub type IC1PSC_R = crate::FieldReader<u8, u8>;
///Field `IC1PSC` writer - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=’0’ (TIM15_CCER register).
...
///`read()` method returns [tim15_ccmr1_input::R](R) reader structure
impl crate::Readable for TIM15_CCMR1_INPUT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim15_ccmr1_input::W](W) writer structure
impl crate::Writable for TIM15_CCMR1_INPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM15_CCMR1_Input to value 0
