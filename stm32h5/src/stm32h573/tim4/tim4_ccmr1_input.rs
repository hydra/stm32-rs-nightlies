///Register `TIM4_CCMR1_Input` reader
...
///Register `TIM4_CCMR1_Input` writer
...
///`read()` method returns [tim4_ccmr1_input::R](R) reader structure
impl crate::Readable for TIM4_CCMR1_INPUT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim4_ccmr1_input::W](W) writer structure
impl crate::Writable for TIM4_CCMR1_INPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM4_CCMR1_Input to value 0
