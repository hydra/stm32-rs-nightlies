///Register `TIM5_CCMR2_Output` reader
...
///Register `TIM5_CCMR2_Output` writer
...
///`read()` method returns [tim5_ccmr2_output::R](R) reader structure
impl crate::Readable for TIM5_CCMR2_OUTPUT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim5_ccmr2_output::W](W) writer structure
impl crate::Writable for TIM5_CCMR2_OUTPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM5_CCMR2_Output to value 0
