...
pub struct R(crate::R<GETMXDSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GETMXDSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GETMXDSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GETMXDSR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `GETMXDSR` writer
pub struct W(crate::W<GETMXDSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GETMXDSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GETMXDSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GETMXDSR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type HOFFAS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GETMXDSR_SPEC, u8, u8, 2, O>;
///Field `FMT` reader - GETMXDS CCC format
pub type FMT_R = crate::FieldReader<u8, u8>;
///Field `FMT` writer - GETMXDS CCC format
pub type FMT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GETMXDSR_SPEC, u8, u8, 2, O>;
...
///field) of the 3-byte MaxRdTurn which is returned in response to the GETMXDS CCC format 2 to encode the maximum read turnaround time.
pub type RDTURN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GETMXDSR_SPEC, u8, u8, 8, O>;
...
///bits.
pub type TSCO_W<'a, const O: u8> = crate::BitWriter<'a, u32, GETMXDSR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [getmxdsr](index.html) module
