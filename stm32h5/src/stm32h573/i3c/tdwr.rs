...
pub struct W(crate::W<TDWR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TDWR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<TDWR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TDWR_SPEC>) -> Self {
        W(writer)
    }
}
///Field `TDB0` writer - 8-bit transmit data (earliest byte on I3C bus)
pub type TDB0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDWR_SPEC, u8, u8, 8, O>;
///Field `TDB1` writer - 8-bit transmit data (next byte after TDB0\[7:0\]
///on I3C bus).
pub type TDB1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDWR_SPEC, u8, u8, 8, O>;
///Field `TDB2` writer - 8-bit transmit data (next byte after TDB1\[7:0\]
///on I3C bus).
pub type TDB2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDWR_SPEC, u8, u8, 8, O>;
///Field `TDB3` writer - 8-bit transmit data (latest byte on I3C bus).
pub type TDB3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TDWR_SPEC, u8, u8, 8, O>;
impl W {
...
///
///For information about available fields see [tdwr](index.html) module
