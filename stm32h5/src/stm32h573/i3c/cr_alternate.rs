...
pub struct W(crate::W<CR_ALTERNATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CR_ALTERNATE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CR_ALTERNATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CR_ALTERNATE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_ALTERNATE_SPEC, u16, u16, 16, O>;
...
pub type CCC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_ALTERNATE_SPEC, u8, u8, 8, O>;
...
pub type MTYPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_ALTERNATE_SPEC, u8, u8, 4, O>;
///Field `MEND` writer - message end type (when I3C is acting as controller)
pub type MEND_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_ALTERNATE_SPEC, bool, O>;
impl W {
...
///
///For information about available fields see [cr_alternate](index.html) module
pub struct CR_ALTERNATE_SPEC;
impl crate::RegisterSpec for CR_ALTERNATE_SPEC {
    type Ux = u32;
}
///`write(|w| ..)` method takes [cr_alternate::W](W) writer structure
impl crate::Writable for CR_ALTERNATE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CR_ALTERNATE to value 0
impl crate::Resettable for CR_ALTERNATE_SPEC {
