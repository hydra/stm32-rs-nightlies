...
pub struct W(crate::W<ICR_INTPUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ICR_INTPUT_SPEC>;
    #[inline(always)]
...
pub type EXTTRIGCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
...
pub type ARROKCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
...
pub type UPCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
...
pub type DOWNCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
///Field `UECF` writer - Update event clear flag Writing 1 to this bit clear the UE flag in the LPTIM_ISR register.
pub type UECF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
...
pub type REPOKCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
...
pub type CC2CF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
///Field `CC1OCF` writer - Capture/compare 1 over-capture clear flag Writing 1 to this bit clears the CC1OF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 1 channel this bit is reserved. Please refer to .
pub type CC1OCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
///Field `CC2OCF` writer - Capture/compare 2 over-capture clear flag Writing 1 to this bit clears the CC2OF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
pub type CC2OCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
...
pub type DIEROKCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_INTPUT_SPEC, bool, O>;
impl W {
...
///
///For information about available fields see [icr_intput](index.html) module
