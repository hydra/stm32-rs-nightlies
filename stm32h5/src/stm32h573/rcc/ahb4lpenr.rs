...
///Field `OTFDEC1LPEN` reader - OTFDEC1 clock enable during sleep mode Set and reset by software.
pub type OTFDEC1LPEN_R = crate::BitReader<bool>;
///Field `OTFDEC1LPEN` writer - OTFDEC1 clock enable during sleep mode Set and reset by software.
...
impl R {
    ///Bit 7 - OTFDEC1 clock enable during sleep mode Set and reset by software.
    #[inline(always)]
