...
///Field `AESLPEN` reader - AES clock enable during sleep mode Set and reset by software.
pub type AESLPEN_R = crate::BitReader<bool>;
///Field `AESLPEN` writer - AES clock enable during sleep mode Set and reset by software.
...
///Field `PKALPEN` reader - PKA clock enable during sleep mode Set and reset by software.
pub type PKALPEN_R = crate::BitReader<bool>;
///Field `PKALPEN` writer - PKA clock enable during sleep mode Set and reset by software.
pub type PKALPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2LPENR_SPEC, bool, O>;
///Field `SAESLPEN` reader - SAES clock enable during sleep mode Set and reset by software.
pub type SAESLPEN_R = crate::BitReader<bool>;
///Field `SAESLPEN` writer - SAES clock enable during sleep mode Set and reset by software.
...
impl R {
    ...
    ///Bit 16 - AES clock enable during sleep mode Set and reset by software.
    #[inline(always)]
    ...
    ///Bit 19 - PKA clock enable during sleep mode Set and reset by software.
    #[inline(always)]
    pub fn pkalpen(&self) -> PKALPEN_R {
        PKALPEN_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - SAES clock enable during sleep mode Set and reset by software.
    #[inline(always)]
