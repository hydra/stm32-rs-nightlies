...
///`read()` method returns [tim17_dtr2::R](R) reader structure
impl crate::Readable for TIM17_DTR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim17_dtr2::W](W) writer structure
impl crate::Writable for TIM17_DTR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM17_DTR2 to value 0
