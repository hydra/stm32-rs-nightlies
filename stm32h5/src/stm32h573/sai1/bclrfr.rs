...
pub type COVRUDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, COVRUDRW_AW, O>;
...
pub type CMUTEDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, CMUTEDETW_AW, O>;
...
///= 0) and NODIV = 0 in the SAI_xCR1 register. Reading this bit always returns the value 0.
pub type CWCKCFG_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, CWCKCFGW_AW, O>;
...
pub type CCNRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, CCNRDYW_AW, O>;
...
pub type CAFSDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, CAFSDETW_AW, O>;
...
pub type CLFSDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, BCLRFR_SPEC, CLFSDETW_AW, O>;
