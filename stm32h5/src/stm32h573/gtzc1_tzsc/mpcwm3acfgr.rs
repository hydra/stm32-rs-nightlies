...
pub struct R(crate::R<MPCWM3ACFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MPCWM3ACFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MPCWM3ACFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MPCWM3ACFGR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MPCWM3ACFGR` writer
pub struct W(crate::W<MPCWM3ACFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MPCWM3ACFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MPCWM3ACFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MPCWM3ACFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM3ACFGR_SPEC, bool, O>;
...
pub type SRLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM3ACFGR_SPEC, bool, O>;
...
pub type SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM3ACFGR_SPEC, bool, O>;
...
pub type PRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM3ACFGR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [mpcwm3acfgr](index.html) module
pub struct MPCWM3ACFGR_SPEC;
impl crate::RegisterSpec for MPCWM3ACFGR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mpcwm3acfgr::R](R) reader structure
impl crate::Readable for MPCWM3ACFGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcwm3acfgr::W](W) writer structure
impl crate::Writable for MPCWM3ACFGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCWM3ACFGR to value 0
impl crate::Resettable for MPCWM3ACFGR_SPEC {
