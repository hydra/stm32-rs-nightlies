...
pub struct R(crate::R<MPCWM2BCFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MPCWM2BCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MPCWM2BCFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MPCWM2BCFGR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MPCWM2BCFGR` writer
pub struct W(crate::W<MPCWM2BCFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MPCWM2BCFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MPCWM2BCFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MPCWM2BCFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM2BCFGR_SPEC, bool, O>;
...
pub type SRLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM2BCFGR_SPEC, bool, O>;
...
pub type SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM2BCFGR_SPEC, bool, O>;
...
pub type PRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCWM2BCFGR_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [mpcwm2bcfgr](index.html) module
pub struct MPCWM2BCFGR_SPEC;
impl crate::RegisterSpec for MPCWM2BCFGR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mpcwm2bcfgr::R](R) reader structure
impl crate::Readable for MPCWM2BCFGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcwm2bcfgr::W](W) writer structure
impl crate::Writable for MPCWM2BCFGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCWM2BCFGR to value 0
impl crate::Resettable for MPCWM2BCFGR_SPEC {
