...
pub type ETHSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECCFGR3_SPEC, bool, O>;
...
pub type AESSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECCFGR3_SPEC, bool, O>;
...
pub type SAESSEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECCFGR3_SPEC, bool, O>;
...
pub type PKASEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECCFGR3_SPEC, bool, O>;
///Field `SDMMC2SEC` reader - secure access mode for SDMMC2
pub type SDMMC2SEC_R = crate::BitReader<bool>;
///Field `SDMMC2SEC` writer - secure access mode for SDMMC2
pub type SDMMC2SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECCFGR3_SPEC, bool, O>;
