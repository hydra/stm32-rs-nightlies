...
pub struct R(crate::R<MPCWM4BR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MPCWM4BR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MPCWM4BR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MPCWM4BR_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MPCWM4BR` writer
pub struct W(crate::W<MPCWM4BR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MPCWM4BR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MPCWM4BR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MPCWM4BR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SUBB_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MPCWM4BR_SPEC, u16, u16, 11, O>;
...
pub type SUBB_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MPCWM4BR_SPEC, u16, u16, 12, O>;
impl R {
    ///Bits 0:10 - Start of sub-region B in region x This field defines the address offset of the sub-region B, to be multiplied by the granularity defined in Table�30, versus the start of the region x. External memories that are watermark controlled, start fully non-secure at reset when TZEN�=�0xC3. When TZEN�=�0xB4, external memories start fully secure (inverted reset value).
    #[inline(always)]
...
///
///For information about available fields see [mpcwm4br](index.html) module
pub struct MPCWM4BR_SPEC;
impl crate::RegisterSpec for MPCWM4BR_SPEC {
    type Ux = u32;
}
///`read()` method returns [mpcwm4br::R](R) reader structure
impl crate::Readable for MPCWM4BR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcwm4br::W](W) writer structure
impl crate::Writable for MPCWM4BR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCWM4BR to value 0
impl crate::Resettable for MPCWM4BR_SPEC {
