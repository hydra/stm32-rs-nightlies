...
pub type ECCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M5CR_SPEC, bool, O>;
...
pub type ALE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M5CR_SPEC, bool, O>;
...
pub type SRAMER_W<'a, const O: u8> = crate::BitWriter<'a, u32, M5CR_SPEC, bool, O>;
impl R {
