...
///Field `ABDTR` reader - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSY = 0.
pub type ABDTR_R = crate::BitReader<bool>;
///Field `ABDTR` writer - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSY = 0.
...
///Field `SIOO` reader - Send instruction only once mode This bit has no effect when IMODE = 00 (see ).
pub type SIOO_R = crate::BitReader<bool>;
///Field `SIOO` writer - Send instruction only once mode This bit has no effect when IMODE = 00 (see ).
...
impl R {
    ...
    ///Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSY = 0.
    #[inline(always)]
    ...
    ///Bit 31 - Send instruction only once mode This bit has no effect when IMODE = 00 (see ).
    #[inline(always)]
