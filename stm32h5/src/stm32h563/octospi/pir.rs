...
///Field `INTERVAL` reader - 15: 0\]: Polling interval Number of CLK cycle between a read during the Automatic status-polling phases
pub type INTERVAL_R = crate::FieldReader<u16, u16>;
///Field `INTERVAL` writer - 15: 0\]: Polling interval Number of CLK cycle between a read during the Automatic status-polling phases
pub type INTERVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIR_SPEC, u16, u16, 16, O>;
impl R {
    ///Bits 0:15 - 15: 0\]: Polling interval Number of CLK cycle between a read during the Automatic status-polling phases
    #[inline(always)]
