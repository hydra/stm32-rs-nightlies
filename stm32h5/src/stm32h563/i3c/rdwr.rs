...
pub struct R(crate::R<RDWR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDWR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDWR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDWR_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rdwr](index.html) module
