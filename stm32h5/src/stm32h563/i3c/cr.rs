...
pub type DCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u16, u16, 16, O>;
...
pub type RNW_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
...
pub type MTYPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 4, O>;
///Field `MEND` writer - message end type (when the I3C is acting as controller)
pub type MEND_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
impl W {
