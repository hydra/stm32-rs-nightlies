...
///`read()` method returns [tim4_ecr::R](R) reader structure
impl crate::Readable for TIM4_ECR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim4_ecr::W](W) writer structure
impl crate::Writable for TIM4_ECR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM4_ECR to value 0
