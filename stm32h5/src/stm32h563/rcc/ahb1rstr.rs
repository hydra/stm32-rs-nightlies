...
///Field `ETHRST` reader - ETHRST block reset Set and reset by software
pub type ETHRST_R = crate::BitReader<bool>;
///Field `ETHRST` writer - ETHRST block reset Set and reset by software
...
impl R {
    ...
    ///Bit 19 - ETHRST block reset Set and reset by software
    #[inline(always)]
