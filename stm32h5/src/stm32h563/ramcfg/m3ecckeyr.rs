...
pub struct W(crate::W<M3ECCKEYR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M3ECCKEYR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<M3ECCKEYR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M3ECCKEYR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ECCKEY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, M3ECCKEYR_SPEC, u8, u8, 8, O>;
impl W {
...
///
///For information about available fields see [m3ecckeyr](index.html) module
