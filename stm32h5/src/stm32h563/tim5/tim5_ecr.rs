...
///`read()` method returns [tim5_ecr::R](R) reader structure
impl crate::Readable for TIM5_ECR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim5_ecr::W](W) writer structure
impl crate::Writable for TIM5_ECR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM5_ECR to value 0
