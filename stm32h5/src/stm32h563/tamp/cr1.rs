...
///Field `TAMP7E` reader - Tamper detection on TAMP_IN7 enable
pub type TAMP7E_R = crate::BitReader<bool>;
///Field `TAMP7E` writer - Tamper detection on TAMP_IN7 enable
pub type TAMP7E_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, bool, O>;
///Field `TAMP8E` reader - Tamper detection on TAMP_IN8 enable
pub type TAMP8E_R = crate::BitReader<bool>;
///Field `TAMP8E` writer - Tamper detection on TAMP_IN8 enable
