...
///`read()` method returns [tim3_ecr::R](R) reader structure
impl crate::Readable for TIM3_ECR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim3_ecr::W](W) writer structure
impl crate::Writable for TIM3_ECR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM3_ECR to value 0
