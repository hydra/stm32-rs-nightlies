...
pub type SLOTSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BSLOTR_SPEC, u8, SLOTSZ_A, 2, O>;
...
pub type SLOTEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BSLOTR_SPEC, u16, SLOTEN_A, 16, O>;
