///Register `GTZC1_MPCBB3_SECCFGR5` reader
...
///Register `GTZC1_MPCBB3_SECCFGR5` writer
...
///`read()` method returns [gtzc1_mpcbb3_seccfgr5::R](R) reader structure
impl crate::Readable for GTZC1_MPCBB3_SECCFGR5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [gtzc1_mpcbb3_seccfgr5::W](W) writer structure
impl crate::Writable for GTZC1_MPCBB3_SECCFGR5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets GTZC1_MPCBB3_SECCFGR5 to value 0xffff_ffff
