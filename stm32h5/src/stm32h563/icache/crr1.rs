...
pub struct R(crate::R<CRR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CRR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CRR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRR1_SPEC>) -> Self {
        R(reader)
    }
}
///Register `CRR1` writer
pub struct W(crate::W<CRR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CRR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CRR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CRR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REMAPADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CRR1_SPEC, u16, u16, 11, O>;
...
pub type MSTSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRR1_SPEC, bool, O>;
...
pub type HBURST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRR1_SPEC, bool, O>;
impl R {
...
///
///For information about available fields see [crr1](index.html) module
pub struct CRR1_SPEC;
impl crate::RegisterSpec for CRR1_SPEC {
    type Ux = u32;
}
///`read()` method returns [crr1::R](R) reader structure
impl crate::Readable for CRR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [crr1::W](W) writer structure
impl crate::Writable for CRR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CRR1 to value 0x0200
impl crate::Resettable for CRR1_SPEC {
