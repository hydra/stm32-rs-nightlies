...
///`read()` method returns [tim17_cr2::R](R) reader structure
impl crate::Readable for TIM17_CR2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tim17_cr2::W](W) writer structure
impl crate::Writable for TIM17_CR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets TIM17_CR2 to value 0
