...
///Field `FRAME_MIS` reader - Capture complete masked interrupt status This bit gives the status of the masked capture complete interrupt
pub type FRAME_MIS_R = crate::BitReader<bool>;
///Field `OVR_MIS` reader - Overrun masked interrupt status This bit gives the status of the masked overflow interrupt.
pub type OVR_MIS_R = crate::BitReader<bool>;
///Field `ERR_MIS` reader - Synchronization error masked interrupt status This bit gives the status of the masked synchronization error interrupt. Note: This bit is available only in embedded synchronization mode.
pub type ERR_MIS_R = crate::BitReader<bool>;
///Field `VSYNC_MIS` reader - VSYNC masked interrupt status This bit gives the status of the masked VSYNC interrupt. The active state of the DCMI_VSYNC signal is defined by the VSPOL bit.
pub type VSYNC_MIS_R = crate::BitReader<bool>;
///Field `LINE_MIS` reader - Line masked interrupt status This bit gives the status of the masked line interrupt.
