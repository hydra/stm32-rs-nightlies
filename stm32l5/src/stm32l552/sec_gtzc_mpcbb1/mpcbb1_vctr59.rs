...
///`read()` method returns [mpcbb1_vctr59::R](R) reader structure
impl crate::Readable for MPCBB1_VCTR59_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcbb1_vctr59::W](W) writer structure
impl crate::Writable for MPCBB1_VCTR59_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCBB1_VCTR59 to value 0
