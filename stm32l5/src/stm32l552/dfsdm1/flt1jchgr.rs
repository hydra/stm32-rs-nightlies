...
///`read()` method returns [flt1jchgr::R](R) reader structure
impl crate::Readable for FLT1JCHGR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [flt1jchgr::W](W) writer structure
