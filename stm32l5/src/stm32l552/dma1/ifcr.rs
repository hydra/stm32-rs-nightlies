...
///Field `CGIF8` writer - global interrupt flag clear for channel 8
pub type CGIF8_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFCR_SPEC, bool, O>;
///Field `CTCIF8` writer - transfer complete flag clear for channel 8
pub type CTCIF8_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFCR_SPEC, bool, O>;
///Field `CHTIF8` writer - half transfer flag clear for channel 8
pub type CHTIF8_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFCR_SPEC, bool, O>;
///Field `CTEIF8` writer - transfer error flag clear for channel 8
