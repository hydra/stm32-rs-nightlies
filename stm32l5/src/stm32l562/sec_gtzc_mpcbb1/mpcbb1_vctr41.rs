...
///`read()` method returns [mpcbb1_vctr41::R](R) reader structure
impl crate::Readable for MPCBB1_VCTR41_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mpcbb1_vctr41::W](W) writer structure
impl crate::Writable for MPCBB1_VCTR41_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets MPCBB1_VCTR41 to value 0
