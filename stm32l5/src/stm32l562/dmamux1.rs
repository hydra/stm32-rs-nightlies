...
pub struct RegisterBlock {
    ...
    pub rg3cr: RG3CR,
    _reserved20: [u8; 0x28],
    ///0x138 - DMA Multiplexer Channel 10 Control register
    pub c14cr: C14CR,
    ///0x13c - DMA Multiplexer Channel 10 Control register
    pub c15cr: C15CR,
...
pub mod csr;
///CCFR (rw) register accessor: an alias for `Reg<CCFR_SPEC>`
...
pub mod rgsr;
///RGCFR (rw) register accessor: an alias for `Reg<RGCFR_SPEC>`
