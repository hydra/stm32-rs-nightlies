...
///`read()` method returns [cm1ar1::R](R) reader structure
impl crate::Readable for CM1AR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cm1ar1::W](W) writer structure
impl crate::Writable for CM1AR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets CM1AR1 to value 0
