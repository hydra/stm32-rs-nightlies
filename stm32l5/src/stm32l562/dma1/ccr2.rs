...
///Field `TEIE` reader - Transfer error interupt enable
pub type TEIE_R = crate::BitReader<bool>;
///Field `TEIE` writer - Transfer error interupt enable
...
///Field `CIRC` reader - Ciruclar mode
pub type CIRC_R = crate::BitReader<bool>;
///Field `CIRC` writer - Ciruclar mode
pub type CIRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR2_SPEC, bool, O>;
///Field `MINC` reader - Memory increment mdoe
pub type MINC_R = crate::BitReader<bool>;
///Field `MINC` writer - Memory increment mdoe
...
///Field `CT` reader - Current target memory of DMA transfer in double-bufer mode
pub type CT_R = crate::BitReader<bool>;
///Field `CT` writer - Current target memory of DMA transfer in double-bufer mode
...
impl R {
    ...
    ///Bit 3 - Transfer error interupt enable
    #[inline(always)]
    ...
    ///Bit 7 - Memory increment mdoe
    #[inline(always)]
    pub fn minc(&self) -> MINC_R {
        MINC_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 7 - Peripheral increment mode
    #[inline(always)]
    ...
    ///Bit 16 - Current target memory of DMA transfer in double-bufer mode
    #[inline(always)]
    pub fn ct(&self) -> CT_R {
