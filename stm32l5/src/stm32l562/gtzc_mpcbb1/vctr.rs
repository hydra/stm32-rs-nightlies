...
///`read()` method returns [vctr::R](R) reader structure
impl crate::Readable for VCTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [vctr::W](W) writer structure
impl crate::Writable for VCTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets VCTR%s to value 0xffff_ffff
